...
//#if !#{Fuse.iOS.Bindings.UIControlCallback.callbackForEvent(iOS.Foundation.NSObject,iOS.Foundation.NSObject):IsStripped}
...
//#if !#{Fuse.iOS.Bindings.UIControlCallback.callbackSelector():IsStripped}
