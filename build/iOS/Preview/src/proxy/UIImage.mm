...
//{
//    #{iOS.UIKit.UIImage} __return = #{iOS.UIKit.UIImage._imageWithCIImage(iOS.CoreImage.CIImage):Call((#{iOS.CoreImage.CIImage})uObjC::Lifetime::GetUnoObject(ciImage, #{iOS.CoreImage.CIImage:TypeOf}))};
//    return uObjC::Lifetime::GetNativeHandle((::uObject *)__return);
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UIImage:Of(__this).drawInRect(iOS.CoreGraphics.CGRect):Call(uObjC::Struct::ToUno_CGRect(rect, #{iOS.CoreGraphics.CGRect}()))};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.CoreGraphics.CGSize} __return = #{iOS.UIKit.UIImage:Of(__this).size():Call()};
