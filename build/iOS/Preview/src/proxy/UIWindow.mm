...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UIViewController} __return = #{iOS.UIKit.UIWindow:Of(__this).rootViewController():Call()};
//    return uObjC::Lifetime::GetNativeHandle((::uObject *)__return);
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UIWindow:Of(__this).setRootViewController(iOS.UIKit.UIViewController):Call((#{iOS.UIKit.UIViewController})uObjC::Lifetime::GetUnoObject(rootViewController, #{iOS.UIKit.UIViewController:TypeOf}))};
//}
//#endif // !IsStripped
