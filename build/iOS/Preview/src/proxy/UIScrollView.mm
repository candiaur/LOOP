...
//    #{iOS.UIKit.UIScrollView:Of(__this).setContentOffsetAnimated(iOS.CoreGraphics.CGPoint,bool):Call(uObjC::Struct::ToUno_CGPoint(contentOffset, #{iOS.CoreGraphics.CGPoint}()), (#{bool})animated)};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.CoreGraphics.CGPoint} __return = #{iOS.UIKit.UIScrollView:Of(__this).contentOffset():Call()};
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UIScrollView:Of(__this).setContentOffset(iOS.CoreGraphics.CGPoint):Call(uObjC::Struct::ToUno_CGPoint(contentOffset, #{iOS.CoreGraphics.CGPoint}()))};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.IUIScrollViewDelegate} __return = #{iOS.UIKit.UIScrollView:Of(__this).delegate_():Call()};
//    return uObjC::Lifetime::GetNativeHandle((::uObject *)__return, #{iOS.UIKit.IUIScrollViewDelegate:TypeOf});
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UIScrollView:Of(__this).setDelegate(iOS.UIKit.IUIScrollViewDelegate):Call(uObjC::Lifetime::GetUnoObject(delegate, #{iOS.UIKit.Interop.IUIScrollViewDelegate:TypeOf}))};
//}
//#endif // !IsStripped
