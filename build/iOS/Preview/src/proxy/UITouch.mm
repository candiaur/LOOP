...
//    #{iOS.CoreGraphics.CGPoint} __return = #{iOS.UIKit.UITouch:Of(__this).locationInView(iOS.UIKit.UIView):Call((#{iOS.UIKit.UIView})uObjC::Lifetime::GetUnoObject(view, #{iOS.UIKit.UIView:TypeOf}))};
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{double} __return = #{iOS.UIKit.UITouch:Of(__this).timestamp():Call()};
//    return __return;
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UITouchPhase} __return = #{iOS.UIKit.UITouch:Of(__this).phase():Call()};
