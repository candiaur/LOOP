...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.IUITextViewDelegate} __return = #{iOS.UIKit.UITextView:Of(__this).delegate_():Call()};
//    return uObjC::Lifetime::GetNativeHandle((::uObject *)__return, #{iOS.UIKit.IUITextViewDelegate:TypeOf});
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UITextView:Of(__this).setDelegate(iOS.UIKit.IUITextViewDelegate):Call(uObjC::Lifetime::GetUnoObject(delegate, #{iOS.UIKit.Interop.IUITextViewDelegate:TypeOf}))};
//}
//#endif // !IsStripped
