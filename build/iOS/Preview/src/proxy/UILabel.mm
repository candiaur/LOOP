...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.NSLineBreakMode} __return = #{iOS.UIKit.UILabel:Of(__this).lineBreakMode():Call()};
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UILabel:Of(__this).setLineBreakMode(iOS.UIKit.NSLineBreakMode):Call(#{int}(lineBreakMode))};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{int} __return = #{iOS.UIKit.UILabel:Of(__this).numberOfLines():Call()};
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.UIKit.UILabel:Of(__this).setNumberOfLines(int):Call((#{int})numberOfLines)};
//}
//#endif // !IsStripped
