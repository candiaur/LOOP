...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/0.29.22/$.uno
// ---------------------------------------------------------------
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/0.29.22/$.uno");
...
// private double Fuse.Triggers.IMediaPlayback.get_Duration() :983
...
// private float Fuse.Triggers.IMediaPlayback.get_Volume() :971
...
// private void Fuse.Triggers.IMediaPlayback.set_Volume(float value) :972
