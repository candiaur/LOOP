...
// /usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Time/Text/$.uno
// ------------------------------------------------------------------------
...
void FixedFormatPattern__Parse_fn(FixedFormatPattern* __this, uString* line, void* bucket)
{
    ...
    for (int i = 0; i < uPtr(__this->_parts)->Length(); i++)
    {
        ...
        if (readCount == 0)
            i = i + ::g::Uno::Time::Text::IPatternPart::SkipNextPartsCountIfThisNotSpecified(uInterface(part, __types[1]));
    }
