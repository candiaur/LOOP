// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Platform/$.uno'.
...
static void Application_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof()), (uintptr_t)&::g::Uno::Platform::iOS::Application::DelayedLocalNotifications_, uFieldFlagsStatic,
        ...
        ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof()), (uintptr_t)&::g::Uno::Platform::iOS::Application::ReceivedLocalNotification1_, uFieldFlagsStatic,
    ...
    type->Reflection.SetFunctions(8,
        ...
        new uFunction("add_ReceivedLocalNotification", NULL, (void*)Application__add_ReceivedLocalNotification_fn, 0, true, uVoid_typeof(), 1, ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof())),
        new uFunction("remove_ReceivedLocalNotification", NULL, (void*)Application__remove_ReceivedLocalNotification_fn, 0, true, uVoid_typeof(), 1, ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof())),
...
void Application::DispatchDelayedLocalNotifications(int state)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong<uString*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(Application::DelayedLocalNotifications()), &ret3), ret3); enum2.MoveNext(::TYPES[2/*Uno.Collections.List<string>.Enumerator*/]); )
        {
            uString* n = enum2.Current(::TYPES[2/*Uno.Collections.List<string>.Enumerator*/]);
            uPtr(handler)->Invoke(2, NULL, n);
        }

    uPtr(Application::DelayedLocalNotifications())->Clear();
    ::g::Uno::Platform2::Application::remove_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedLocalNotifications_fn));
}
...
void Application::DispatchDelayedNotifications(int state)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong<uString*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(Application::DelayedNotifications()), &ret4), ret4); enum1.MoveNext(::TYPES[2/*Uno.Collections.List<string>.Enumerator*/]); )
        {
    ...
    ::g::Uno::Platform2::Application::remove_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedNotifications_fn));
}
...
void Application::DispatchDelayedReason(int state)
{
    ...
    ::g::Uno::Platform2::Application::remove_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedReason_fn));
}
...
void Application::DispatchDelayedRegToken(int state)
{
    ...
    ::g::Uno::Platform2::Application::remove_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedRegToken_fn));
}
...
void Application::OnNotificationRegistrationFailed(uString* reason)
{
    ...
    else
    {
        ...
        ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedReason_fn));
    }
}
...
void Application::OnNotificationRegistrationSucceeded(uString* regID)
{
    ...
    else
    {
        ...
        ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedRegToken_fn));
    }
}
...
void Application::OnReceivedLocalNotification(uString* notification)
{
    ...
    else
    {
        ...
        ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedLocalNotifications_fn));
    }
}
...
void Application::OnReceivedNotification(uString* notification)
{
    ...
    else
    {
        ...
        ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[3/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedNotifications_fn));
    }
}
...
void Application::add_NotificationRegistrationFailed(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::NotificationRegistrationFailed1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::NotificationRegistrationFailed1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Application::remove_NotificationRegistrationFailed(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::NotificationRegistrationFailed1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::NotificationRegistrationFailed1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Application::add_NotificationRegistrationSucceeded(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::NotificationRegistrationSucceeded1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::NotificationRegistrationSucceeded1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Application::remove_NotificationRegistrationSucceeded(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::NotificationRegistrationSucceeded1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::NotificationRegistrationSucceeded1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Application::add_ReceivedLocalNotification(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ReceivedLocalNotification1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::ReceivedLocalNotification1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Application::remove_ReceivedLocalNotification(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ReceivedLocalNotification1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::ReceivedLocalNotification1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Application::add_ReceivedNotification(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ReceivedNotification1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::ReceivedNotification1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Application::remove_ReceivedNotification(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ReceivedNotification1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::ReceivedNotification1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
// }
