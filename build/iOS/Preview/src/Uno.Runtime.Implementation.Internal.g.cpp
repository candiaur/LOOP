...
// /usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Runtime/Implementation/Internal/$.uno
// ----------------------------------------------------------------------------------------------
...
::g::Uno::Buffer* BufferConverters::ToBuffer8(uArray* data)
{
    ...
    ::g::Uno::Buffer* result = ::g::Uno::Buffer::New3(uPtr(data)->Length() * 4);

    for (int i = 0; i < data->Length(); i++)
        result->Set21(i * 4, data->Item<uint32_t>(i), true);
...
uArray* BufferReader::ReadBytes(int count)
{
    ...
    for (int i = 0; i < count; i++)
        result->Item<uint8_t>(i) = ReadByte();
