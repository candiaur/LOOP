...
// /usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Content/Fonts/$.uno
// ----------------------------------------------------------------------------
...
{
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Uno::Content::Fonts::SdfFontShader, _draw_a6403fca), 0);
    type->Reflection.SetFunctions(1,
...
void SdfFontShader__Draw_fn(SdfFontShader* __this, ::g::Uno::Content::Fonts::TextShaderData* data)
{
    ...
    float FontSmoothing_a6403fca_12_0_1 = 0.25f / ::g::Uno::Math::Max1(uPtr(data)->FontSpread * uPtr(data)->FontScale, 0.5f);
    __this->_draw_a6403fca.BlendEnabled(true);
    __this->_draw_a6403fca.DepthTestEnabled(false);
    __this->_draw_a6403fca.CullFace(uPtr(data)->DataCullFace);
    __this->_draw_a6403fca.BlendSrcRgb(2);
    __this->_draw_a6403fca.BlendDstRgb(3);
    __this->_draw_a6403fca.Use();
    __this->_draw_a6403fca.Attrib1(0, data->PositionInfo.Type, data->PositionInfo.Buffer, data->PositionInfo.BufferStride, data->PositionInfo.BufferOffset);
    __this->_draw_a6403fca.Attrib1(1, data->TexCoordInfo.Type, data->TexCoordInfo.Buffer, data->TexCoordInfo.BufferStride, data->TexCoordInfo.BufferOffset);
    __this->_draw_a6403fca.Attrib1(2, data->ColorInfo.Type, data->ColorInfo.Buffer, data->ColorInfo.BufferStride, data->ColorInfo.BufferOffset);
    __this->_draw_a6403fca.Uniform12(3, data->ClipSpaceMatrix);
    __this->_draw_a6403fca.Uniform(4, 0.5f - FontSmoothing_a6403fca_12_0_1);
    __this->_draw_a6403fca.Uniform(5, 0.5f + FontSmoothing_a6403fca_12_0_1);
    __this->_draw_a6403fca.Sampler3(6, data->FontTexture, ::g::Uno::Graphics::SamplerState__TrilinearClamp());
...
void SdfFontShader::init_DrawCalls()
{
    ...
    _draw_a6403fca = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::UnoCore_bundle::SdfFontShader06541a00());
}
...
{
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Uno::Content::Fonts::SpriteFontShader, _draw_c2905fec), 0);
    type->Reflection.SetFunctions(1,
...
void SpriteFontShader__Draw_fn(SpriteFontShader* __this, ::g::Uno::Content::Fonts::TextShaderData* data)
{
    ...
    __this->_draw_c2905fec.CullFace(uPtr(data)->DataCullFace);
    ...
    __this->_draw_c2905fec.Attrib1(0, data->PositionInfo.Type, data->PositionInfo.Buffer, data->PositionInfo.BufferStride, data->PositionInfo.BufferOffset);
    __this->_draw_c2905fec.Attrib1(1, data->ColorInfo.Type, data->ColorInfo.Buffer, data->ColorInfo.BufferStride, data->ColorInfo.BufferOffset);
    __this->_draw_c2905fec.Attrib1(2, data->TexCoordInfo.Type, data->TexCoordInfo.Buffer, data->TexCoordInfo.BufferStride, data->TexCoordInfo.BufferOffset);
    __this->_draw_c2905fec.Uniform12(3, data->ClipSpaceMatrix);
    __this->_draw_c2905fec.Sampler3(4, data->FontTexture, ::g::Uno::Graphics::SamplerState__TrilinearClamp());
...
void SpriteFontShader::init_DrawCalls()
{
    ...
    _draw_c2905fec = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::UnoCore_bundle::SpriteFontShaderf730f5ae());
}
