...
// public sealed extern class Switch :1464
// {
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :1476
void Switch__ctor_2_fn(Switch* __this, uObject* host)
{
    __this->ctor_2(host);
}

// private static ObjC.Object Create() :1496
void Switch__Create_fn(uObject** __retval)
{
    *__retval = Switch::Create();
}

// public override sealed void Dispose() :1482
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :1490
...
// public void set_Value(bool value) [instance] :1469
void Switch::Value(bool value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Switch", "set_Value(bool)");
    Switch::SetValue(Handle(), value);
}

// private static ObjC.Object Create() [static] :1496
uObject* Switch::Create()
{
    uStackFrame __("Fuse.Controls.Native.iOS.Switch", "Create()");
    @autoreleasepool
    {
...
// private static bool GetValue(ObjC.Object handle) [static] :1502
bool Switch::GetValue(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Switch", "GetValue(ObjC.Object)");
    @autoreleasepool
    {
...
// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :1476
...
// private static void SetValue(ObjC.Object handle, bool value) [static] :1509
void Switch::SetValue(uObject* handle, bool value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Switch", "SetValue(ObjC.Object,bool)");
    @autoreleasepool
    {
