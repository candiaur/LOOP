...
// /usr/local/share/uno/Packages/Fuse.Drawing.Batching/0.29.22/$.uno
// -----------------------------------------------------------------
...
::g::Fuse::Drawing::Batching::Batch* BatchHelpers::CreateSingleBatch(::g::Uno::Content::Models::ModelMesh* m)
{
    ...
    else
    {
        ...
        for (int i = 0; i < m->VertexCount(); i++)
            uPtr(b->Indices())->Write1((uint16_t)i);
    }
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(m)->VertexAttributes()), ::TYPES[1/*Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[2/*Uno.Collections.IEnumerator*/])); )
    {
        ...
        if (::g::Uno::String::op_Equality(v.Key(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/]), ::STRINGS[2/*"Position"*/]))
            ...
            b->TexCoord0s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->TexCoord1s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->TexCoord2s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->TexCoord3s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->TexCoord4s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->TexCoord5s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->TexCoord6s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->TexCoord7s(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->Normals(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->Tangents(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->Binormals(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->Colors(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->InstanceIndices(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->BoneWeightBuffer(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
            ...
            b->BoneIndexBuffer(BatchHelpers::CreateBatchVertexBuffer(v.Value(::TYPES[4/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/])));
    }
...
void BatchIndexBuffer::ctor_1(int type, ::g::Uno::Buffer* data)
{
    ...
    DataType(type);
    usage = 0;
    buf = ::g::Uno::Buffer::New3(uPtr(data)->SizeInBytes());

    for (int i = 0; i < uPtr(buf)->SizeInBytes(); i++)
        uPtr(buf)->Item(i, data->Item(i));
}
...
::g::Uno::Buffer* BatchIndexBuffer::Buffer()
{
    ...
    if (buf == NULL)
        buf = ::g::Uno::Buffer::New3(maxIndices * StrideInBytes());
...
::g::Uno::Buffer* BatchVertexBuffer::Buffer()
{
    ...
    if (buf == NULL)
        buf = ::g::Uno::Buffer::New3(maxVertices * StrideInBytes());
    ...
    for (int e = 0; e < uPtr(entries)->Count(); e++)
    {
        ...
        for (int i = 0; i < uPtr(m)->IndexCount(); i++)
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(virtualIndexToRealIndex), uCRef<int>(virtualIndex), &newIndex, &ret18), ret18))
            {
                ...
                if (texcoord != NULL)
                    uPtr(b->TexCoord0s())->Write3((ind4 = uPtr(texcoord)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind4.X, ind4.Y)));

                if (texcoord1 != NULL)
                    uPtr(b->TexCoord1s())->Write3((ind5 = uPtr(texcoord1)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind5.X, ind5.Y)));

                if (texcoord2 != NULL)
                    uPtr(b->TexCoord2s())->Write3((ind6 = uPtr(texcoord2)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind6.X, ind6.Y)));

                if (texcoord3 != NULL)
                    uPtr(b->TexCoord3s())->Write3((ind7 = uPtr(texcoord3)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind7.X, ind7.Y)));

                if (texcoord4 != NULL)
                    uPtr(b->TexCoord4s())->Write3((ind8 = uPtr(texcoord4)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind8.X, ind8.Y)));

                if (texcoord5 != NULL)
                    uPtr(b->TexCoord5s())->Write3((ind9 = uPtr(texcoord5)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind9.X, ind9.Y)));

                if (texcoord6 != NULL)
                    uPtr(b->TexCoord6s())->Write3((ind10 = uPtr(texcoord6)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind10.X, ind10.Y)));

                if (texcoord7 != NULL)
                    uPtr(b->TexCoord7s())->Write3((ind11 = uPtr(texcoord7)->GetFloat4(originalIndex), ::g::Uno::Float2__New2(ind11.X, ind11.Y)));

                if (normal != NULL)
                    uPtr(b->Normals())->Write4((ind12 = uPtr(normal)->GetFloat4(originalIndex), ::g::Uno::Float3__New2(ind12.X, ind12.Y, ind12.Z)));

                if (tangent != NULL)
                    uPtr(b->Tangents())->Write5(uPtr(tangent)->GetFloat4(originalIndex));

                if (binormal != NULL)
                    uPtr(b->Binormals())->Write4((ind13 = uPtr(binormal)->GetFloat4(originalIndex), ::g::Uno::Float3__New2(ind13.X, ind13.Y, ind13.Z)));

                if (color != NULL)
                    uPtr(b->Colors())->Write5(uPtr(color)->GetFloat4(originalIndex));

                if (boneWeights != NULL)
                    uPtr(b->BoneWeightBuffer())->Write2(uPtr(boneWeights)->GetByte4Normalized(originalIndex));

                if (boneIndex != NULL)
                    uPtr(b->BoneIndexBuffer())->Write2(uPtr(boneIndex)->GetByte4(originalIndex));

                uPtr(b->InstanceIndices())->Write17((uint16_t)uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(entries), uCRef<int>(e), &ret19), ret19))->InstanceIndex);
                batchVertexCount++;
            }
