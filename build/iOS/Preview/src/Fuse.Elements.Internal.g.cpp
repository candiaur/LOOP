...
// internal sealed class ElementDraw :184
// {
// static ElementDraw() :184
...
static void ElementDraw_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Elements::Internal::ElementDraw, Rectangle_LocalTransform_b1f11b73_3_9_2), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Elements::Internal::ElementDraw, Rectangle_LocalTransform_b1f11b73_3_9_3), 0,
...
// public generated ElementDraw() :184
void ElementDraw__ctor__fn(ElementDraw* __this)
{
    __this->ctor_();
}

// private generated void init_DrawCalls() :184
void ElementDraw__init_DrawCalls_fn(ElementDraw* __this)
{
    __this->init_DrawCalls();
}

// public generated ElementDraw New() :184
void ElementDraw__New1_fn(ElementDraw** __retval)
{
    *__retval = ElementDraw::New1();
}

// public void Rectangle(Fuse.DrawContext dc, Fuse.Elements.Element element, float2 offset, float2 size, float4 color) :188
...
// public generated ElementDraw() [instance] :184
...
// private generated void init_DrawCalls() [instance] :184
void ElementDraw::init_DrawCalls()
{
    ...
    Rectangle_LocalTransform_b1f11b73_3_9_2 = ::g::Uno::Matrix::Translation(-::g::Uno::Float2__New1(0.0f).X, -::g::Uno::Float2__New1(0.0f).Y, 0.0f);
    Rectangle_LocalTransform_b1f11b73_3_9_3 = ::g::Uno::Matrix::RotationZ(0.0f);
...
// public void Rectangle(Fuse.DrawContext dc, Fuse.Elements.Element element, float2 offset, float2 size, float4 color) [instance] :188
void ElementDraw::Rectangle(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* element, ::g::Uno::Float2 offset, ::g::Uno::Float2 size, ::g::Uno::Float4 color)
{
    ...
    ::g::Uno::Float4x4 LocalTransform_b1f11b73_3_9_4 = ::g::Uno::Matrix::Mul10(Rectangle_LocalTransform_b1f11b73_3_9_2, ::g::Uno::Matrix::Scaling1(size.X, size.Y, 1.0f), Rectangle_LocalTransform_b1f11b73_3_9_3, ::g::Uno::Matrix::Translation(offset.X, offset.Y, 0.0f));
    ...
    _draw_b1f11b73.Uniform12(1, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[1/*Fuse.IViewport*/])));
    _draw_b1f11b73.Uniform10(2, color);
    _draw_b1f11b73.Uniform12(3, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_b1f11b73_3_9_4, uPtr(element)->WorldTransform()) : LocalTransform_b1f11b73_3_9_4);
    _draw_b1f11b73.DrawArrays(6);
}

// public generated ElementDraw New() [static] :184
...
// internal sealed class Scale9Rectangle :209
// {
// static Scale9Rectangle() :209
...
static void Scale9Rectangle_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Fuse::Elements::Internal::Scale9Rectangle, _draw_bf332376), 0,
        ::g::Uno::UShort_typeof()->Array(), offsetof(::g::Fuse::Elements::Internal::Scale9Rectangle, Draw_indices_bf332376_1_2_13), 0,
        ::g::Uno::Graphics::IndexBuffer_typeof(), offsetof(::g::Fuse::Elements::Internal::Scale9Rectangle, Draw_xv_bf332376_1_3_2), 0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Elements::Internal::Scale9Rectangle, Draw_xv_bf332376_1_3_3), 0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Elements::Internal::Scale9Rectangle, Draw_yv_bf332376_1_4_6), 0,
...
// public generated Scale9Rectangle() :209
void Scale9Rectangle__ctor__fn(Scale9Rectangle* __this)
{
    __this->ctor_();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, texture2D tex, float4 color, float4 margin) :213
...
// private generated void init_DrawCalls() :209
void Scale9Rectangle__init_DrawCalls_fn(Scale9Rectangle* __this)
{
    __this->init_DrawCalls();
}

// public generated Scale9Rectangle New() :209
...
// public generated Scale9Rectangle() [instance] :209
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, texture2D tex, float4 color, float4 margin) [instance] :213
void Scale9Rectangle::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* element, ::g::Uno::Float2 size, ::g::Uno::Float2 scaleTextureSize, ::g::Uno::Graphics::Texture2D* tex, ::g::Uno::Float4 color, ::g::Uno::Float4 margin)
{
    ...
    _draw_bf332376.BlendEnabled(true);
    _draw_bf332376.DepthTestEnabled(false);
    _draw_bf332376.CullFace(0);
    _draw_bf332376.BlendSrcRgb(2);
    _draw_bf332376.BlendDstRgb(3);
    _draw_bf332376.BlendDstAlpha(3);
    _draw_bf332376.Use();
    _draw_bf332376.Attrib1(0, 3, Draw_xv_bf332376_1_3_3, 12, 0);
    _draw_bf332376.Attrib1(1, 3, Draw_yv_bf332376_1_4_6, 12, 0);
    _draw_bf332376.Uniform(2, margin.X);
    _draw_bf332376.Uniform(3, size.X - margin.Z);
    _draw_bf332376.Uniform(4, size.X);
    _draw_bf332376.Uniform(5, margin.Y);
    _draw_bf332376.Uniform(6, size.Y - margin.W);
    _draw_bf332376.Uniform(7, size.Y);
    _draw_bf332376.Uniform12(8, uPtr(element)->WorldTransform());
    _draw_bf332376.Uniform12(9, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(uPtr(dc)->Viewport()), ::TYPES[1/*Fuse.IViewport*/])));
    _draw_bf332376.Uniform(10, scaleTextureSize.X - margin.Z);
    _draw_bf332376.Uniform(11, scaleTextureSize.X);
    _draw_bf332376.Uniform(12, scaleTextureSize.Y - margin.W);
    _draw_bf332376.Uniform(13, scaleTextureSize.Y);
    _draw_bf332376.Uniform2(14, scaleTextureSize);
    _draw_bf332376.Uniform10(15, color);
    _draw_bf332376.Sampler2(16, tex);
    _draw_bf332376.Draw(uPtr(Draw_indices_bf332376_1_2_13)->Length(), 2, Draw_xv_bf332376_1_3_2);
}

// private generated void init_DrawCalls() [instance] :209
void Scale9Rectangle::init_DrawCalls()
{
    uStackFrame __("Fuse.Elements.Internal.Scale9Rectangle", "init_DrawCalls()");
    uArray* indices_bf332376_1_2_1 = uArray::Init<int>(::TYPES[3/*ushort[]*/], 54, 0, 4, 5, 0, 5, 1, 1, 5, 6, 1, 6, 2, 2, 6, 7, 2, 7, 3, 4, 8, 9, 4, 9, 5, 5, 9, 10, 5, 10, 6, 6, 10, 11, 6, 11, 7, 8, 12, 13, 8, 13, 9, 9, 13, 14, 9, 14, 10, 10, 14, 15, 10, 15, 11);
    Draw_xv_bf332376_1_3_2 = ::g::Uno::Graphics::IndexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer9(indices_bf332376_1_2_1), 0);
    Draw_xv_bf332376_1_3_3 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer4(uArray::Init< ::g::Uno::Float3>(::TYPES[4/*float3[]*/], 16, ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f))), 0);
    Draw_yv_bf332376_1_4_6 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer4(uArray::Init< ::g::Uno::Float3>(::TYPES[4/*float3[]*/], 16, ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f))), 0);
    Draw_indices_bf332376_1_2_13 = indices_bf332376_1_2_1;
    _draw_bf332376 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseElements_bundle::Scale9Rectangle26462ebf());
}

// public generated Scale9Rectangle New() [static] :209
