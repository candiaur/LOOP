...
// internal static extern class AppRoot :175
// {
// static AppRoot() :184
...
// private static ObjC.Object CreateAppRootView(ObjC.Object handle) [static] :190
uObject* AppRoot::CreateAppRootView(uObject* handle)
{
    uStackFrame __("Fuse.AppRoot", "CreateAppRootView(ObjC.Object)");
    AppRoot_typeof()->Init();
    @autoreleasepool
    {
...
// public static void Remove(ObjC.Object root) [static] :229
...
// private static void Remove(ObjC.Object handle, ObjC.Object childHandle) [static] :247
void AppRoot::Remove1(uObject* handle, uObject* childHandle)
{
    uStackFrame __("Fuse.AppRoot", "Remove(ObjC.Object,ObjC.Object)");
    AppRoot_typeof()->Init();
    @autoreleasepool
    {
...
// public static void Set(ObjC.Object root) [static] :220
...
// private static void Set(ObjC.Object handle, ObjC.Object childHandle) [static] :239
void AppRoot::Set1(uObject* handle, uObject* childHandle)
{
    uStackFrame __("Fuse.AppRoot", "Set(ObjC.Object,ObjC.Object)");
    AppRoot_typeof()->Init();
    @autoreleasepool
    {
        [] (::id handle, ::id childHandle) -> void
...
// private static void SetAppRootView(Uno.IntPtr handle) [static] :213
void AppRoot::SetAppRootView(void* handle)
{
    uStackFrame __("Fuse.AppRoot", "SetAppRootView(Uno.IntPtr)");
    AppRoot_typeof()->Init();
    ::g::Uno::Platform2::Application::RootView((uPlatform2::ViewNativeHandle)handle);
}

// private static void SetClearColor(ObjC.Object handle, float r, float g, float b, float a) [static] :207
void AppRoot::SetClearColor(uObject* handle, float r, float g, float b, float a)
{
    uStackFrame __("Fuse.AppRoot", "SetClearColor(ObjC.Object,float,float,float,float)");
    AppRoot_typeof()->Init();
    @autoreleasepool
    {
...
// public static void set_ClearColor(float4 value) [static] :203
void AppRoot::ClearColor(::g::Uno::Float4 value)
{
    uStackFrame __("Fuse.AppRoot", "set_ClearColor(float4)");
    AppRoot_typeof()->Init();
    AppRoot::SetClearColor(AppRoot::_appRootView(), value.X, value.Y, value.Z, value.W);
}

// public static ObjC.Object get_RootView() [static] :179
uObject* AppRoot::RootView()
{
    uStackFrame __("Fuse.AppRoot", "get_RootView()");
    AppRoot_typeof()->Init();
