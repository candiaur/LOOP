...
// /usr/local/share/uno/Packages/Fuse.Android/0.29.22/.uno/package
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.BasicTheme/0.29.22/.uno/$.uno
// ----------------------------------------------------------------
...
// public FuseBasicTheme_BasicBackButton_IsEnabled_Property(Basic.BackButton obj, Uno.UX.Selector name) :754
void FuseBasicTheme_BasicBackButton_IsEnabled_Property__ctor_2_fn(FuseBasicTheme_BasicBackButton_IsEnabled_Property* __this, ::g::Basic::BackButton* obj, ::g::Uno::UX::Selector* name)
{
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_IsEnabled_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->IsEnabled(), void();
}

// public FuseBasicTheme_BasicBackButton_IsEnabled_Property New(Basic.BackButton obj, Uno.UX.Selector name) :754
void FuseBasicTheme_BasicBackButton_IsEnabled_Property__New1_fn(::g::Basic::BackButton* obj, ::g::Uno::UX::Selector* name, FuseBasicTheme_BasicBackButton_IsEnabled_Property** __retval)
{
    *__retval = FuseBasicTheme_BasicBackButton_IsEnabled_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_IsEnabled_Property", "get_Object()");
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_IsEnabled_Property", "Set(bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_IsEnabled_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_BasicBackButton_IsEnabled_Property(Basic.BackButton obj, Uno.UX.Selector name) [instance] :754
void FuseBasicTheme_BasicBackButton_IsEnabled_Property::ctor_2(::g::Basic::BackButton* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_IsEnabled_Property", ".ctor(Basic.BackButton,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_BasicBackButton_IsEnabled_Property New(Basic.BackButton obj, Uno.UX.Selector name) [static] :754
FuseBasicTheme_BasicBackButton_IsEnabled_Property* FuseBasicTheme_BasicBackButton_IsEnabled_Property::New1(::g::Basic::BackButton* obj, ::g::Uno::UX::Selector name)
{
    FuseBasicTheme_BasicBackButton_IsEnabled_Property* obj1 = (FuseBasicTheme_BasicBackButton_IsEnabled_Property*)uNew(FuseBasicTheme_BasicBackButton_IsEnabled_Property_typeof());
...
// public FuseBasicTheme_BasicBackButton_Text_Property(Basic.BackButton obj, Uno.UX.Selector name) :736
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_Text_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Text(), void();
}

// public FuseBasicTheme_BasicBackButton_Text_Property New(Basic.BackButton obj, Uno.UX.Selector name) :736
...
{
    *__retval = FuseBasicTheme_BasicBackButton_Text_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_Text_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_Text_Property", "Set(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_Text_Property", "get_SupportsOriginSetter()");
    return *__retval = true, void();
}

// public FuseBasicTheme_BasicBackButton_Text_Property(Basic.BackButton obj, Uno.UX.Selector name) [instance] :736
void FuseBasicTheme_BasicBackButton_Text_Property::ctor_2(::g::Basic::BackButton* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_BasicBackButton_Text_Property", ".ctor(Basic.BackButton,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_BasicBackButton_Text_Property New(Basic.BackButton obj, Uno.UX.Selector name) [static] :736
FuseBasicTheme_BasicBackButton_Text_Property* FuseBasicTheme_BasicBackButton_Text_Property::New1(::g::Basic::BackButton* obj, ::g::Uno::UX::Selector name)
{
    FuseBasicTheme_BasicBackButton_Text_Property* obj1 = (FuseBasicTheme_BasicBackButton_Text_Property*)uNew(FuseBasicTheme_BasicBackButton_Text_Property_typeof());
    obj1->ctor_2(obj, name);
    return obj1;
}
// }
...
// public FuseBasicTheme_BasicButton_Opacity_Property(Basic.Button obj, Uno.UX.Selector name) :763
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Opacity_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Opacity(), void();
}

// public FuseBasicTheme_BasicButton_Opacity_Property New(Basic.Button obj, Uno.UX.Selector name) :763
...
{
    *__retval = FuseBasicTheme_BasicButton_Opacity_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Opacity_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Opacity_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Opacity_Property", "get_SupportsOriginSetter()");
    return *__retval = true, void();
}

// public FuseBasicTheme_BasicButton_Opacity_Property(Basic.Button obj, Uno.UX.Selector name) [instance] :763
void FuseBasicTheme_BasicButton_Opacity_Property::ctor_2(::g::Basic::Button* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_BasicButton_Opacity_Property", ".ctor(Basic.Button,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_BasicButton_Opacity_Property New(Basic.Button obj, Uno.UX.Selector name) [static] :763
FuseBasicTheme_BasicButton_Opacity_Property* FuseBasicTheme_BasicButton_Opacity_Property::New1(::g::Basic::Button* obj, ::g::Uno::UX::Selector name)
{
    FuseBasicTheme_BasicButton_Opacity_Property* obj1 = (FuseBasicTheme_BasicButton_Opacity_Property*)uNew(FuseBasicTheme_BasicButton_Opacity_Property_typeof());
    obj1->ctor_2(obj, name);
    return obj1;
}
// }
...
// public FuseBasicTheme_BasicButton_Text_Property(Basic.Button obj, Uno.UX.Selector name) :745
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Text_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Text(), void();
}

// public FuseBasicTheme_BasicButton_Text_Property New(Basic.Button obj, Uno.UX.Selector name) :745
...
{
    *__retval = FuseBasicTheme_BasicButton_Text_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Text_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Text_Property", "Set(string,Uno.UX.IPropertyListener)");
    uPtr(__this->_obj)->SetText(v, origin);
}
...
{
    uStackFrame __("FuseBasicTheme_BasicButton_Text_Property", "get_SupportsOriginSetter()");
    return *__retval = true, void();
}

// public FuseBasicTheme_BasicButton_Text_Property(Basic.Button obj, Uno.UX.Selector name) [instance] :745
void FuseBasicTheme_BasicButton_Text_Property::ctor_2(::g::Basic::Button* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_BasicButton_Text_Property", ".ctor(Basic.Button,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_BasicButton_Text_Property New(Basic.Button obj, Uno.UX.Selector name) [static] :745
FuseBasicTheme_BasicButton_Text_Property* FuseBasicTheme_BasicButton_Text_Property::New1(::g::Basic::Button* obj, ::g::Uno::UX::Selector name)
{
    FuseBasicTheme_BasicButton_Text_Property* obj1 = (FuseBasicTheme_BasicButton_Text_Property*)uNew(FuseBasicTheme_BasicButton_Text_Property_typeof());
    obj1->ctor_2(obj, name);
    return obj1;
}
// }
...
// public FuseBasicTheme_BasicTextInput_TextColor_Property(Basic.TextInput obj, Uno.UX.Selector name) :808
...
{
    uStackFrame __("FuseBasicTheme_BasicTextInput_TextColor_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->TextColor(), void();
}

// public FuseBasicTheme_BasicTextInput_TextColor_Property New(Basic.TextInput obj, Uno.UX.Selector name) :808
...
{
    *__retval = FuseBasicTheme_BasicTextInput_TextColor_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_BasicTextInput_TextColor_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_BasicTextInput_TextColor_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_BasicTextInput_TextColor_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_BasicTextInput_TextColor_Property(Basic.TextInput obj, Uno.UX.Selector name) [instance] :808
void FuseBasicTheme_BasicTextInput_TextColor_Property::ctor_2(::g::Basic::TextInput* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_BasicTextInput_TextColor_Property", ".ctor(Basic.TextInput,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_BasicTextInput_TextColor_Property New(Basic.TextInput obj, Uno.UX.Selector name) [static] :808
FuseBasicTheme_BasicTextInput_TextColor_Property* FuseBasicTheme_BasicTextInput_TextColor_Property::New1(::g::Basic::TextInput* obj, ::g::Uno::UX::Selector name)
{
    FuseBasicTheme_BasicTextInput_TextColor_Property* obj1 = (FuseBasicTheme_BasicTextInput_TextColor_Property*)uNew(FuseBasicTheme_BasicTextInput_TextColor_Property_typeof());
    obj1->ctor_2(obj, name);
    return obj1;
}
// }

// /usr/local/share/uno/Packages/Fuse.BasicTheme/0.29.22/.uno/package
// ------------------------------------------------------------------
...
{
    FuseBasicTheme_bundle::RobotoLight50951d55_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[7/*"Fuse.BasicT...*/]))->GetFile(::STRINGS[8/*"roboto-ligh...*/]);
    FuseBasicTheme_bundle::RobotoMedium34aee4de_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[7/*"Fuse.BasicT...*/]))->GetFile(::STRINGS[9/*"roboto-medi...*/]);
    FuseBasicTheme_bundle::RobotoRegularc525ea1b_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[7/*"Fuse.BasicT...*/]))->GetFile(::STRINGS[10/*"roboto-regu...*/]);
}
...
static void FuseBasicTheme_bundle_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseBasicTheme_bundle::RobotoLight50951d55_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseBasicTheme_bundle::RobotoMedium34aee4de_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseBasicTheme_bundle::RobotoRegularc525ea1b_, uFieldFlagsStatic);
    type->Reflection.SetFields(3,
        new uField("RobotoLight50951d55", 0),
        new uField("RobotoMedium34aee4de", 1),
        new uField("RobotoRegularc525ea1b", 2));
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseBasicTheme_bundle::RobotoLight50951d55_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseBasicTheme_bundle::RobotoMedium34aee4de_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseBasicTheme_bundle::RobotoRegularc525ea1b_;
// }
...
// public FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property(Fuse.Animations.Change<float4> obj, Uno.UX.Selector name) :727
...
{
    uStackFrame __("FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property", "Get()");
    ::g::Uno::Float4 ret2;
    return *__retval = (::g::Fuse::Animations::Change__get_Value_fn(uPtr(__this->_obj), &ret2), ret2), void();
}

// public FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property New(Fuse.Animations.Change<float4> obj, Uno.UX.Selector name) :727
...
{
    uStackFrame __("FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property(Fuse.Animations.Change<float4> obj, Uno.UX.Selector name) [instance] :727
void FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property::ctor_2(::g::Fuse::Animations::Change* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property", ".ctor(Fuse.Animations.Change<float4>,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property New(Fuse.Animations.Change<float4> obj, Uno.UX.Selector name) [static] :727
...
// public FuseBasicTheme_FuseControlsCircle_Opacity_Property(Fuse.Controls.Circle obj, Uno.UX.Selector name) :790
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsCircle_Opacity_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Opacity(), void();
}

// public FuseBasicTheme_FuseControlsCircle_Opacity_Property New(Fuse.Controls.Circle obj, Uno.UX.Selector name) :790
...
{
    *__retval = FuseBasicTheme_FuseControlsCircle_Opacity_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsCircle_Opacity_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsCircle_Opacity_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
    uPtr(__this->_obj)->SetOpacity(v_, origin);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsCircle_Opacity_Property", "get_SupportsOriginSetter()");
    return *__retval = true, void();
}

// public FuseBasicTheme_FuseControlsCircle_Opacity_Property(Fuse.Controls.Circle obj, Uno.UX.Selector name) [instance] :790
void FuseBasicTheme_FuseControlsCircle_Opacity_Property::ctor_2(::g::Fuse::Controls::Circle* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseControlsCircle_Opacity_Property", ".ctor(Fuse.Controls.Circle,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseControlsCircle_Opacity_Property New(Fuse.Controls.Circle obj, Uno.UX.Selector name) [static] :790
FuseBasicTheme_FuseControlsCircle_Opacity_Property* FuseBasicTheme_FuseControlsCircle_Opacity_Property::New1(::g::Fuse::Controls::Circle* obj, ::g::Uno::UX::Selector name)
{
...
// public FuseBasicTheme_FuseControlsRectangle_Height_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :817
void FuseBasicTheme_FuseControlsRectangle_Height_Property__ctor_2_fn(FuseBasicTheme_FuseControlsRectangle_Height_Property* __this, ::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_2(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Height_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Height(), void();
}

// public FuseBasicTheme_FuseControlsRectangle_Height_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :817
void FuseBasicTheme_FuseControlsRectangle_Height_Property__New1_fn(::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector* name, FuseBasicTheme_FuseControlsRectangle_Height_Property** __retval)
{
    *__retval = FuseBasicTheme_FuseControlsRectangle_Height_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Height_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Height_Property", "Set(Uno.UX.Size,Uno.UX.IPropertyListener)");
    ::g::Uno::UX::Size v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Height_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_FuseControlsRectangle_Height_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [instance] :817
void FuseBasicTheme_FuseControlsRectangle_Height_Property::ctor_2(::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Height_Property", ".ctor(Fuse.Controls.Rectangle,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseControlsRectangle_Height_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [static] :817
FuseBasicTheme_FuseControlsRectangle_Height_Property* FuseBasicTheme_FuseControlsRectangle_Height_Property::New1(::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector name)
{
...
// public FuseBasicTheme_FuseControlsRectangle_Width_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :772
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Width_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Width(), void();
}

// public FuseBasicTheme_FuseControlsRectangle_Width_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :772
...
{
    *__retval = FuseBasicTheme_FuseControlsRectangle_Width_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Width_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Width_Property", "Set(Uno.UX.Size,Uno.UX.IPropertyListener)");
    ::g::Uno::UX::Size v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Width_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_FuseControlsRectangle_Width_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [instance] :772
void FuseBasicTheme_FuseControlsRectangle_Width_Property::ctor_2(::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseControlsRectangle_Width_Property", ".ctor(Fuse.Controls.Rectangle,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseControlsRectangle_Width_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [static] :772
FuseBasicTheme_FuseControlsRectangle_Width_Property* FuseBasicTheme_FuseControlsRectangle_Width_Property::New1(::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector name)
{
...
// public FuseBasicTheme_FuseControlsText_TextColor_Property(Fuse.Controls.Text obj, Uno.UX.Selector name) :700
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_TextColor_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->TextColor(), void();
}

// public FuseBasicTheme_FuseControlsText_TextColor_Property New(Fuse.Controls.Text obj, Uno.UX.Selector name) :700
...
{
    *__retval = FuseBasicTheme_FuseControlsText_TextColor_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_TextColor_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_TextColor_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
    uPtr(__this->_obj)->TextColor(v_);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_TextColor_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_FuseControlsText_TextColor_Property(Fuse.Controls.Text obj, Uno.UX.Selector name) [instance] :700
void FuseBasicTheme_FuseControlsText_TextColor_Property::ctor_2(::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_TextColor_Property", ".ctor(Fuse.Controls.Text,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseControlsText_TextColor_Property New(Fuse.Controls.Text obj, Uno.UX.Selector name) [static] :700
FuseBasicTheme_FuseControlsText_TextColor_Property* FuseBasicTheme_FuseControlsText_TextColor_Property::New1(::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector name)
{
...
// public FuseBasicTheme_FuseControlsText_Value_Property(Fuse.Controls.Text obj, Uno.UX.Selector name) :691
void FuseBasicTheme_FuseControlsText_Value_Property__ctor_2_fn(FuseBasicTheme_FuseControlsText_Value_Property* __this, ::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_2(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_Value_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Value(), void();
}

// public FuseBasicTheme_FuseControlsText_Value_Property New(Fuse.Controls.Text obj, Uno.UX.Selector name) :691
void FuseBasicTheme_FuseControlsText_Value_Property__New1_fn(::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector* name, FuseBasicTheme_FuseControlsText_Value_Property** __retval)
{
    *__retval = FuseBasicTheme_FuseControlsText_Value_Property::New1(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_Value_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_Value_Property", "Set(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_Value_Property", "get_SupportsOriginSetter()");
    return *__retval = true, void();
}

// public FuseBasicTheme_FuseControlsText_Value_Property(Fuse.Controls.Text obj, Uno.UX.Selector name) [instance] :691
void FuseBasicTheme_FuseControlsText_Value_Property::ctor_2(::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseControlsText_Value_Property", ".ctor(Fuse.Controls.Text,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseControlsText_Value_Property New(Fuse.Controls.Text obj, Uno.UX.Selector name) [static] :691
FuseBasicTheme_FuseControlsText_Value_Property* FuseBasicTheme_FuseControlsText_Value_Property::New1(::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector name)
{
...
// public FuseBasicTheme_FuseDrawingSolidColor_Color_Property(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) :709
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingSolidColor_Color_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Color(), void();
}

// public FuseBasicTheme_FuseDrawingSolidColor_Color_Property New(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) :709
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingSolidColor_Color_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingSolidColor_Color_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingSolidColor_Color_Property", "get_SupportsOriginSetter()");
    return *__retval = true, void();
}

// public FuseBasicTheme_FuseDrawingSolidColor_Color_Property(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) [instance] :709
void FuseBasicTheme_FuseDrawingSolidColor_Color_Property::ctor_2(::g::Fuse::Drawing::SolidColor* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseDrawingSolidColor_Color_Property", ".ctor(Fuse.Drawing.SolidColor,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseDrawingSolidColor_Color_Property New(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) [static] :709
...
// public FuseBasicTheme_FuseDrawingStroke_Width_Property(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) :799
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingStroke_Width_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Width(), void();
}

// public FuseBasicTheme_FuseDrawingStroke_Width_Property New(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) :799
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingStroke_Width_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingStroke_Width_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
    uPtr(__this->_obj)->Width(v_);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseDrawingStroke_Width_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_FuseDrawingStroke_Width_Property(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) [instance] :799
void FuseBasicTheme_FuseDrawingStroke_Width_Property::ctor_2(::g::Fuse::Drawing::Stroke* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseDrawingStroke_Width_Property", ".ctor(Fuse.Drawing.Stroke,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseDrawingStroke_Width_Property New(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) [static] :799
...
// public FuseBasicTheme_FuseEffectsDropShadow_Color_Property(Fuse.Effects.DropShadow obj, Uno.UX.Selector name) :718
...
{
    uStackFrame __("FuseBasicTheme_FuseEffectsDropShadow_Color_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Color(), void();
}

// public FuseBasicTheme_FuseEffectsDropShadow_Color_Property New(Fuse.Effects.DropShadow obj, Uno.UX.Selector name) :718
...
{
    uStackFrame __("FuseBasicTheme_FuseEffectsDropShadow_Color_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseEffectsDropShadow_Color_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_FuseEffectsDropShadow_Color_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_FuseEffectsDropShadow_Color_Property(Fuse.Effects.DropShadow obj, Uno.UX.Selector name) [instance] :718
void FuseBasicTheme_FuseEffectsDropShadow_Color_Property::ctor_2(::g::Fuse::Effects::DropShadow* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseEffectsDropShadow_Color_Property", ".ctor(Fuse.Effects.DropShadow,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseEffectsDropShadow_Color_Property New(Fuse.Effects.DropShadow obj, Uno.UX.Selector name) [static] :718
...
// public FuseBasicTheme_FuseTranslation_X_Property(Fuse.Translation obj, Uno.UX.Selector name) :781
void FuseBasicTheme_FuseTranslation_X_Property__ctor_2_fn(FuseBasicTheme_FuseTranslation_X_Property* __this, ::g::Fuse::Translation* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_2(obj, *name);
}
...
{
    uStackFrame __("FuseBasicTheme_FuseTranslation_X_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->X(), void();
}

// public FuseBasicTheme_FuseTranslation_X_Property New(Fuse.Translation obj, Uno.UX.Selector name) :781
...
{
    uStackFrame __("FuseBasicTheme_FuseTranslation_X_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}
...
{
    uStackFrame __("FuseBasicTheme_FuseTranslation_X_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
...
{
    uStackFrame __("FuseBasicTheme_FuseTranslation_X_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public FuseBasicTheme_FuseTranslation_X_Property(Fuse.Translation obj, Uno.UX.Selector name) [instance] :781
void FuseBasicTheme_FuseTranslation_X_Property::ctor_2(::g::Fuse::Translation* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("FuseBasicTheme_FuseTranslation_X_Property", ".ctor(Fuse.Translation,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public FuseBasicTheme_FuseTranslation_X_Property New(Fuse.Translation obj, Uno.UX.Selector name) [static] :781
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.29.22/.uno/package
// ----------------------------------------------------------------
...
{
    FuseControls_bundle::SolidRectangleafb52825_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[11/*"uniform mat...*/], ::STRINGS[12/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[20/*"n"*/]));
    FuseControls_bundle::SolidRectangleafb52826_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[21/*"uniform mat...*/], ::STRINGS[22/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/]));
    FuseControls_bundle::SolidRectangleafb52827_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[23/*"uniform mat...*/], ::STRINGS[24/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[19/*"l"*/]));
    FuseControls_bundle::Viewportb83477c3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[25/*"uniform mat...*/], ::STRINGS[26/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/]));
}

static void FuseControls_bundle_build(uType* type)
{
    ::STRINGS[11] = uString::Const("uniform mat4 l, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[12] = uString::Const("uniform vec4 i;\n"
        "uniform float j, k;\n"
        "\n"
        "uniform sampler2D n;\n"
        "\n"
    ...
    ::STRINGS[21] = uString::Const("uniform mat4 d, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[22] = uString::Const("uniform vec4 c;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = c;\n"
        "}\n"
        "");
    ::STRINGS[23] = uString::Const("uniform mat4 h, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[24] = uString::Const("uniform float f, g;\n"
        "\n"
        "uniform sampler2D l;\n"
        "\n"
        "varying float k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[25] = uString::Const("uniform mat4 c, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[26] = uString::Const("uniform sampler2D e;\n"
        "\n"
        "varying vec2 d;\n"
        "\n"
        "void main()\n"
    ...
    type->Reflection.SetFields(4,
        new uField("SolidRectangleafb52825", 0),
        new uField("SolidRectangleafb52826", 1),
        new uField("SolidRectangleafb52827", 2),
        new uField("Viewportb83477c3", 3));
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/0.29.22/.uno/package
// -----------------------------------------------------------------------
...
{
    FuseControlsNative_bundle::iOSBlitter389256a7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[27/*"uniform vec...*/], ::STRINGS[1/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"f"*/]));
}

static void FuseControlsNative_bundle_build(uType* type)
{
    ::STRINGS[27] = uString::Const("uniform vec2 c, b;\n"
        "uniform mat4 d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
    ...
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseControlsNative_bundle::iOSBlitter389256a7_, uFieldFlagsStatic);
    type->Reflection.SetFields(1,
        new uField("iOSBlitter389256a7", 0));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseControlsNative_bundle::iOSBlitter389256a7_;
// }

// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/0.29.22/.uno/$.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.29.22/.uno/package
// ---------------------------------------------------------------------------
...
{
    FuseControlsPrimitives_bundle::ImageElementDraw25a5f7fe_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[28/*"uniform mat...*/], ::STRINGS[29/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[15/*"h"*/]));
}
...
static void FuseControlsPrimitives_bundle_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseControlsPrimitives_bundle::ImageElementDraw25a5f7fe_, uFieldFlagsStatic);
    type->Reflection.SetFields(1,
        new uField("ImageElementDraw25a5f7fe", 0));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseControlsPrimitives_bundle::ImageElementDraw25a5f7fe_;
// }

// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.29.22/.uno/$.uno
// -------------------------------------------------------------------------
...
// public FuseControlsPrimitives_FuseControlsBackButton_Text_Property(Fuse.Controls.BackButton obj, Uno.UX.Selector name) :646
...
// public FuseControlsPrimitives_FuseControlsBackButton_Text_Property New(Fuse.Controls.BackButton obj, Uno.UX.Selector name) :646
...
// public FuseControlsPrimitives_FuseControlsBackButton_Text_Property(Fuse.Controls.BackButton obj, Uno.UX.Selector name) [instance] :646
...
// public FuseControlsPrimitives_FuseControlsBackButton_Text_Property New(Fuse.Controls.BackButton obj, Uno.UX.Selector name) [static] :646
...
// public FuseControlsPrimitives_FuseControlsCircle_Fill_Property(Fuse.Controls.Circle obj, Uno.UX.Selector name) :700
...
// public FuseControlsPrimitives_FuseControlsCircle_Fill_Property New(Fuse.Controls.Circle obj, Uno.UX.Selector name) :700
...
// public FuseControlsPrimitives_FuseControlsCircle_Fill_Property(Fuse.Controls.Circle obj, Uno.UX.Selector name) [instance] :700
...
// public FuseControlsPrimitives_FuseControlsCircle_Fill_Property New(Fuse.Controls.Circle obj, Uno.UX.Selector name) [static] :700
...
// public FuseControlsPrimitives_FuseControlsCircle_Opacity_Property(Fuse.Controls.Circle obj, Uno.UX.Selector name) :691
...
// public FuseControlsPrimitives_FuseControlsCircle_Opacity_Property New(Fuse.Controls.Circle obj, Uno.UX.Selector name) :691
...
// public FuseControlsPrimitives_FuseControlsCircle_Opacity_Property(Fuse.Controls.Circle obj, Uno.UX.Selector name) [instance] :691
...
// public FuseControlsPrimitives_FuseControlsCircle_Opacity_Property New(Fuse.Controls.Circle obj, Uno.UX.Selector name) [static] :691
...
// public FuseControlsPrimitives_FuseControlsRectangle_Fill_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :736
...
// public FuseControlsPrimitives_FuseControlsRectangle_Fill_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :736
...
// public FuseControlsPrimitives_FuseControlsRectangle_Fill_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [instance] :736
...
// public FuseControlsPrimitives_FuseControlsRectangle_Fill_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [static] :736
...
// public FuseControlsPrimitives_FuseDrawingStroke_Brush_Property(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) :709
...
// public FuseControlsPrimitives_FuseDrawingStroke_Brush_Property New(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) :709
...
// public FuseControlsPrimitives_FuseDrawingStroke_Brush_Property(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) [instance] :709
...
// public FuseControlsPrimitives_FuseDrawingStroke_Brush_Property New(Fuse.Drawing.Stroke obj, Uno.UX.Selector name) [static] :709
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/0.29.22/.uno/$.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/0.29.22/.uno/package
// ----------------------------------------------------------------------
...
{
    FuseControlsVideo_bundle::Scale9Rectangleb08a8ede_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[30/*"uniform flo...*/], ::STRINGS[31/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[34/*"q"*/]));
    FuseControlsVideo_bundle::VideoDrawElementd598cf98_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[35/*"uniform mat...*/], ::STRINGS[36/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[14/*"g"*/]));
}
...
static void FuseControlsVideo_bundle_build(uType* type)
{
    ::STRINGS[30] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[31] = uString::Const("uniform sampler2D q;\n"
        "\n"
        "varying vec2 p;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[18] = uString::Const("k");
    ::STRINGS[19] = uString::Const("l");
    ::STRINGS[32] = uString::Const("m");
    ::STRINGS[20] = uString::Const("n");
    ::STRINGS[33] = uString::Const("o");
    ::STRINGS[34] = uString::Const("q");
    ::STRINGS[35] = uString::Const("uniform mat4 e, b;\n"
        "uniform vec2 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[36] = uString::Const("uniform sampler2D g;\n"
        "\n"
        "varying vec2 f;\n"
        "\n"
        "void main()\n"
    ...
    type->Reflection.SetFields(2,
        new uField("Scale9Rectangleb08a8ede", 0),
        new uField("VideoDrawElementd598cf98", 1));
}
...
// /usr/local/share/uno/Packages/FuseCore/0.29.22/.uno/package
// -----------------------------------------------------------
...
{
    FuseCore_bundle::DrawHelpersbba46184_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[37/*"uniform vec...*/], ::STRINGS[38/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/]));
    FuseCore_bundle::RobotoRegularbc36ee02_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[39/*"FuseCore"*/]))->GetFile(::STRINGS[40/*"roboto-regu...*/]);
}

static void FuseCore_bundle_build(uType* type)
{
    ::STRINGS[37] = uString::Const("uniform vec2 c, b;\n"
        "uniform mat4 d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[38] = uString::Const("uniform vec4 e;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = e;\n"
    ...
    ::STRINGS[5] = uString::Const("d");
    ::STRINGS[13] = uString::Const("e");
    ::STRINGS[39] = uString::Const("FuseCore");
    ::STRINGS[40] = uString::Const("roboto-regular-8e96360c.ttf");
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
        ...
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseCore_bundle::RobotoRegularbc36ee02_, uFieldFlagsStatic);
    type->Reflection.SetFields(2,
        new uField("DrawHelpersbba46184", 0),
        new uField("RobotoRegularbc36ee02", 1));
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseCore_bundle::RobotoRegularbc36ee02_;
// }

// /usr/local/share/uno/Packages/Fuse.Drawing/0.29.22/.uno/package
// ---------------------------------------------------------------
...
{
    FuseDrawing_bundle::LinearGradientDrawable066bc6f3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[41/*"attribute v...*/], ::STRINGS[42/*"uniform flo...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/]));
}
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Polygons/0.29.22/.uno/package
// ------------------------------------------------------------------------
...
{
    FuseDrawingPolygons_bundle::Borderabeb3b3d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[43/*"uniform mat...*/], ::STRINGS[44/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[32/*"m"*/]));
    FuseDrawingPolygons_bundle::Borderabeb3b3e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[45/*"uniform mat...*/], ::STRINGS[46/*"varying vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/]));
    FuseDrawingPolygons_bundle::Borderabeb3b3f_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[47/*"uniform mat...*/], ::STRINGS[48/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[18/*"k"*/]));
    FuseDrawingPolygons_bundle::Borderabeb3b40_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[49/*"uniform mat...*/], ::STRINGS[50/*"varying vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawablefeed06e7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[51/*"uniform mat...*/], ::STRINGS[52/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[19/*"l"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawablefeed06e8_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[53/*"uniform mat...*/], ::STRINGS[22/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawablefeed06e9_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[54/*"uniform mat...*/], ::STRINGS[55/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[17/*"j"*/]));
}

static void FuseDrawingPolygons_bundle_build(uType* type)
{
    ::STRINGS[43] = uString::Const("uniform mat4 c;\n"
        "uniform vec2 d, e, f, g, h;\n"
        "\n"
        "attribute vec4 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[44] = uString::Const("uniform vec4 i;\n"
        "uniform float j;\n"
        "\n"
        "uniform sampler2D m;\n"
        "\n"
    ...
    ::STRINGS[45] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[46] = uString::Const("varying vec4 e;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = e;\n"
    ...
    ::STRINGS[49] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[50] = uString::Const("varying vec4 d;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = d;\n"
        "}\n"
        "");
    ::STRINGS[51] = uString::Const("uniform mat4 c;\n"
        "uniform vec2 d, e, f, g, h;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[52] = uString::Const("uniform vec4 i;\n"
        "uniform float j;\n"
        "\n"
        "uniform sampler2D l;\n"
        "\n"
        ...
        "");
    ::STRINGS[19] = uString::Const("l");
    ::STRINGS[53] = uString::Const("uniform mat4 b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
    ...
    ::STRINGS[22] = uString::Const("uniform vec4 c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[54] = uString::Const("uniform mat4 b;\n"
        "uniform vec2 c, d, e, g;\n"
        "uniform float h;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[55] = uString::Const("uniform float f;\n"
        "\n"
        "uniform sampler2D j;\n"
        "\n"
        "varying float i;\n"
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Primitives/0.29.22/.uno/package
// --------------------------------------------------------------------------
...
{
    FuseDrawingPrimitives_bundle::Circle2a09f04b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[56/*"uniform vec...*/], ::STRINGS[57/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[59/*"r"*/], ::STRINGS[60/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle2a09f04c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[56/*"uniform vec...*/], ::STRINGS[61/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[59/*"r"*/], ::STRINGS[60/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle2a09f04d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[62/*"uniform vec...*/], ::STRINGS[63/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[59/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle2a0b4d6b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[64/*"uniform vec...*/], ::STRINGS[65/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circle2a0b4d6c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[64/*"uniform vec...*/], ::STRINGS[66/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circle2a0b4d82_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[67/*"uniform vec...*/], ::STRINGS[68/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 10, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/]));
    FuseDrawingPrimitives_bundle::Circle2a16366b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[69/*"uniform vec...*/], ::STRINGS[70/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[71/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle2a16366c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[69/*"uniform vec...*/], ::STRINGS[72/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[71/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle2a16366d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[73/*"uniform vec...*/], ::STRINGS[74/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[58/*"p"*/]));
    FuseDrawingPrimitives_bundle::Circle2a17938b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[75/*"uniform vec...*/], ::STRINGS[76/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle2a17938c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[75/*"uniform vec...*/], ::STRINGS[77/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle2a17938d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[78/*"uniform vec...*/], ::STRINGS[79/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/]));
    FuseDrawingPrimitives_bundle::Circle32dc887c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[80/*"uniform vec...*/], ::STRINGS[81/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[59/*"r"*/], ::STRINGS[60/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle32dc887d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[82/*"uniform vec...*/], ::STRINGS[83/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[59/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c424a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[84/*"uniform vec...*/], ::STRINGS[85/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 21, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[59/*"r"*/], ::STRINGS[71/*"s"*/], ::STRINGS[86/*"t"*/], ::STRINGS[87/*"w"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c424b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[84/*"uniform vec...*/], ::STRINGS[88/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 21, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[59/*"r"*/], ::STRINGS[71/*"s"*/], ::STRINGS[86/*"t"*/], ::STRINGS[87/*"w"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c424c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[89/*"uniform vec...*/], ::STRINGS[90/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[86/*"t"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c4d90_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[91/*"uniform vec...*/], ::STRINGS[92/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c4d91_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[91/*"uniform vec...*/], ::STRINGS[93/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c4d92_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[75/*"uniform vec...*/], ::STRINGS[94/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c58d6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[80/*"uniform vec...*/], ::STRINGS[95/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[59/*"r"*/], ::STRINGS[60/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circlef0db6dc4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[96/*"uniform vec...*/], ::STRINGS[97/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circlef0db6dc5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[96/*"uniform vec...*/], ::STRINGS[98/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circlef0db6dc6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[99/*"uniform vec...*/], ::STRINGS[100/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62db4f9_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[101/*"uniform flo...*/], ::STRINGS[102/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 20, ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[59/*"r"*/], ::STRINGS[71/*"s"*/], ::STRINGS[103/*"x"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62db4fa_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[104/*"uniform flo...*/], ::STRINGS[105/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62db4fb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[106/*"uniform flo...*/], ::STRINGS[107/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[108/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62db4fc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[109/*"uniform flo...*/], ::STRINGS[110/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62dc401_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[111/*"uniform flo...*/], ::STRINGS[112/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[108/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62dc402_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[113/*"uniform flo...*/], ::STRINGS[114/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62dc403_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[115/*"uniform flo...*/], ::STRINGS[116/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[86/*"t"*/]));
    FuseDrawingPrimitives_bundle::Rectangleb62dc404_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[117/*"uniform flo...*/], ::STRINGS[118/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/]));
}
...
static void FuseDrawingPrimitives_bundle_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("n");
    ::STRINGS[33] = uString::Const("o");
    ::STRINGS[58] = uString::Const("p");
    ::STRINGS[34] = uString::Const("q");
    ::STRINGS[59] = uString::Const("r");
    ...
    ::STRINGS[61] = uString::Const("uniform vec4 k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[62] = uString::Const("uniform vec2 c, d, f, g, h, i, j;\n"
        "uniform mat4 e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[63] = uString::Const("uniform vec4 k;\n"
        "uniform float l, m, n, o;\n"
        "\n"
        "uniform sampler2D r;\n"
        "\n"
    ...
    ::STRINGS[64] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[65] = uString::Const("uniform float e, f, g, h, j;\n"
        "uniform vec2 k, l, m;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[66] = uString::Const("uniform float e, f, g, h, j;\n"
        "uniform vec2 k, l, m;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 n;\n"
    ...
    ::STRINGS[67] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[68] = uString::Const("uniform float e, f, g, h, j;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 k;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[69] = uString::Const("uniform vec2 b, c, e, f, g, l;\n"
        "uniform mat4 d;\n"
        "uniform float m;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[70] = uString::Const("uniform float h, i, j, k;\n"
        "uniform vec2 n, o, p;\n"
        "\n"
        "uniform sampler2D s;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[71] = uString::Const("s");
    ::STRINGS[72] = uString::Const("uniform float h, i, j, k;\n"
        "uniform vec2 n, o, p;\n"
        "\n"
        "uniform sampler2D s;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[73] = uString::Const("uniform vec2 b, c, e, f, g, l;\n"
        "uniform mat4 d;\n"
        "uniform float m;\n"
        "\n"
        "attribute vec2 a;\n"
    ...
    ::STRINGS[77] = uString::Const("uniform float e, f, g, h;\n"
        ...
        "}\n"
        "");
    ::STRINGS[78] = uString::Const("uniform vec2 b, c;\n"
        "uniform mat4 d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[79] = uString::Const("uniform float e, f, g, h;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 j;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[80] = uString::Const("uniform vec2 b, c, e, f, g, n;\n"
        "uniform mat4 d;\n"
        "uniform float o;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[81] = uString::Const("uniform float h, i, j, k, l, m;\n"
        "uniform vec2 p, q, r;\n"
        "\n"
        "uniform sampler2D u;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[82] = uString::Const("uniform vec2 b, c, e, f, g, n;\n"
        "uniform mat4 d;\n"
        "uniform float o;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[83] = uString::Const("uniform float h, i, j, k, l, m;\n"
        "\n"
        "uniform sampler2D r;\n"
        "\n"
        "varying float p;\n"
        ...
        "}\n"
        "");
    ::STRINGS[84] = uString::Const("uniform vec2 c, d, f, g, h, i, j;\n"
        "uniform mat4 e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[85] = uString::Const("uniform vec4 k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[86] = uString::Const("t");
    ::STRINGS[87] = uString::Const("w");
    ::STRINGS[88] = uString::Const("uniform vec4 k;\n"
        "uniform float l, m, n, o, p, q;\n"
        "uniform vec2 r, s, t;\n"
        "\n"
        "uniform sampler2D w;\n"
    ...
    ::STRINGS[90] = uString::Const("uniform vec4 k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[91] = uString::Const("uniform vec2 b, c;\n"
        "uniform mat4 d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[92] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec2 m, n, o;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 p;\n"
        ...
        "}\n"
        "");
    ::STRINGS[93] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec2 m, n, o;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 p;\n"
    ...
    ::STRINGS[94] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[95] = uString::Const("uniform float h, i, j, k, l, m;\n"
        "uniform vec2 p, q, r;\n"
        "\n"
        "uniform sampler2D u;\n"
        "\n"
    ...
    ::STRINGS[97] = uString::Const("uniform float e, f, g, h, i, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[98] = uString::Const("uniform float e, f, g, h, i, j;\n"
        "uniform vec2 l, m, n;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 o;\n"
    ...
    ::STRINGS[99] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[100] = uString::Const("uniform float e, f, g, h, i, j;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 l;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[101] = uString::Const("uniform float f[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[102] = uString::Const("uniform vec4 n;\n"
    ...
    ::STRINGS[104] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[105] = uString::Const("uniform float h, i, j, k, l, n;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float o;\n"
        "varying vec2 p, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[106] = uString::Const("uniform float e[d], q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[107] = uString::Const("uniform float k, l, m, n, o;\n"
        "\n"
        "uniform sampler2D v;\n"
        "\n"
        "varying float r, s;\n"
    ...
    ::STRINGS[109] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[110] = uString::Const("uniform float h, i, j, k, l;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float n;\n"
        "varying vec2 o, p;\n"
    ...
    ::STRINGS[114] = uString::Const("uniform float h, i, j, l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[115] = uString::Const("uniform float e[d], o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[116] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
    ...
    ::STRINGS[117] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[118] = uString::Const("uniform float h, i, j;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float l;\n"
        "varying vec2 m, n;\n"
    ...
    type->Reflection.SetFields(32,
        ...
        new uField("Rectangleb62db4f9", 24),
        new uField("Rectangleb62db4fa", 25),
        new uField("Rectangleb62db4fb", 26),
        new uField("Rectangleb62db4fc", 27),
        new uField("Rectangleb62dc401", 28),
        new uField("Rectangleb62dc402", 29),
        new uField("Rectangleb62dc403", 30),
        new uField("Rectangleb62dc404", 31));
}
...
// /usr/local/share/uno/Packages/Fuse.Effects/0.29.22/.uno/package
// ---------------------------------------------------------------
...
{
    FuseEffects_bundle::Blitter1ef54105_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[119/*"uniform mat...*/], ::STRINGS[120/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[15/*"h"*/]));
    FuseEffects_bundle::Blurec489e30_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[121/*"uniform mat...*/], ::STRINGS[122/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/]));
    FuseEffects_bundle::Desaturatec68ecebc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[123/*"uniform mat...*/], ::STRINGS[124/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"f"*/]));
    FuseEffects_bundle::EffectHelpers19f0dc38_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[125/*"attribute v...*/], ::STRINGS[126/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/]));
    FuseEffects_bundle::EffectHelpers36c238d5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[127/*"uniform vec...*/], ::STRINGS[128/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[32/*"m"*/]));
    FuseEffects_bundle::EffectHelpers4273de51_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[129/*"uniform vec...*/], ::STRINGS[130/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[86/*"t"*/]));
    FuseEffects_bundle::EffectHelpersde6318b0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[131/*"attribute v...*/], ::STRINGS[132/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[15/*"h"*/]));
    FuseEffects_bundle::Halftoneb6f474d8_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[133/*"uniform mat...*/], ::STRINGS[134/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[34/*"q"*/]));
    FuseEffects_bundle::Mask76ebab4c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[135/*"uniform mat...*/], ::STRINGS[136/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/]));
    FuseEffects_bundle::Mask76ebab4d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[135/*"uniform mat...*/], ::STRINGS[137/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/]));
    FuseEffects_bundle::Mask76ebab4e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[135/*"uniform mat...*/], ::STRINGS[138/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/]));
}

static void FuseEffects_bundle_build(uType* type)
{
    ::STRINGS[119] = uString::Const("uniform mat4 f, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 g;\n"
        ...
        "}\n"
        "");
    ::STRINGS[120] = uString::Const("uniform vec3 e;\n"
        "uniform float c, d;\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
    ...
    ::STRINGS[6] = uString::Const("f");
    ::STRINGS[15] = uString::Const("h");
    ::STRINGS[121] = uString::Const("uniform mat4 c, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[122] = uString::Const("uniform sampler2D e;\n"
        "\n"
        "varying vec2 d;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[123] = uString::Const("uniform mat4 d, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 e;\n"
    ...
    ::STRINGS[124] = uString::Const("uniform float c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[125] = uString::Const("attribute vec2 a;\n"
        "\n"
        "varying vec2 b;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[126] = uString::Const("uniform sampler2D c;\n"
        "\n"
        "varying vec2 b;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[127] = uString::Const("uniform vec2 c, e, f, g;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[128] = uString::Const("uniform float b, d;\n"
        "\n"
        "uniform sampler2D m;\n"
        "\n"
        "varying vec2 h, i, j, k, l;\n"
    ...
    ::STRINGS[19] = uString::Const("l");
    ::STRINGS[34] = uString::Const("q");
    ::STRINGS[135] = uString::Const("uniform mat4 c, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 d, e;\n"
        ...
        "}\n"
        "");
    ::STRINGS[136] = uString::Const("uniform sampler2D f, g;\n"
        "\n"
        "varying vec2 d, e;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[137] = uString::Const("uniform sampler2D f, g;\n"
        "\n"
        "varying vec2 d, e;\n"
        "\n"
        "void main()\n"
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.29.22/.uno/package
// ----------------------------------------------------------------
...
{
    FuseElements_bundle::CacheHelper09c90965_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[139/*"uniform vec...*/], ::STRINGS[140/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[14/*"g"*/]));
    FuseElements_bundle::ElementBatch47d0cb7a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[141/*"uniform mat...*/], ::STRINGS[142/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"f"*/]));
    FuseElements_bundle::Scale9Rectangle26462ebf_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[143/*"uniform flo...*/], ::STRINGS[144/*"uniform vec...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[59/*"r"*/]));
}
...
static void FuseElements_bundle_build(uType* type)
{
    ...
    type->Reflection.SetFields(3,
        ...
        new uField("Scale9Rectangle26462ebf", 2));
}
...
// /usr/local/share/uno/Packages/Fuse.Entities/0.29.22/.uno/package
// ----------------------------------------------------------------
...
{
    FuseEntities_bundle::Blur17c40e2b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[145/*"uniform vec...*/], ::STRINGS[146/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[15/*"h"*/]));
    FuseEntities_bundle::FindEdges6e47be68_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[147/*"uniform vec...*/], ::STRINGS[148/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[20/*"n"*/]));
    FuseEntities_bundle::MeshBatchingEngine2a0b934a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[149/*"uniform mat...*/], ::STRINGS[150/*"uniform vec...*/], 3, 5, uArray::Init<uString*>(::TYPES[0/*string[]*/], 20, ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[15/*"h"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[34/*"q"*/], ::STRINGS[87/*"w"*/], ::STRINGS[103/*"x"*/], ::STRINGS[151/*"y"*/]));
    FuseEntities_bundle::MeshBatchingEngine6eb677fe_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[152/*"uniform mat...*/], ::STRINGS[153/*"uniform vec...*/], 3, 4, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[15/*"h"*/], ::STRINGS[16/*"i"*/], ::STRINGS[17/*"j"*/], ::STRINGS[18/*"k"*/], ::STRINGS[19/*"l"*/], ::STRINGS[32/*"m"*/], ::STRINGS[20/*"n"*/], ::STRINGS[33/*"o"*/], ::STRINGS[58/*"p"*/], ::STRINGS[108/*"v"*/], ::STRINGS[87/*"w"*/], ::STRINGS[103/*"x"*/]));
    FuseEntities_bundle::MeshRenderer3c229be4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[154/*"uniform mat...*/], ::STRINGS[155/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseEntities_bundle::MeshRendererf517efea_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[156/*"uniform mat...*/], ::STRINGS[157/*"void main()...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/]));
    FuseEntities_bundle::RenderToTexture36aca600_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[158/*"attribute v...*/], ::STRINGS[126/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/]));
}
...
static void FuseEntities_bundle_build(uType* type)
{
    ::STRINGS[145] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[146] = uString::Const("uniform sampler2D h;\n"
        "\n"
        "varying vec2 d, e, f, g;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[4] = uString::Const("c");
    ::STRINGS[15] = uString::Const("h");
    ::STRINGS[147] = uString::Const("uniform vec2 b, c, d, e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[148] = uString::Const("uniform float f;\n"
        "uniform vec4 g, h;\n"
        "\n"
        "uniform sampler2D n;\n"
        "\n"
    ...
    ::STRINGS[14] = uString::Const("g");
    ::STRINGS[20] = uString::Const("n");
    ::STRINGS[149] = uString::Const("uniform mat4 i[16], q, m[16];\n"
        "uniform vec2 j, k;\n"
        "\n"
        "attribute vec3 a, e;\n"
        "attribute float b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[150] = uString::Const("uniform vec3 l, n, o;\n"
        "uniform float p;\n"
        "\n"
    ...
    ::STRINGS[87] = uString::Const("w");
    ::STRINGS[103] = uString::Const("x");
    ::STRINGS[151] = uString::Const("y");
    ::STRINGS[152] = uString::Const("uniform mat4 o, l, p;\n"
        "uniform vec2 h, i;\n"
        "\n"
        "attribute vec3 a, d;\n"
        "attribute vec2 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[153] = uString::Const("uniform vec3 j, k, m;\n"
        "uniform float n;\n"
        "\n"
        ...
        "");
    ::STRINGS[108] = uString::Const("v");
    ::STRINGS[154] = uString::Const("uniform mat4 c;\n"
        "\n"
        "attribute vec3 a;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[155] = uString::Const("uniform vec4 b;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = b;\n"
        "}\n"
        "");
    ::STRINGS[156] = uString::Const("uniform mat4 b;\n"
        "\n"
        "attribute vec3 a;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[157] = uString::Const("void main()\n"
        "{\n"
        "    gl_FragColor = vec4(0.8, 0.85, 1.0, 1.0);\n"
        "}\n"
        "");
    ::STRINGS[158] = uString::Const("attribute vec2 a;\n"
        "\n"
        "varying vec2 b;\n"
        "\n"
        "void main()\n"
...
// /usr/local/share/uno/Packages/Fuse.iOS.Bindings/0.29.22/.uno/package
// --------------------------------------------------------------------

// public static generated class FuseiOSBindings_bundle :0
// {
// static FuseiOSBindings_bundle() :0
static void FuseiOSBindings_bundle__cctor__fn(uType* __type)
{
    FuseiOSBindings_bundle::Blitter8e9d1e2b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[121/*"uniform mat...*/], ::STRINGS[26/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[13/*"e"*/]));
}

static void FuseiOSBindings_bundle_build(uType* type)
{
    ::STRINGS[121] = uString::Const("uniform mat4 c, b;\n"
        "\n"
        "attribute vec2 a;\n"
    ...
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseiOSBindings_bundle::Blitter8e9d1e2b_, uFieldFlagsStatic);
    type->Reflection.SetFields(1,
        new uField("Blitter8e9d1e2b", 0));
}

uClassType* FuseiOSBindings_bundle_typeof()
{
    static uSStrong<uClassType*> type;
    if (type != NULL) return type;
    ...
    options.FieldCount = 1;
    options.TypeSize = sizeof(uClassType);
    type = uClassType::New("FuseiOSBindings_bundle", options);
    type->fp_build_ = FuseiOSBindings_bundle_build;
    type->fp_cctor_ = FuseiOSBindings_bundle__cctor__fn;
    return type;
}

uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseiOSBindings_bundle::Blitter8e9d1e2b_;
// }

// /usr/local/share/uno/Packages/Fuse.Reactive/0.29.22/.uno/package
// ----------------------------------------------------------------
...
{
    FuseReactive_bundle::es6promise8ca9f621_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[159/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[160/*"es6-promise...*/]);
    FuseReactive_bundle::Observable5d5a1275_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[159/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[161/*"observable-...*/]);
    FuseReactive_bundle::SubscriberProxy2fa1c3a8_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[159/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[162/*"subscriberp...*/]);
}

static void FuseReactive_bundle_build(uType* type)
{
    ::STRINGS[159] = uString::Const("Fuse.Reactive");
    ::STRINGS[160] = uString::Const("es6-promise-50b2740f.js");
    ::STRINGS[161] = uString::Const("observable-b4b458ef.js");
    ::STRINGS[162] = uString::Const("subscriberproxy-705ef316.js");
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::es6promise8ca9f621_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::Observable5d5a1275_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::SubscriberProxy2fa1c3a8_, uFieldFlagsStatic);
    type->Reflection.SetFields(3,
        new uField("es6promise8ca9f621", 0),
        new uField("Observable5d5a1275", 1),
        new uField("SubscriberProxy2fa1c3a8", 2));
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::es6promise8ca9f621_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::Observable5d5a1275_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::SubscriberProxy2fa1c3a8_;
// }

// /usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno
// -----------------------------------------------------------------------

// public sealed class HashableWeakReference :2147
// {
...
// public HashableWeakReference(Uno.WeakReference<object> reference) :2150
void HashableWeakReference__ctor__fn(HashableWeakReference* __this, ::g::Uno::WeakReference* reference)
{
    __this->ctor_(reference);
}

// public override sealed bool Equals(object that) :2169
...
// public override sealed int GetHashCode() :2160
...
// public HashableWeakReference New(Uno.WeakReference<object> reference) :2150
...
// public bool TryGetTarget(object& obj) :2155
...
// public HashableWeakReference(Uno.WeakReference<object> reference) [instance] :2150
...
// public bool TryGetTarget(object& obj) [instance] :2155
...
// public HashableWeakReference New(Uno.WeakReference<object> reference) [static] :2150
...
{
    OutracksSimulatorClientUno_bundle::fightb073b460_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[163/*"Outracks.Si...*/]))->GetFile(::STRINGS[164/*"fight-af32b...*/]);
}

static void OutracksSimulatorClientUno_bundle_build(uType* type)
{
    ::STRINGS[163] = uString::Const("Outracks.Simulator.Client.Uno");
    ::STRINGS[164] = uString::Const("fight-af32bb4b.png");
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::OutracksSimulatorClientUno_bundle::fightb073b460_, uFieldFlagsStatic);
    type->Reflection.SetFields(1,
...
uSStrong< ::g::Uno::IO::BundleFile*> OutracksSimulatorClientUno_bundle::fightb073b460_;
// }

// /usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/.uno/$.uno
// ----------------------------------------------------------------------------

// internal sealed class OutracksSimulatorClientUno_FuseControlsRectangle_Color_Property :238
// {
...
// public OutracksSimulatorClientUno_FuseControlsRectangle_Color_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :241
...
// public override sealed float4 Get() :243
...
// public OutracksSimulatorClientUno_FuseControlsRectangle_Color_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :241
...
// public override sealed void Set(float4 v, Uno.UX.IPropertyListener origin) :244
...
// public override sealed bool get_SupportsOriginSetter() :245
...
// public OutracksSimulatorClientUno_FuseControlsRectangle_Color_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [instance] :241
...
// public OutracksSimulatorClientUno_FuseControlsRectangle_Color_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [static] :241
...
// internal sealed class OutracksSimulatorClientUno_FuseControlsText_Value_Property :220
// {
...
// public OutracksSimulatorClientUno_FuseControlsText_Value_Property(Fuse.Controls.Text obj, Uno.UX.Selector name) :223
...
// public override sealed string Get() :225
...
// public OutracksSimulatorClientUno_FuseControlsText_Value_Property New(Fuse.Controls.Text obj, Uno.UX.Selector name) :223
...
// public override sealed Uno.UX.PropertyObject get_Object() :224
...
// public override sealed void Set(string v, Uno.UX.IPropertyListener origin) :226
...
// public override sealed bool get_SupportsOriginSetter() :227
...
// public OutracksSimulatorClientUno_FuseControlsText_Value_Property(Fuse.Controls.Text obj, Uno.UX.Selector name) [instance] :223
...
// public OutracksSimulatorClientUno_FuseControlsText_Value_Property New(Fuse.Controls.Text obj, Uno.UX.Selector name) [static] :223
...
// internal sealed class OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property :229
// {
...
// public OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property(Fuse.Triggers.WhileTrue obj, Uno.UX.Selector name) :232
...
// public override sealed bool Get() :234
...
// public OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property New(Fuse.Triggers.WhileTrue obj, Uno.UX.Selector name) :232
...
// public override sealed Uno.UX.PropertyObject get_Object() :233
...
// public override sealed void Set(bool v, Uno.UX.IPropertyListener origin) :235
...
// public override sealed bool get_SupportsOriginSetter() :236
...
// public OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property(Fuse.Triggers.WhileTrue obj, Uno.UX.Selector name) [instance] :232
...
// public OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property New(Fuse.Triggers.WhileTrue obj, Uno.UX.Selector name) [static] :232
...
// internal sealed class OutracksSimulatorClientUno_OutracksSimulatorDeveloperMenu_Opacity_Property :283
// {
...
// public OutracksSimulatorClientUno_OutracksSimulatorDeveloperMenu_Opacity_Property(Outracks.Simulator.DeveloperMenu obj, Uno.UX.Selector name) :286
...
// public override sealed float Get() :288
...
// public OutracksSimulatorClientUno_OutracksSimulatorDeveloperMenu_Opacity_Property New(Outracks.Simulator.DeveloperMenu obj, Uno.UX.Selector name) :286
...
// public override sealed Uno.UX.PropertyObject get_Object() :287
...
// public override sealed void Set(float v, Uno.UX.IPropertyListener origin) :289
...
// public override sealed bool get_SupportsOriginSetter() :290
...
// public OutracksSimulatorClientUno_OutracksSimulatorDeveloperMenu_Opacity_Property(Outracks.Simulator.DeveloperMenu obj, Uno.UX.Selector name) [instance] :286
...
// public OutracksSimulatorClientUno_OutracksSimulatorDeveloperMenu_Opacity_Property New(Outracks.Simulator.DeveloperMenu obj, Uno.UX.Selector name) [static] :286
...
// internal sealed class OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property :265
// {
static void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property_build(uType* type)
{
    ::TYPES[1] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetFields(1,
        ::g::Outracks::Simulator::ErrorToast_typeof(), offsetof(::g::OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property, _obj), 0);
}

::g::Uno::UX::Property1_type* OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property_typeof()
{
    static uSStrong< ::g::Uno::UX::Property1_type*> type;
    if (type != NULL) return type;
    ...
    uTypeOptions options;
    options.FieldCount = 2;
    options.ObjectSize = sizeof(OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property", options);
    type->SetBase(::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof()));
    type->fp_build_ = OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property_build;
    type->fp_Get = (void(*)(::g::Uno::UX::Property1*, uTRef))OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__Get_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__get_Object_fn;
    type->fp_Set = (void(*)(::g::Uno::UX::Property1*, void*, uObject*))OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__Set_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::Property*, bool*))OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :268
void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__ctor_2_fn(OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property* __this, ::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_2(obj, *name);
}

// public override sealed float4 Get() :270
void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__Get_fn(OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property* __this, ::g::Uno::Float4* __retval)
{
    uStackFrame __("OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Color1(), void();
}

// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :268
void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__New1_fn(::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector* name, OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property** __retval)
{
    *__retval = OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property::New1(obj, *name);
}

// public override sealed Uno.UX.PropertyObject get_Object() :269
void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__get_Object_fn(OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property* __this, ::g::Uno::UX::PropertyObject** __retval)
{
    uStackFrame __("OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}

// public override sealed void Set(float4 v, Uno.UX.IPropertyListener origin) :271
void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__Set_fn(OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property* __this, ::g::Uno::Float4* v, uObject* origin)
{
    uStackFrame __("OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
    uPtr(__this->_obj)->SetColor1(v_, origin);
}

// public override sealed bool get_SupportsOriginSetter() :272
void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property__get_SupportsOriginSetter_fn(OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property* __this, bool* __retval)
{
    uStackFrame __("OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property", "get_SupportsOriginSetter()");
    return *__retval = true, void();
}

// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [instance] :268
void OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property::ctor_2(::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector name)
{
    uStackFrame __("OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property", ".ctor(Outracks.Simulator.ErrorToast,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [static] :268
OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property* OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property::New1(::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector name)
{
    OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property* obj1 = (OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property*)uNew(OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property_typeof());
    obj1->ctor_2(obj, name);
    return obj1;
}
// }
...
// internal sealed class OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Message_Property :247
// {
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Message_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :250
...
// public override sealed string Get() :252
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Message_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :250
...
// public override sealed Uno.UX.PropertyObject get_Object() :251
...
// public override sealed void Set(string v, Uno.UX.IPropertyListener origin) :253
...
// public override sealed bool get_SupportsOriginSetter() :254
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Message_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [instance] :250
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Message_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [static] :250
...
// internal sealed class OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property :274
// {
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :277
...
// public override sealed float Get() :279
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :277
...
// public override sealed Uno.UX.PropertyObject get_Object() :278
...
// public override sealed void Set(float v, Uno.UX.IPropertyListener origin) :280
...
// public override sealed bool get_SupportsOriginSetter() :281
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [instance] :277
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [static] :277
...
// internal sealed class OutracksSimulatorClientUno_OutracksSimulatorErrorToast_ShowMonitorInfo_Property :256
// {
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_ShowMonitorInfo_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :259
...
// public override sealed bool Get() :261
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_ShowMonitorInfo_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) :259
...
// public override sealed Uno.UX.PropertyObject get_Object() :260
...
// public override sealed void Set(bool v, Uno.UX.IPropertyListener origin) :262
...
// public override sealed bool get_SupportsOriginSetter() :263
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_ShowMonitorInfo_Property(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [instance] :259
...
// public OutracksSimulatorClientUno_OutracksSimulatorErrorToast_ShowMonitorInfo_Property New(Outracks.Simulator.ErrorToast obj, Uno.UX.Selector name) [static] :259
...
// /usr/local/share/uno/Packages/Polyfills.Window/0.29.22/.uno/package
// -------------------------------------------------------------------

// public static generated class PolyfillsWindow_bundle :0
// {
// static PolyfillsWindow_bundle() :0
static void PolyfillsWindow_bundle__cctor__fn(uType* __type)
{
    PolyfillsWindow_bundle::EventTarget118313ae_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[166/*"eventtarget...*/]);
    PolyfillsWindow_bundle::fetch225073bf_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[167/*"fetch-aa62b...*/]);
    PolyfillsWindow_bundle::File8d634f31_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[168/*"file-03bf8c...*/]);
    PolyfillsWindow_bundle::localStorage9abd7dbd_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[169/*"localstorag...*/]);
    PolyfillsWindow_bundle::Windowa92bb9bd_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[170/*"window-5648...*/]);
    PolyfillsWindow_bundle::WindowBase64f585fa6e_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[171/*"windowbase6...*/]);
    PolyfillsWindow_bundle::WindowTimers6763f18f_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[172/*"windowtimer...*/]);
    PolyfillsWindow_bundle::XMLHttpRequest718ebf5d_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[165/*"Polyfills.W...*/]))->GetFile(::STRINGS[173/*"xmlhttprequ...*/]);
}

static void PolyfillsWindow_bundle_build(uType* type)
{
    ::STRINGS[165] = uString::Const("Polyfills.Window");
    ::STRINGS[166] = uString::Const("eventtarget-06c872f2.js");
    ::STRINGS[167] = uString::Const("fetch-aa62b703.js");
    ::STRINGS[168] = uString::Const("file-03bf8c15.js");
    ::STRINGS[169] = uString::Const("localstorage-810aeaa1.js");
    ::STRINGS[170] = uString::Const("window-5648c2a1.js");
    ::STRINGS[171] = uString::Const("windowbase64-dbd36752.js");
    ::STRINGS[172] = uString::Const("windowtimers-4db15e73.js");
    ::STRINGS[173] = uString::Const("xmlhttprequest-5710f841.js");
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::EventTarget118313ae_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::fetch225073bf_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::File8d634f31_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::localStorage9abd7dbd_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::Windowa92bb9bd_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::WindowBase64f585fa6e_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::WindowTimers6763f18f_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::PolyfillsWindow_bundle::XMLHttpRequest718ebf5d_, uFieldFlagsStatic);
    type->Reflection.SetFields(8,
        new uField("EventTarget118313ae", 0),
        new uField("fetch225073bf", 1),
        new uField("File8d634f31", 2),
        new uField("localStorage9abd7dbd", 3),
        new uField("Windowa92bb9bd", 4),
        new uField("WindowBase64f585fa6e", 5),
        new uField("WindowTimers6763f18f", 6),
        new uField("XMLHttpRequest718ebf5d", 7));
}

uClassType* PolyfillsWindow_bundle_typeof()
{
    static uSStrong<uClassType*> type;
    if (type != NULL) return type;
    ...
    options.TypeSize = sizeof(uClassType);
    type = uClassType::New("PolyfillsWindow_bundle", options);
    type->fp_build_ = PolyfillsWindow_bundle_build;
    type->fp_cctor_ = PolyfillsWindow_bundle__cctor__fn;
    return type;
}

uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::EventTarget118313ae_;
uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::fetch225073bf_;
uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::File8d634f31_;
uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::localStorage9abd7dbd_;
uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::Windowa92bb9bd_;
uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::WindowBase64f585fa6e_;
uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::WindowTimers6763f18f_;
uSStrong< ::g::Uno::IO::BundleFile*> PolyfillsWindow_bundle::XMLHttpRequest718ebf5d_;
// }

// /usr/local/share/uno/Packages/UnoCore/0.29.20/.uno/package
// ----------------------------------------------------------
...
{
    UnoCore_bundle::SdfFontShader06541a00_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[174/*"uniform mat...*/], ::STRINGS[175/*"uniform flo...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[13/*"e"*/], ::STRINGS[6/*"f"*/], ::STRINGS[16/*"i"*/]));
    UnoCore_bundle::SpriteFontShaderf730f5ae_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[176/*"uniform mat...*/], ::STRINGS[177/*"uniform sam...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[14/*"g"*/]));
}
...
static void UnoCore_bundle_build(uType* type)
{
    ::STRINGS[174] = uString::Const("uniform mat4 d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[175] = uString::Const("uniform float e, f;\n"
        "\n"
        "uniform sampler2D i;\n"
        "\n"
        "varying vec2 g;\n"
...
// public sealed class WeakDictionary<TKey, TValue> :2184
// {
...
// public generated WeakDictionary() :2184
void WeakDictionary__ctor__fn(WeakDictionary* __this)
{
    __this->ctor_();
}

// public Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<HashableWeakReference, TValue>> AsEnumerable() :2188
void WeakDictionary__AsEnumerable_fn(WeakDictionary* __this, uObject** __retval)
{
    *__retval = __this->AsEnumerable();
}

// public void Clear() :2193
void WeakDictionary__Clear_fn(WeakDictionary* __this)
{
    __this->Clear();
}

// private static HashableWeakReference GetKey(TKey obj) :2214
...
// public TValue get_Item(TKey key) :2210
...
// public void set_Item(TKey key, TValue value) :2211
...
// public generated WeakDictionary() [instance] :2184
...
// public Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<HashableWeakReference, TValue>> AsEnumerable() [instance] :2188
...
// public void Clear() [instance] :2193
...
// public bool Remove(HashableWeakReference key) [instance] :2203
...
// public generated WeakDictionary New() [static] :2184
