...
// internal static extern class FocusHelpers :237
// {
// static FocusHelpers() :240
...
// public static void BecomeFirstResponder(ObjC.Object uiView) [static] :252
void FocusHelpers::BecomeFirstResponder(uObject* uiView)
{
    uStackFrame __("Fuse.Controls.Native.iOS.FocusHelpers", "BecomeFirstResponder(ObjC.Object)");
...
// public static ObjC.Object GetCurrentFirstResponder() [static] :273
uObject* FocusHelpers::GetCurrentFirstResponder()
{
    uStackFrame __("Fuse.Controls.Native.iOS.FocusHelpers", "GetCurrentFirstResponder()");
    FocusHelpers_typeof()->Init();
    @autoreleasepool
    {
...
// public static bool IsFirstResponder(ObjC.Object handle) [static] :266
bool FocusHelpers::IsFirstResponder(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.FocusHelpers", "IsFirstResponder(ObjC.Object)");
    FocusHelpers_typeof()->Init();
    @autoreleasepool
    {
...
// public static void ResignFirstResponder(ObjC.Object uiView) [static] :259
void FocusHelpers::ResignFirstResponder(uObject* uiView)
{
    uStackFrame __("Fuse.Controls.Native.iOS.FocusHelpers", "ResignFirstResponder(ObjC.Object)");
    FocusHelpers_typeof()->Init();
    @autoreleasepool
    {
        [] (::id uiView) -> void
...
// public static void ScheduleBecomeFirstResponder(ObjC.Object target) [static] :292
...
// public static void ScheduleResignFirstResponder(ObjC.Object target) [static] :286
void FocusHelpers::ScheduleResignFirstResponder(uObject* target)
{
    ...
    FocusHelpers_typeof()->Init();
    uPtr(FocusHelpers::_keyboardView())->ShowKeyboard();
    ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[0/*Uno.Action*/], (void*)FocusHelpers__PerformResignFirstResponder__ResignFirstResponder_fn, FocusHelpers__PerformResignFirstResponder::New1(target)), 0);
}

// public static Fuse.Controls.Native.iOS.KeyboardView get_KeyboardView() [static] :248
::g::Fuse::Controls::Native::iOS::KeyboardView* FocusHelpers::KeyboardView()
{
    uStackFrame __("Fuse.Controls.Native.iOS.FocusHelpers", "get_KeyboardView()");
    FocusHelpers_typeof()->Init();
