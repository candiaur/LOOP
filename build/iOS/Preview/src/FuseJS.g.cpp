...
// /usr/local/share/uno/Packages/FuseJS/0.29.22/$.uno
// --------------------------------------------------

// public sealed class Base64 :254
// {
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) :289
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) :321
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) :273
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) :305
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :289
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :321
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :273
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :305
...
// public sealed class Bundle :356
// {
...
// private static object Read(Fuse.Scripting.Context c, object[] args) [static] :426
...
// private static string Read(string filename) [static] :436
...
// private static Uno.Threading.Future<string> ReadAsync(object[] args) [static] :400
...
// private static Uno.Threading.Future<string> ReadAsync(string filename) [static] :453
...
// private static bool TryGetBundleFile(string sourcePath, Uno.IO.BundleFile& bundleFile) [static] :368
...
// public sealed class Environment :222
// {
...
// public Environment() :226
void Environment__ctor_2_fn(Environment* __this)
{
    __this->ctor_2();
}

// public Environment New() :226
...
// public Environment() [instance] :226
void Environment::ctor_2()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[12/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[10/*"android"*/], uCRef(false), &ret2), ret2));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[12/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[11/*"ios"*/], uCRef(true), &ret3), ret3));
...
// public Environment New() [static] :226
...
// private sealed class FileReaderImpl.FileReadCommand :489
// {
...
// public string ReadAsDataURL() :500
...
// public FileReadCommand(string path) [instance] :492
...
// public string ReadAsDataURL() [instance] :500
...
// public string ReadAsText() [instance] :496
...
// public FileReadCommand New(string path) [static] :492
...
// public sealed class FileReaderImpl :487
// {
...
// private static Uno.Threading.Future<string> readAsText(object[] args) :524
...
// public FileReaderImpl() [instance] :510
...
// public FileReaderImpl New() [static] :510
...
// private static Uno.Threading.Future<string> readAsDataURL(object[] args) [static] :518
...
// private static Uno.Threading.Future<string> readAsText(object[] args) [static] :524
...
// public sealed class Lifecycle :68
// {
static void Lifecycle_build(uType* type)
{
    ...
    ::TYPES[18] = ::g::Uno::Platform2::ApplicationStateTransitionHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0),
        ::g::Fuse::Scripting::IModuleProvider_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface1));
    type->SetFields(4,
...
// public Lifecycle New() :81
void Lifecycle__New2_fn(Lifecycle** __retval)
{
    *__retval = Lifecycle::New2();
}

// private static void OnEnteringBackground(Uno.Platform2.ApplicationState newState) :180
void Lifecycle__OnEnteringBackground_fn(int* newState)
{
    Lifecycle::OnEnteringBackground(*newState);
}

// private static void OnEnteringForeground(Uno.Platform2.ApplicationState newState) :120
void Lifecycle__OnEnteringForeground_fn(int* newState)
{
    Lifecycle::OnEnteringForeground(*newState);
}

// private static void OnEnteringInteractive(Uno.Platform2.ApplicationState newState) :140
void Lifecycle__OnEnteringInteractive_fn(int* newState)
{
    Lifecycle::OnEnteringInteractive(*newState);
}

// private static void OnExitedInteractive(Uno.Platform2.ApplicationState newState) :160
void Lifecycle__OnExitedInteractive_fn(int* newState)
{
    Lifecycle::OnExitedInteractive(*newState);
}

// private static void OnJsInitialized(object sender, Uno.EventArgs args) :98
...
void Lifecycle::ctor_2()
{
    ...
    add_Evaluated(uDelegate::New(::TYPES[16/*Uno.EventHandler*/], (void*)Lifecycle__OnJsInitialized_fn));
}

// public Lifecycle New() [static] :81
...
// private static void OnEnteringBackground(Uno.Platform2.ApplicationState newState) [static] :180
void Lifecycle::OnEnteringBackground(int newState)
{
    uStackFrame __("FuseJS.Lifecycle", "OnEnteringBackground(Uno.Platform2.ApplicationState)");
    ::g::Fuse::Scripting::NativeEvent* handler = Lifecycle::_enteringBackground_;

    if (handler != NULL)
        uPtr(Lifecycle::_enteringBackground_)->RaiseAsync(uArray::New(::TYPES[17/*object[]*/], 0));
}

// private static void OnEnteringForeground(Uno.Platform2.ApplicationState newState) [static] :120
void Lifecycle::OnEnteringForeground(int newState)
{
    uStackFrame __("FuseJS.Lifecycle", "OnEnteringForeground(Uno.Platform2.ApplicationState)");
    ::g::Fuse::Scripting::NativeEvent* handler = Lifecycle::_enteringForeground_;

    if (handler != NULL)
        uPtr(Lifecycle::_enteringForeground_)->RaiseAsync(uArray::New(::TYPES[17/*object[]*/], 0));
}

// private static void OnEnteringInteractive(Uno.Platform2.ApplicationState newState) [static] :140
void Lifecycle::OnEnteringInteractive(int newState)
{
    uStackFrame __("FuseJS.Lifecycle", "OnEnteringInteractive(Uno.Platform2.ApplicationState)");
    ::g::Fuse::Scripting::NativeEvent* handler = Lifecycle::_enteringInteractive_;

    if (handler != NULL)
        uPtr(Lifecycle::_enteringInteractive_)->RaiseAsync(uArray::New(::TYPES[17/*object[]*/], 0));
}

// private static void OnExitedInteractive(Uno.Platform2.ApplicationState newState) [static] :160
void Lifecycle::OnExitedInteractive(int newState)
{
    uStackFrame __("FuseJS.Lifecycle", "OnExitedInteractive(Uno.Platform2.ApplicationState)");
    ::g::Fuse::Scripting::NativeEvent* handler = Lifecycle::_exitedInteractive_;

    if (handler != NULL)
        uPtr(Lifecycle::_exitedInteractive_)->RaiseAsync(uArray::New(::TYPES[17/*object[]*/], 0));
}

// private static void OnJsInitialized(object sender, Uno.EventArgs args) [static] :98
void Lifecycle::OnJsInitialized(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[18/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnEnteringForeground_fn));
    ::g::Uno::Platform2::Application::add_EnteringInteractive(uDelegate::New(::TYPES[18/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnEnteringInteractive_fn));
    ::g::Uno::Platform2::Application::add_ExitedInteractive(uDelegate::New(::TYPES[18/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnExitedInteractive_fn));
    ::g::Uno::Platform2::Application::add_EnteringBackground(uDelegate::New(::TYPES[18/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnEnteringBackground_fn));
}
// }
...
// internal sealed class RaiseEvent :541
// {
static void RaiseEvent_build(uType* type)
{
    ::STRINGS[33] = uString::Const("Cannot find message with name: ");
    ::STRINGS[34] = uString::Const("/usr/local/share/uno/Packages/FuseJS/0.29.22/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[33/*"Cannot find...*/], Name), this, ::STRINGS[34/*"/usr/local/...*/], 553, ::STRINGS[35/*"Raise"*/]);
        return;
    }
...
// public generated RaiseEvent New() [static] :541
...
// private sealed class Bundle.ReadClosure :458
// {
...
// public ReadClosure(string filename) [instance] :462
...
// public string Invoke() [instance] :467
...
// public ReadClosure New(string filename) [static] :462
...
// public sealed class UserEvents :563
// {
static void UserEvents_build(uType* type)
{
    ::STRINGS[36] = uString::Const("FuseJS/UserEvents");
    ::STRINGS[37] = uString::Const("raise");
    ::STRINGS[38] = uString::Const("The FuseJS/UserEvents `Raise` function is deprecated. Use the `object.raise` on a named event instead.");
    ::STRINGS[34] = uString::Const("/usr/local/share/uno/Packages/FuseJS/0.29.22/$.uno");
    ::STRINGS[35] = uString::Const("Raise");
    ::TYPES[0] = uObject_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::NativeMember_typeof();
...
// public UserEvents() :566
void UserEvents__ctor_2_fn(UserEvents* __this)
{
    __this->ctor_2();
}

// public UserEvents New() :566
void UserEvents__New2_fn(UserEvents** __retval)
{
    *__retval = UserEvents::New2();
}

// public static object Raise(Fuse.Scripting.Context context, object[] args) :579
...
// public UserEvents() [instance] :566
void UserEvents::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(UserEvents::_instance_ = this, ::STRINGS[36/*"FuseJS/User...*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[37/*"raise"*/], uDelegate::New(::TYPES[2/*Fuse.Scripting.NativeCallback*/], (void*)UserEvents__Raise_fn)));
}

// public UserEvents New() [static] :566
...
// public static object Raise(Fuse.Scripting.Context context, object[] args) [static] :579
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[38/*"The FuseJS/...*/], context, ::STRINGS[34/*"/usr/local/...*/], 584, ::STRINGS[35/*"Raise"*/]);
    ...
    ::g::Fuse::Scripting::Object* p = (args->Length() > 1) ? uAs< ::g::Fuse::Scripting::Object*>(args->Strong<uObject*>(1), ::TYPES[19/*Fuse.Scripting.Object*/]) : NULL;
