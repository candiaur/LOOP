...
// public sealed extern class MKAnnotationView :28794
// {
static void MKAnnotationView_build(uType* type)
{
    type->SetInterfaces(
...
::g::iOS::UIKit::UIView_type* MKAnnotationView_typeof()
{
    ...
    options.ObjectSize = sizeof(MKAnnotationView);
    options.TypeSize = sizeof(::g::iOS::UIKit::UIView_type);
    type = (::g::iOS::UIKit::UIView_type*)uClassType::New("iOS.MapKit.MKAnnotationView", options);
    type->SetBase(::g::iOS::UIKit::UIView_typeof());
    type->fp_build_ = MKAnnotationView_build;
