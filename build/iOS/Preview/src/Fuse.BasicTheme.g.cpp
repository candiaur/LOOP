...
static void SwitchBehavior_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Fuse::Controls::ToggleControl_typeof();
    ::TYPES[3] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Bool_typeof());
    ::TYPES[4] = ::g::Fuse::Visual_typeof();
    ::TYPES[5] = ::g::Fuse::Input::PointerPressedHandler_typeof();
    ::TYPES[6] = ::g::Fuse::Input::PointerMovedHandler_typeof();
    ::TYPES[7] = ::g::Fuse::Input::PointerReleasedHandler_typeof();
    ...
    type->SetFields(27,
        ::g::Fuse::Elements::Element_typeof(), offsetof(::g::Fuse::BasicTheme::SwitchBehavior, _bounds), 0,
        ...
        ::g::Fuse::Controls::ToggleControl_typeof(), offsetof(::g::Fuse::BasicTheme::SwitchBehavior, _switch), 0);
}
...
void SwitchBehavior__ctor_4_fn(SwitchBehavior* __this)
{
    __this->ctor_4();
}
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) :238
...
// private void OnPointerTapped(object a, int tapCount) :247
...
void SwitchBehavior__OnRooted_fn(SwitchBehavior* __this)
{
    ...
    __this->_switch = uAs< ::g::Fuse::Controls::ToggleControl*>(__this->Parent(), ::TYPES[2/*Fuse.Controls.ToggleControl*/]);

    if (__this->_switch == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[0/*"SwitchBehav...*/]));

    uPtr(__this->_switch)->add_ValueChanged(uDelegate::New(::TYPES[3/*Uno.UX.ValueChangedHandler<bool>*/], (void*)SwitchBehavior__OnValueChanged_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), __this->_switch, uDelegate::New(::TYPES[5/*Fuse.Input.PointerPressedHandler*/], (void*)SwitchBehavior__OnPointerPressed_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), __this->_switch, uDelegate::New(::TYPES[6/*Fuse.Input.PointerMovedHandler*/], (void*)SwitchBehavior__OnPointerMoved_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), __this->_switch, uDelegate::New(::TYPES[7/*Fuse.Input.PointerReleasedHandler*/], (void*)SwitchBehavior__OnPointerReleased_fn, __this));
    __this->_clicker = ::g::Fuse::Gestures::Clicker::AttachClicker(__this->_switch);
    uPtr(__this->_clicker)->add_TappedEvent(uDelegate::New(::TYPES[8/*Fuse.Gestures.ClickerEventHandler*/], (void*)SwitchBehavior__OnPointerTapped_fn, __this));

    if (__this->Bounds() == NULL)
        __this->Bounds(uAs< ::g::Fuse::Elements::Element*>(__this->_switch, ::TYPES[9/*Fuse.Elements.Element*/]));
...
void SwitchBehavior__OnUnrooted_fn(SwitchBehavior* __this)
{
    ...
    uPtr(__this->_switch)->remove_ValueChanged(uDelegate::New(::TYPES[3/*Uno.UX.ValueChangedHandler<bool>*/], (void*)SwitchBehavior__OnValueChanged_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), __this->_switch, uDelegate::New(::TYPES[5/*Fuse.Input.PointerPressedHandler*/], (void*)SwitchBehavior__OnPointerPressed_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), __this->_switch, uDelegate::New(::TYPES[6/*Fuse.Input.PointerMovedHandler*/], (void*)SwitchBehavior__OnPointerMoved_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), __this->_switch, uDelegate::New(::TYPES[7/*Fuse.Input.PointerReleasedHandler*/], (void*)SwitchBehavior__OnPointerReleased_fn, __this));
    uPtr(__this->_switch)->remove_Placed(uDelegate::New(::TYPES[10/*Fuse.PlacedHandler*/], (void*)SwitchBehavior__OnPlaced_fn, __this));
    uPtr(__this->_clicker)->remove_TappedEvent(uDelegate::New(::TYPES[8/*Fuse.Gestures.ClickerEventHandler*/], (void*)SwitchBehavior__OnPointerTapped_fn, __this));
...
// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<bool> args) :254
...
// private bool ReleaseCapture() :228
...
void SwitchBehavior::ctor_4()
{
    uStackFrame __("Fuse.BasicTheme.SwitchBehavior", ".ctor()");
    ctor_3();
}
...
{
    uStackFrame __("Fuse.BasicTheme.SwitchBehavior", "get_Bounds()");
    return _bounds;
}
...
{
    uStackFrame __("Fuse.BasicTheme.SwitchBehavior", "set_Bounds(Fuse.Elements.Element)");
    _bounds = value;
}
    ...
    if (_captured)
    {
        if (!uPtr(args)->IsHardCapturedTo(this))
        {
            if (::g::Uno::Math::Abs1(_originalP.X - uPtr(_switch)->WindowToLocal(uPtr(args)->WindowPoint()).X) > 10.0f)
                uPtr(args)->TryHardCapture(this, uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)SwitchBehavior__OnCaptureLost_fn, this), NULL);
        }
...
void SwitchBehavior::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (uPtr(args)->TrySoftCapture(this, uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)SwitchBehavior__OnCaptureLost_fn, this), NULL))
    {
        _captured = true;
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :238
...
// private void OnPointerTapped(object a, int tapCount) [instance] :247
...
// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<bool> args) [instance] :254
...
// private bool ReleaseCapture() [instance] :228
