...
// /usr/local/share/uno/Packages/Fuse.Scripting/0.29.22/$.uno
// ----------------------------------------------------------

// private sealed class JSCallback.ActionClosure :1085
// {
...
// public ActionClosure(Uno.Action action) :1089
void JSCallback__ActionClosure__ctor__fn(JSCallback__ActionClosure* __this, uDelegate* action)
{
    __this->ctor_(action);
}

// public ActionClosure New(Uno.Action action) :1089
...
// public object Run(object[] args) :1094
...
// public ActionClosure(Uno.Action action) [instance] :1089
...
// public object Run(object[] args) [instance] :1094
...
// public ActionClosure New(Uno.Action action) [static] :1089
...
// private sealed class JSCallback.ActionClosure<T> :1101
// {
...
// public ActionClosure(Uno.Action<T> action) :1105
void JSCallback__ActionClosure1__ctor__fn(JSCallback__ActionClosure1* __this, uDelegate* action)
{
    __this->ctor_(action);
}

// public ActionClosure New(Uno.Action<T> action) :1105
...
// public object Run(object[] args) [instance] :1110
...
// public ActionClosure New(Uno.Action<T> action) [static] :1105
...
// private sealed class JSCallback.ActionClosure<T1, T2> :1122
// {
...
// public ActionClosure(Uno.Action<T1, T2> action) :1126
void JSCallback__ActionClosure2__ctor__fn(JSCallback__ActionClosure2* __this, uDelegate* action)
{
    __this->ctor_(action);
}

// public ActionClosure New(Uno.Action<T1, T2> action) :1126
...
// public object Run(object[] args) [instance] :1131
...
// public ActionClosure New(Uno.Action<T1, T2> action) [static] :1126
...
// /usr/local/share/uno/Packages/FuseCore/0.29.22/Scripting/$.uno
// --------------------------------------------------------------

// public abstract class Array :325
// {
...
// protected generated Array() :325
void Array__ctor__fn(Array* __this)
{
    __this->ctor_();
}

// public override sealed bool Equals(object o) :331
...
// public override int GetHashCode() :337
...
// protected generated Array() [instance] :325
void Array::ctor_()
{
}
// }
...
// public delegate object Callback(object[] args) :420
...
{
    uStackFrame __("Fuse.Scripting.ScriptMethod`1.CallClosure", ".ctor(Uno.Action<T, object[]>,object,object[])");
    _method = method;
    _obj = obj;
    _args = args;
}
...
// public sealed class CodeModule :361
// {
...
// public CodeModule(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) :363
...
// public CodeModule New(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) :363
...
// public CodeModule(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) [instance] :363
...
// public CodeModule New(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) [static] :363
...
// public abstract class Context :568
// {
static void Context_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[6] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
...
// protected Context(Uno.Threading.IDispatcher ownerThread) :614
void Context__ctor__fn(Context* __this, uObject* ownerThread)
{
    __this->ctor_(ownerThread);
}

// internal void DeleteGlobalModuleResult(Fuse.Scripting.ModuleResult mr) :587
...
// public void ObjectDefineProperty(Fuse.Scripting.Object obj, string name, Fuse.Scripting.Callback getProperty, [Fuse.Scripting.Callback setProperty], [bool enumerable], [bool configurable]) :619
...
// public void ObjectDefineProperty(Fuse.Scripting.Object obj, string name, object value, [bool enumerable], [bool configurable]) :626
...
// public object ParseJson(string json) :642
void Context__ParseJson_fn(Context* __this, uString* json, uObject** __retval)
{
    *__retval = __this->ParseJson(json);
}

// public void RegisterGlobalModuleResult(Fuse.Scripting.ModuleResult result) :572
...
// public Fuse.Scripting.ModuleResult TryGetGlobalModuleResult(string id) :579
...
// protected Context(Uno.Threading.IDispatcher ownerThread) [instance] :614
...
// internal void DeleteGlobalModuleResult(Fuse.Scripting.ModuleResult mr) [instance] :587
...
// public Fuse.Scripting.Array NewArray(object[] values) [instance] :655
::g::Fuse::Scripting::Array* Context::NewArray(uArray* values)
{
    uStackFrame __("Fuse.Scripting.Context", "NewArray(object[])");
    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(Evaluate(::STRINGS[3/*"(no file)"*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[4/*"new Array("*/], uBox<int>(::TYPES[23/*int*/], uPtr(values)->Length())), ::STRINGS[5/*")"*/])), ::TYPES[5/*Fuse.Scripting.Array*/]);
...
// public Fuse.Scripting.Object NewObject() [instance] :650
::g::Fuse::Scripting::Object* Context::NewObject()
{
    uStackFrame __("Fuse.Scripting.Context", "NewObject()");
    return uCast< ::g::Fuse::Scripting::Object*>(Evaluate(::STRINGS[3/*"(no file)"*/], ::STRINGS[6/*"new Object()"*/]), ::TYPES[6/*Fuse.Scripting.Object*/]);
}

// public Fuse.Scripting.Object ObjectCreate(object[] args) [instance] :632
::g::Fuse::Scripting::Object* Context::ObjectCreate(uArray* args)
{
    uStackFrame __("Fuse.Scripting.Context", "ObjectCreate(object[])");
    ::g::Fuse::Scripting::Function* objectCreate = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(no file)"*/], ::STRINGS[7/*"Object.create"*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);

    if (objectCreate != NULL)
        return uAs< ::g::Fuse::Scripting::Object*>(uPtr(objectCreate)->Call(args), ::TYPES[6/*Fuse.Scripting.Object*/]);

    return NULL;
}

// public void ObjectDefineProperty(Fuse.Scripting.Object obj, string name, Fuse.Scripting.Callback getProperty, [Fuse.Scripting.Callback setProperty], [bool enumerable], [bool configurable]) [instance] :619
void Context::ObjectDefineProperty(::g::Fuse::Scripting::Object* obj, uString* name, uDelegate* getProperty, uDelegate* setProperty, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[8/*""*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[9/*"(function(o...*/], ::g::Uno::Delegate::op_Inequality(setProperty, NULL) ? ::STRINGS[10/*" set: setCa...*/] : ::STRINGS[8/*""*/]), ::STRINGS[11/*" enumerable...*/])), ::TYPES[7/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 6, obj, name, getProperty, setProperty, uBox(::TYPES[24/*bool*/], enumerable), uBox(::TYPES[24/*bool*/], configurable)));
}

// public void ObjectDefineProperty(Fuse.Scripting.Object obj, string name, object value, [bool enumerable], [bool configurable]) [instance] :626
void Context::ObjectDefineProperty1(::g::Fuse::Scripting::Object* obj, uString* name, uObject* value, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[8/*""*/], ::STRINGS[12/*"(function(o...*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 5, obj, name, value, uBox(::TYPES[24/*bool*/], enumerable), uBox(::TYPES[24/*bool*/], configurable)));
}

// public object ParseJson(string json) [instance] :642
uObject* Context::ParseJson(uString* json)
{
    uStackFrame __("Fuse.Scripting.Context", "ParseJson(string)");

    if (_parseJson == NULL)
        _parseJson = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(no file)"*/], ::STRINGS[13/*"JSON.parse"*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);

    return uPtr(_parseJson)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 1, json));
}

// public void RegisterGlobalModuleResult(Fuse.Scripting.ModuleResult result) [instance] :572
...
// public Fuse.Scripting.ModuleResult TryGetGlobalModuleResult(string id) [instance] :579
...
// private sealed class NativePromise<T, TJSResult>.ContextClosure :779
// {
...
// public ContextClosure(Fuse.Scripting.Context c, Fuse.Scripting.FutureFactory<T> factory, Fuse.Scripting.ResultConverter<T, TJSResult> converter) :784
...
// internal object CreatePromise(object[] args) :790
...
// public ContextClosure New(Fuse.Scripting.Context c, Fuse.Scripting.FutureFactory<T> factory, Fuse.Scripting.ResultConverter<T, TJSResult> converter) :784
...
// public ContextClosure(Fuse.Scripting.Context c, Fuse.Scripting.FutureFactory<T> factory, Fuse.Scripting.ResultConverter<T, TJSResult> converter) [instance] :784
...
// internal object CreatePromise(object[] args) [instance] :790
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[14/*"Promise"*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);
    ::g::Uno::Threading::Future1* future = (::g::Uno::Threading::Future1*)uPtr(_factory)->Invoke(1, args);
    return uPtr(promise)->Construct(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 1, uDelegate::New(::TYPES[10/*Fuse.Scripting.Callback*/], (void*)::g::Fuse::Scripting::NativePromise__PromiseClosure__Run_fn, ::g::Fuse::Scripting::NativePromise__PromiseClosure::New1(__types[0], _c, future, _converter))));
}

// public ContextClosure New(Fuse.Scripting.Context c, Fuse.Scripting.FutureFactory<T> factory, Fuse.Scripting.ResultConverter<T, TJSResult> converter) [static] :784
...
// public sealed class DoubleChangedArgs :54
// {
...
// public DoubleChangedArgs(double value) :56
void DoubleChangedArgs__ctor_2_fn(DoubleChangedArgs* __this, double* value)
{
    __this->ctor_2(*value);
}

// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :60
void DoubleChangedArgs__FuseScriptingIScriptEventSerialize_fn(DoubleChangedArgs* __this, uObject* s)
{
    ...
    double ret2;
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[3/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[2/*"value"*/], (::g::Uno::UX::ValueChangedArgs__get_Value_fn(__this, &ret2), ret2));
}

// public DoubleChangedArgs New(double value) :56
void DoubleChangedArgs__New3_fn(double* value, DoubleChangedArgs** __retval)
{
    *__retval = DoubleChangedArgs::New3(*value);
}

// public DoubleChangedArgs(double value) [instance] :56
...
// public DoubleChangedArgs New(double value) [static] :56
...
// public sealed class External :399
// {
...
// public External(object o) :403
void External__ctor__fn(External* __this, uObject* o)
{
    __this->ctor_(o);
}

// public override sealed bool Equals(object o) :408
...
// public override sealed int GetHashCode() :414
...
// public External New(object o) [static] :403
...
// internal sealed class FactoryClosure<T> :718
// {
...
// public FactoryClosure(Fuse.Scripting.ResultFactory<T> factory, object[] args, Uno.Threading.Promise<T> promise) :724
...
// public FactoryClosure New(Fuse.Scripting.ResultFactory<T> factory, object[] args, Uno.Threading.Promise<T> promise) :724
...
// public FactoryClosure(Fuse.Scripting.ResultFactory<T> factory, object[] args, Uno.Threading.Promise<T> promise) [instance] :724
...
// public FactoryClosure New(Fuse.Scripting.ResultFactory<T> factory, object[] args, Uno.Threading.Promise<T> promise) [static] :724
...
// public sealed class FileModule :372
// {
...
// public FileModule New(Uno.UX.FileSource fs) [static] :374
...
// private sealed class JSCallback.FuncClosure<TResult> :1144
// {
...
// public FuncClosure(Uno.Func<TResult> method) :1148
void JSCallback__FuncClosure__ctor__fn(JSCallback__FuncClosure* __this, uDelegate* method)
{
    __this->ctor_(method);
}

// public FuncClosure New(Uno.Func<TResult> method) :1148
...
// public object Run(object[] args) [instance] :1153
...
// public FuncClosure New(Uno.Func<TResult> method) [static] :1148
...
// private sealed class JSCallback.FuncClosure<TArg, TResult> :1159
// {
...
// public FuncClosure(Uno.Func<TArg, TResult> method) :1163
void JSCallback__FuncClosure1__ctor__fn(JSCallback__FuncClosure1* __this, uDelegate* method)
{
    __this->ctor_(method);
}

// public FuncClosure New(Uno.Func<TArg, TResult> method) :1163
...
// public object Run(object[] args) [instance] :1168
...
// public FuncClosure New(Uno.Func<TArg, TResult> method) [static] :1163
...
// private sealed class JSCallback.FuncClosure<TArg, TArg1, TResult> :1178
// {
...
// public FuncClosure(Uno.Func<TArg, TArg1, TResult> method) :1182
void JSCallback__FuncClosure2__ctor__fn(JSCallback__FuncClosure2* __this, uDelegate* method)
{
    __this->ctor_(method);
}

// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) :1182
...
// public object Run(object[] args) :1187
void JSCallback__FuncClosure2__Run_fn(JSCallback__FuncClosure2* __this, uArray* args, uObject** __retval)
{
    *__retval = __this->Run(args);
}

// public FuncClosure(Uno.Func<TArg, TArg1, TResult> method) [instance] :1182
...
// public object Run(object[] args) [instance] :1187
...
// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) [static] :1182
...
// public abstract class Function :364
// {
...
// protected generated Function() :364
void Function__ctor__fn(Function* __this)
{
    __this->ctor_();
}

// public override sealed bool Equals(object o) :370
...
// public override int GetHashCode() :376
...
// protected generated Function() [instance] :364
void Function::ctor_()
{
}
// }
...
// public delegate Uno.Threading.Future<T> FutureFactory<T>(object[] args) :715
...
// public static class JSCallback :1053
// {
static void JSCallback_build(uType* type)
{
    ...
    ::TYPES[17] = JSCallback__FuncClosure2_typeof();
    ::TYPES[18] = JSCallback__NumberConverter_typeof();
...
// public static Fuse.Scripting.Callback FromAction(Uno.Action action) :1055
void JSCallback__FromAction_fn(uDelegate* action, uDelegate** __retval)
{
    *__retval = JSCallback::FromAction(action);
}

// public static Fuse.Scripting.Callback FromAction<T>(Uno.Action<T> action) :1060
...
// public static Fuse.Scripting.Callback FromAction<T1, T2>(Uno.Action<T1, T2> action) :1065
...
// public static Fuse.Scripting.Callback FromAction(Uno.Action action) [static] :1055
...
// public static Fuse.Scripting.Callback FromAction<T>(Uno.Action<T> action) [static] :1060
...
// public static Fuse.Scripting.Callback FromAction<T1, T2>(Uno.Action<T1, T2> action) [static] :1065
...
// public static Fuse.Scripting.Callback FromFunc<TResult>(Uno.Func<TResult> func) [static] :1070
...
// public static Fuse.Scripting.Callback FromFunc<T, TResult>(Uno.Func<T, TResult> func) [static] :1075
...
// public static Fuse.Scripting.Callback FromFunc<T1, T2, TResult>(Uno.Func<T1, T2, TResult> func) [static] :1080
uDelegate* JSCallback::FromFunc2(uType* __type, uDelegate* func)
{
    uType* __types[] = {
        ::TYPES[17/*Fuse.Scripting.JSCallback.FuncClosure`3*/]->MakeType(__type->U(0), __type->U(1), __type->U(2)),
        __type->U(0),
        __type->U(1),
        __type->U(2),
    };
    uStackFrame __("Fuse.Scripting.JSCallback", "FromFunc`3(Uno.Func<T1, T2, TResult>)");
    return uDelegate::New(::TYPES[10/*Fuse.Scripting.Callback*/], (void*)JSCallback__FuncClosure2__Run_fn, (JSCallback__FuncClosure2*)JSCallback__FuncClosure2::New1(__types[0], func));
}
// }
...
// public JSFileSource(string path) [instance] :395
...
// public JSFileSource New(string path) [static] :395
...
static void Json_build(uType* type)
{
    ...
    ::TYPES[19] = ::g::Uno::Collections::HashSet_typeof()->MakeType(uObject_typeof());
    ::TYPES[20] = ::g::Uno::String_typeof();
    ...
    ::TYPES[27] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[28] = ::g::Uno::Comparison_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[5] = ::g::Fuse::Scripting::Array_typeof();
...
// public static string Escape(string s) :496
void Json__Escape_fn(uString* s, uString** __retval)
{
    *__retval = Json::Escape(s);
}

// public static void Escape(string s, Uno.Text.StringBuilder sb) :505
void Json__Escape1_fn(uString* s, ::g::Uno::Text::StringBuilder* sb)
{
    Json::Escape1(s, sb);
}

// public static string Stringify(object value, [bool normalized]) :437
void Json__Stringify_fn(uObject* value, bool* normalized, uString** __retval)
{
    *__retval = Json::Stringify(value, *normalized);
}

// private static void Stringify(object value, bool normalized, Uno.Text.StringBuilder sb, Uno.Collections.HashSet<object> visitedSet) :444
...
// public static void Escape(string s, Uno.Text.StringBuilder sb) [static] :505
void Json::Escape1(uString* s, ::g::Uno::Text::StringBuilder* sb)
{
    ...
    for (int i = 0; i < uPtr(s)->Length(); i++)
        ...
        else if (uPtr(s)->Item(i) == '\\')
        {
            ...
            sb->Append2(::STRINGS[16/*"\\\\"*/]);
        }
        else
            uPtr(sb)->Append(uPtr(s)->Item(i));
}

// public static string Stringify(object value, [bool normalized]) [static] :437
uString* Json::Stringify(uObject* value, bool normalized)
{
    uStackFrame __("Fuse.Scripting.Json", "Stringify(object,[bool])");
    ::g::Uno::Text::StringBuilder* sb = ::g::Uno::Text::StringBuilder::New1();
    Json::Stringify1(value, normalized, sb, (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[19/*Uno.Collections.HashSet<object>*/]));
    return sb->ToString();
}

// private static void Stringify(object value, bool normalized, Uno.Text.StringBuilder sb, Uno.Collections.HashSet<object> visitedSet) [static] :444
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    if (uIs(value, ::TYPES[20/*string*/]))
        Json::ToLiteral3(uCast<uString*>(value, ::TYPES[20/*string*/]), sb);
    else if (uIs(value, ::TYPES[21/*double*/]))
        uPtr(sb)->Append2(Json::ToLiteral1(uUnbox<double>(::TYPES[21/*double*/], value)));
    else if (uIs(value, ::TYPES[22/*float*/]))
        sb->Append2(Json::ToLiteral1((double)uUnbox<float>(::TYPES[22/*float*/], value)));
    else if (uIs(value, ::TYPES[23/*int*/]))
        sb->Append2(Json::ToLiteral1((double)uUnbox<int>(::TYPES[23/*int*/], value)));
    else if (uIs(value, ::TYPES[24/*bool*/]))
        sb->Append2(Json::ToLiteral(uUnbox<bool>(::TYPES[24/*bool*/], value)));
    else if (uIs(value, ::TYPES[6/*Fuse.Scripting.Object*/]))
    {
        ...
        ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(value, ::TYPES[6/*Fuse.Scripting.Object*/]);
        uPtr(sb)->Append2(::STRINGS[18/*"{"*/]);
        uArray* keys = uArray::New(::TYPES[25/*string[]*/], uPtr(uPtr(obj)->Keys())->Length());
        ::g::Uno::Array::Copy1(::TYPES[26/*Uno.Array.Copy<string>*/], obj->Keys(), keys, uPtr(obj->Keys())->Length());

        if (normalized)
            ::g::Uno::Array::Sort1(::TYPES[27/*Uno.Array.Sort<string>*/], keys, uDelegate::New(::TYPES[28/*Uno.Comparison<string>*/], (void*)::g::Uno::String__Compare_fn));
    ...
    else if (uIs(value, ::TYPES[5/*Fuse.Scripting.Array*/]))
    {
        ...
        ::g::Fuse::Scripting::Array* arr = uAs< ::g::Fuse::Scripting::Array*>(value, ::TYPES[5/*Fuse.Scripting.Array*/]);
        ...
        sb->Append2(::STRINGS[24/*"null"*/]);
}

// public static string ToLiteral(bool b) [static] :548
...
// public static string ToLiteral(double s) [static] :541
uString* Json::ToLiteral1(double s)
{
    uStackFrame __("Fuse.Scripting.Json", "ToLiteral(double)");

    if ((double)(int)s == s)
        return ::g::Uno::Int::ToString((int)s, ::TYPES[23/*int*/]);

    return ::g::Uno::Double::ToString(s, ::TYPES[21/*double*/]);
}

// public static string ToLiteral(string s) [static] :527
uString* Json::ToLiteral2(uString* s)
{
    uStackFrame __("Fuse.Scripting.Json", "ToLiteral(string)");
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[27/*"\""*/], Json::Escape(s)), ::STRINGS[27/*"\""*/]);
}

// public static void ToLiteral(string s, Uno.Text.StringBuilder sb) [static] :533
...
// public static class Marshal :406
// {
// static Marshal() :406
static void Marshal__cctor__fn(uType* __type)
{
    Marshal::_convertibleClasses_ = uArray::Init<uType*>(::TYPES[29/*Uno.Type[]*/], 2, ::TYPES[30/*Fuse.Drawing.Brush*/], ::TYPES[34/*Uno.UX.FileSource*/]);
}
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.29.22/$.uno");
    ...
    ::TYPES[29] = ::g::Uno::Type_typeof()->Array();
    ::TYPES[2] = ::g::Uno::Type_typeof();
    ::TYPES[24] = ::g::Uno::Bool_typeof();
    ::TYPES[20] = ::g::Uno::String_typeof();
    ::TYPES[30] = ::g::Fuse::Drawing::Brush_typeof();
    ::TYPES[21] = ::g::Uno::Double_typeof();
    ::TYPES[22] = ::g::Uno::Float_typeof();
    ::TYPES[23] = ::g::Uno::Int_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[31] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[32] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[33] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[34] = ::g::Uno::UX::FileSource_typeof();
    ::TYPES[6] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[5] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[35] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[36] = ::g::Uno::UX::Size_typeof();
    ::TYPES[37] = ::g::Uno::UX::Size2_typeof();
...
// public static object TryConvertTo(Uno.Type t, object o) :583
void Marshal__TryConvertTo_fn(uType* t, uObject* o, uObject** __retval)
{
    *__retval = Marshal::TryConvertTo(t, o);
}

// public static bool TryConvertTo<T>(object obj, T& value) :568
...
// public static bool CanConvertClass(Uno.Type t) [static] :622
...
// public static bool ToBool(object obj) [static] :552
bool Marshal::ToBool(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[24/*bool*/]))
        return uUnbox<bool>(::TYPES[24/*bool*/], obj);
    else if (uIs(obj, ::TYPES[20/*string*/]))
        return ::g::Uno::Bool::Parse(uCast<uString*>(obj, ::TYPES[20/*string*/]));
    else
...
// public static Fuse.Drawing.Brush ToBrush(object o) [static] :545
...
// public static double ToDouble(object o) [static] :408
double Marshal::ToDouble(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToDouble(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[21/*double*/]))
        return uUnbox<double>(::TYPES[21/*double*/], o);
    else if (uIs(o, ::TYPES[22/*float*/]))
        return (double)uUnbox<float>(::TYPES[22/*float*/], o);
    else if (uIs(o, ::TYPES[23/*int*/]))
        return (double)uUnbox<int>(::TYPES[23/*int*/], o);
    else if (o == NULL)
        return 0.0;
    else if (uIs(o, ::TYPES[20/*string*/]))
        return ::g::Uno::Double::Parse(uCast<uString*>(o, ::TYPES[20/*string*/]));
    else
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[30/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[31/*"/usr/local/...*/], 420);
        return 0.0;
    }
}

// public static Uno.UX.FileSource ToFileSource(object obj) [static] :425
::g::Uno::UX::FileSource* Marshal::ToFileSource(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[20/*string*/]))
    {
        uString* path = uCast<uString*>(obj, ::TYPES[20/*string*/]);

        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[31/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[32/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[33/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);

            if (::g::Uno::String::op_Equality(uPtr(f)->SourcePath(), path))
                return ::g::Uno::UX::BundleFileSource::New1(f);
        }

        return ::g::Fuse::Scripting::JSFileSource::New1(uCast<uString*>(obj, ::TYPES[20/*string*/]));
    }
    else if (uIs(obj, ::TYPES[6/*Fuse.Scripting.Object*/]))
        return ::g::Fuse::Scripting::JSFileSource::New1(uAs<uString*>(uPtr(uCast< ::g::Fuse::Scripting::Object*>(obj, ::TYPES[6/*Fuse.Scripting.Object*/]))->Item(::STRINGS[32/*"path"*/]), ::TYPES[20/*string*/]));
    else
...
// public static float ToFloat(object o) [static] :450
...
// public static float4 ToFloat4(Fuse.Scripting.Array values) [static] :518
...
// public static float4 ToFloat4(object o) [static] :528
::g::Uno::Float4 Marshal::ToFloat41(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToFloat4(object)");
    Marshal_typeof()->Init();
    ::g::Fuse::Scripting::Array* aa = uAs< ::g::Fuse::Scripting::Array*>(o, ::TYPES[5/*Fuse.Scripting.Array*/]);

    if (aa != NULL)
        return Marshal::ToFloat4(aa);

    if (uIs(o, ::TYPES[20/*string*/]))
    {
        uString* s = uCast<uString*>(o, ::TYPES[20/*string*/]);
...
// public static int ToInt(object o) [static] :445
...
// public static Uno.UX.Selector ToSelector(object o) [static] :455
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToSelector(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[35/*Uno.UX.Selector*/]))
        return uUnbox< ::g::Uno::UX::Selector>(::TYPES[35/*Uno.UX.Selector*/], o);
    else if (uIs(o, ::TYPES[20/*string*/]))
        return ::g::Uno::UX::Selector__op_Implicit(uCast<uString*>(o, ::TYPES[20/*string*/]));

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[36/*"Unable to p...*/], o)));
}

// public static Uno.UX.Size ToSize(object o) [static] :469
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToSize(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[36/*Uno.UX.Size*/]))
        return uUnbox< ::g::Uno::UX::Size>(::TYPES[36/*Uno.UX.Size*/], o);
...
// public static Uno.UX.Size2 ToSize2(object o) [static] :488
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToSize2(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[37/*Uno.UX.Size2*/]))
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[37/*Uno.UX.Size2*/], o);
    ...
    if (uIs(o, ::TYPES[20/*string*/]))
    {
        ...
        uArray* parts = ::g::Uno::String::Split(uPtr(s), uArray::Init<int>(::TYPES[38/*char[]*/], 1, ','));
    ...
    if (uIs(o, ::TYPES[5/*Fuse.Scripting.Array*/]))
    {
        ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(o, ::TYPES[5/*Fuse.Scripting.Array*/]);
...
// public static object TryConvertTo(Uno.Type t, object o) [static] :583
uObject* Marshal::TryConvertTo(uType* t, uObject* o)
{
    ...
    if (o == NULL)
        return NULL;
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[24/*bool*/]))
        return uBox(::TYPES[24/*bool*/], Marshal::ToBool(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[22/*float*/]))
        return uBox(::TYPES[22/*float*/], Marshal::ToFloat(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[21/*double*/]))
        return uBox(::TYPES[21/*double*/], Marshal::ToDouble(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[23/*int*/]))
        return uBox<int>(::TYPES[23/*int*/], Marshal::ToInt(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[20/*string*/]))
        return ::g::Uno::Object::ToString(uPtr(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[35/*Uno.UX.Selector*/]))
        return uBox(::TYPES[35/*Uno.UX.Selector*/], Marshal::ToSelector(o));
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[36/*Uno.UX.Size*/]))
        return uBox(::TYPES[36/*Uno.UX.Size*/], Marshal::ToSize(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[37/*Uno.UX.Size2*/]))
        return uBox(::TYPES[37/*Uno.UX.Size2*/], Marshal::ToSize2(o));
    else if (::g::Uno::Type::IsEnum(uPtr(t)) && uIs(o, ::TYPES[20/*string*/]))
        return ::g::Uno::Enum::Parse(t, uCast<uString*>(o, ::TYPES[20/*string*/]));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[30/*Fuse.Drawing.Brush*/]))
        return Marshal::ToBrush(o);
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[34/*Uno.UX.FileSource*/]))
...
// public abstract class Module :749
// {
...
// protected generated Module() :749
...
// public Fuse.Scripting.ModuleResult Evaluate(Fuse.Scripting.Context c, string id) :757
...
// public object EvaluateExports(Fuse.Scripting.Context c, string id) :751
...
// public virtual Uno.UX.FileSource GetFile() :784
...
// protected generated Module() [instance] :749
void Module::ctor_()
{
}
...
// public Fuse.Scripting.ModuleResult Evaluate(Fuse.Scripting.Context c, string id) [instance] :757
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        module->Item(::STRINGS[45/*"id"*/], id);

    return result;
}

// public object EvaluateExports(Fuse.Scripting.Context c, string id) [instance] :751
...
static void ModuleResult_build(uType* type)
{
    ...
    ::STRINGS[44] = uString::Const("exports");
    ::TYPES[40] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[41] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[42] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::EventArgs_typeof());
    type->SetFields(0,
...
void ModuleResult::ctor_(::g::Fuse::Scripting::Context* context, uString* id, ::g::Fuse::Scripting::Module* mod, ::g::Fuse::Scripting::Object* obj)
{
    ...
    _invalidateCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[40/*Uno.Collections.List<Uno.Action>*/]));
    Context = context;
    Module = mod;
    Object = obj;
    Id = id;
    ...
    if (::g::Uno::String::op_Inequality(Id, NULL))
    {
        ...
        ::g::Uno::UX::Resource::AddGlobalKeyListener(uDelegate::New(::TYPES[41/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
    }

    if (uPtr(Module)->GetFile() != NULL)
    {
        uPtr(uPtr(Module)->GetFile())->add_DataChanged(uDelegate::New(::TYPES[42/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = true;
    }
}
...
void ModuleResult::Dispose()
{
    ...
    if (_fileListening)
    {
        uPtr(uPtr(Module)->GetFile())->remove_DataChanged(uDelegate::New(::TYPES[42/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = false;
    }

    if (_globalKeyListening)
    {
        ::g::Uno::UX::Resource::RemoveGlobalKeyListener(uDelegate::New(::TYPES[41/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
...
// public delegate object NativeCallback(Fuse.Scripting.Context c, object[] args) :894
...
// public sealed class NativeEvent :938
// {
static void NativeEvent_build(uType* type)
{
    ::TYPES[43] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array());
    ::TYPES[44] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2, uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[45] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof());
    type->SetFields(8,
...
// public NativeEvent(string name, [bool queueEventsBeforeHandlerIsSet]) :944
...
// private void DispatchQueue() :961
void NativeEvent__DispatchQueue_fn(NativeEvent* __this)
{
    __this->DispatchQueue();
}

// protected override sealed Fuse.Scripting.Function GetProperty() :956
...
// public NativeEvent New(string name, [bool queueEventsBeforeHandlerIsSet]) :944
...
// public void RaiseAsync(object[] args) :967
void NativeEvent__RaiseAsync_fn(NativeEvent* __this, uArray* args)
{
    __this->RaiseAsync(args);
}

// protected override sealed void SetProperty(Fuse.Scripting.Function function) :950
...
// public NativeEvent(string name, [bool queueEventsBeforeHandlerIsSet]) [instance] :944
void NativeEvent::ctor_4(uString* name, bool queueEventsBeforeHandlerIsSet)
{
    ...
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[43/*Uno.Collections.Queue<object[]>*/]));
    _queueEventsBeforeEvaluation = queueEventsBeforeHandlerIsSet;
}

// private void DispatchQueue() [instance] :961
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[44/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher, uDelegate::New(::TYPES[45/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}

// public void RaiseAsync(object[] args) [instance] :967
...
// public NativeEvent New(string name, [bool queueEventsBeforeHandlerIsSet]) [static] :944
...
// public sealed class NativeFunction :896
// {
...
// public NativeFunction(string name, Fuse.Scripting.NativeCallback callback) :905
void NativeFunction__ctor_1_fn(NativeFunction* __this, uString* name, uDelegate* callback)
{
    __this->ctor_1(name, callback);
}

// protected override sealed object CreateObject() :900
...
// public NativeFunction New(string name, Fuse.Scripting.NativeCallback callback) :905
...
// public NativeFunction(string name, Fuse.Scripting.NativeCallback callback) [instance] :905
...
// public NativeFunction New(string name, Fuse.Scripting.NativeCallback callback) [static] :905
...
// private sealed class NativeFunction.NativeFunctionClosure :910
// {
...
// public NativeFunctionClosure(Fuse.Scripting.NativeCallback callback, Fuse.Scripting.Context context) :915
...
// public object Callback(object[] args) :921
...
// public NativeFunctionClosure New(Fuse.Scripting.NativeCallback callback, Fuse.Scripting.Context context) :915
...
// public NativeFunctionClosure(Fuse.Scripting.NativeCallback callback, Fuse.Scripting.Context context) [instance] :915
...
// public object Callback(object[] args) [instance] :921
...
// public NativeFunctionClosure New(Fuse.Scripting.NativeCallback callback, Fuse.Scripting.Context context) [static] :915
...
// public abstract class NativeMember :866
// {
...
// public generated Fuse.Scripting.Context get_Context() [instance] :869
...
// private generated void set_Context(Fuse.Scripting.Context value) [instance] :869
...
// internal void Create(Fuse.Scripting.Object obj, Fuse.Scripting.Context context) [instance] :873
...
// protected generated Fuse.Scripting.Object get_ModuleObject() [instance] :870
...
// private generated void set_ModuleObject(Fuse.Scripting.Object value) [instance] :870
...
// protected generated string get_Name() [instance] :868
...
// private generated void set_Name(string value) [instance] :868
...
// public class NativeModule :641
// {
static void NativeModule_build(uType* type)
{
    ::STRINGS[47] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[44] = uString::Const("exports");
    ::TYPES[46] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
    ::TYPES[6] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[47] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
    ::TYPES[8] = ::g::Uno::Delegate_typeof();
    ::TYPES[48] = ::g::Fuse::Scripting::Module_typeof();
...
// public generated NativeModule() :641
void NativeModule__ctor_1_fn(NativeModule* __this)
{
    __this->ctor_1();
}

// protected void AddMember(Fuse.Scripting.NativeMember member) :678
void NativeModule__AddMember_fn(NativeModule* __this, ::g::Fuse::Scripting::NativeMember* member)
{
    __this->AddMember(member);
}

// public override void Evaluate(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result) :685
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[44/*"exports"*/]), ::TYPES[6/*Fuse.Scripting.Object*/]);

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[47/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
    {
        ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[47/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
        uPtr(m)->Create(obj, c);
    }
...
// public void add_Evaluated(Uno.EventHandler value) [instance] :653
void NativeModule::add_Evaluated(uDelegate* value)
{
    ...
    if (_isEvaluated)
        ...
        _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_evaluated, value), ::TYPES[49/*Uno.EventHandler*/]);
}

// public void remove_Evaluated(Uno.EventHandler value) [instance] :660
void NativeModule::remove_Evaluated(uDelegate* value)
{
    ...
    _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_evaluated, value), ::TYPES[49/*Uno.EventHandler*/]);
}

// internal void InternalReset() [instance] :672
...
// public void add_Reset(Uno.EventHandler value) [instance] :668
void NativeModule::add_Reset(uDelegate* value)
{
    uStackFrame __("Fuse.Scripting.NativeModule", "add_Reset(Uno.EventHandler)");
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_reset, value), ::TYPES[49/*Uno.EventHandler*/]);
}

// public void remove_Reset(Uno.EventHandler value) [instance] :669
void NativeModule::remove_Reset(uDelegate* value)
{
    uStackFrame __("Fuse.Scripting.NativeModule", "remove_Reset(Uno.EventHandler)");
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_reset, value), ::TYPES[49/*Uno.EventHandler*/]);
}

// public generated NativeModule New() [static] :641
...
// public sealed class NativePromise<T, TJSResult> :748
// {
static void NativePromise_build(uType* type)
{
    ::TYPES[50] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[10] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[51] = NativePromise__ContextClosure_typeof();
    ::TYPES[52] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[53] = ::g::Uno::Action_typeof();
    ::TYPES[54] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    ::TYPES[55] = ::g::Uno::Threading::Future1_typeof();
    type->SetPrecalc(
...
// public NativePromise(string name, Fuse.Scripting.FutureFactory<T> futureFactory, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) :768
...
// public NativePromise(string name, Fuse.Scripting.ResultFactory<T> func, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) :754
...
// protected override sealed object CreateObject() :774
...
// private Uno.Threading.Future<T> Factory(object[] args) :761
...
// public NativePromise New(string name, Fuse.Scripting.FutureFactory<T> futureFactory, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) :768
...
// public NativePromise New(string name, Fuse.Scripting.ResultFactory<T> func, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) :754
...
// public NativePromise(string name, Fuse.Scripting.FutureFactory<T> futureFactory, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) [instance] :768
...
// public NativePromise(string name, Fuse.Scripting.ResultFactory<T> func, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) [instance] :754
...
// private Uno.Threading.Future<T> Factory(object[] args) [instance] :761
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    uPtr(::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[53/*Uno.Action*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[2], _func, args, future))))->Start();
    return future;
}

// public NativePromise New(string name, Fuse.Scripting.FutureFactory<T> futureFactory, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) [static] :768
...
// public NativePromise New(string name, Fuse.Scripting.ResultFactory<T> func, [Fuse.Scripting.ResultConverter<T, TJSResult> resultConverter]) [static] :754
...
// public class NativeProperty<T, TJSValue> :987
// {
static void NativeProperty_build(uType* type)
{
    ...
    ::TYPES[10] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[8] = ::g::Uno::Delegate_typeof();
    ::TYPES[56] = ::g::Uno::Func_typeof();
    ::TYPES[57] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
...
// public NativeProperty(string name) :995
void NativeProperty__ctor_1_fn(NativeProperty* __this, uString* name)
{
    __this->ctor_1(name);
}

// public NativeProperty(string name, [Uno.Func<T> getHandler], [Uno.Action<TJSValue> setHandler], [Fuse.Scripting.ValueConverter<T, TJSValue> valueConverter]) :1004
...
// public NativeProperty(string name, TJSValue value) :998
...
// protected override sealed object CreateObject() :1012
...
// protected virtual T GetProperty() :1042
...
// public NativeProperty New(string name, TJSValue value) :998
...
// public NativeProperty(string name) [instance] :995
...
// public NativeProperty(string name, [Uno.Func<T> getHandler], [Uno.Action<TJSValue> setHandler], [Fuse.Scripting.ValueConverter<T, TJSValue> valueConverter]) [instance] :1004
...
// private object GetProperty(object[] args) [instance] :1032
...
// private object SetProperty(object[] args) [instance] :1022
uObject* NativeProperty::SetProperty(uArray* args)
{
    ...
    uPtr(_setHandler)->InvokeVoid(((uPtr(args)->Length() > 0) && uIs((uObject*)uPtr(args)->Strong<uObject*>(0), __types[1])) ? (void*)uUnboxAny(__types[1], uPtr(args)->Strong<uObject*>(0)) : uT(__types[1], U_ALLOCA(__types[1]->ValueSize)));
    return NULL;
}

// public NativeProperty New(string name) [static] :995
...
// public NativeProperty New(string name, [Uno.Func<T> getHandler], [Uno.Action<TJSValue> setHandler], [Fuse.Scripting.ValueConverter<T, TJSValue> valueConverter]) [static] :1004
...
// public static class JSCallback.NumberConverter :1209
// {
...
// private static object Convert(double value, Uno.Type targetType) :1274
...
// private static object Convert(float value, Uno.Type targetType) :1265
...
// private static object Convert(int value, Uno.Type targetType) :1247
...
// private static object Convert(long value, Uno.Type targetType) :1256
...
// private static object Convert(short value, Uno.Type targetType) :1238
...
// public static object Convert(Uno.Type targetType, object value) :1228
...
// public static TValue Convert<TValue>(object value) :1223
...
// public static bool TryConvert<TValue>(object value, TValue& convertedValue) :1211
...
// private static object Convert(double value, Uno.Type targetType) [static] :1274
uObject* JSCallback__NumberConverter::Convert(double value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[58/*short*/]))
        return uBox<int16_t>(::TYPES[58/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[23/*int*/]))
        return uBox<int>(::TYPES[23/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[59/*long*/]))
        return uBox<int64_t>(::TYPES[59/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[22/*float*/]))
        return uBox(::TYPES[22/*float*/], (float)value);

    return uBox(::TYPES[21/*double*/], value);
}

// private static object Convert(float value, Uno.Type targetType) [static] :1265
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[21/*double*/]))
        return uBox(::TYPES[21/*double*/], (double)value);

    return uBox(::TYPES[22/*float*/], value);
}

// private static object Convert(int value, Uno.Type targetType) [static] :1247
uObject* JSCallback__NumberConverter::Convert2(int value, uType* targetType)
{
    ...
    return uBox<int>(::TYPES[23/*int*/], value);
}

// private static object Convert(long value, Uno.Type targetType) [static] :1256
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[59/*long*/], value);
}

// private static object Convert(short value, Uno.Type targetType) [static] :1238
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[58/*short*/], value);
}

// public static object Convert(Uno.Type targetType, object value) [static] :1228
uObject* JSCallback__NumberConverter::Convert5(uType* targetType, uObject* value)
{
    ...
    if (uIs(value, ::TYPES[58/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[58/*short*/], value), targetType);

    if (uIs(value, ::TYPES[23/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[23/*int*/], value), targetType);

    if (uIs(value, ::TYPES[59/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[59/*long*/], value), targetType);

    if (uIs(value, ::TYPES[22/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[22/*float*/], value), targetType);

    if (uIs(value, ::TYPES[21/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[21/*double*/], value), targetType);
...
// public abstract class Object :343
// {
...
// protected generated Object() :343
...
// protected generated Object() [instance] :343
void Object::ctor_()
{
}
// }
...
// private sealed class NativePromise<T, TJSResult>.PromiseClosure :798
// {
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[1] = uObject_typeof();
    ::TYPES[8] = ::g::Uno::Delegate_typeof();
    ::TYPES[60] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[53] = ::g::Uno::Action_typeof();
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[57] = ::g::Uno::Action1_typeof();
    ::TYPES[61] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetPrecalc(
...
// public PromiseClosure(Fuse.Scripting.Context context, Uno.Threading.Future<T> promise, Fuse.Scripting.ResultConverter<T, TJSResult> converter) :808
...
// private void Reject(Uno.Exception reason) :843
...
// private void Resolve(T result) :828
void NativePromise__PromiseClosure__Resolve_fn(NativePromise__PromiseClosure* __this, void* result)
{
    ...
    if (__this->_resolve != NULL)
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(__this->_c)->Dispatcher), ::TYPES[60/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[53/*Uno.Action*/], (void*)NativePromise__PromiseClosure__InternalResolve_fn, __this));
}

// public object Run(object[] args) :815
void NativePromise__PromiseClosure__Run_fn(NativePromise__PromiseClosure* __this, uArray* args, uObject** __retval)
{
    *__retval = __this->Run(args);
}

// public PromiseClosure(Fuse.Scripting.Context context, Uno.Threading.Future<T> promise, Fuse.Scripting.ResultConverter<T, TJSResult> converter) [instance] :808
...
// private void InternalReject() [instance] :850
...
// private void InternalResolve() [instance] :835
...
// private void Reject(Uno.Exception reason) [instance] :843
void NativePromise__PromiseClosure::Reject(::g::Uno::Exception* reason)
{
    ...
    if (_reject != NULL)
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(_c)->Dispatcher), ::TYPES[60/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[53/*Uno.Action*/], (void*)NativePromise__PromiseClosure__InternalReject_fn, this));
}

// public object Run(object[] args) [instance] :815
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
        _resolve = uAs< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[7/*Fuse.Scripting.Function*/]);

    if (args->Length() > 1)
        _reject = uAs< ::g::Fuse::Scripting::Function*>(args->Strong<uObject*>(1), ::TYPES[7/*Fuse.Scripting.Function*/]);

    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[61/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}

// public PromiseClosure New(Fuse.Scripting.Context context, Uno.Threading.Future<T> promise, Fuse.Scripting.ResultConverter<T, TJSResult> converter) [static] :808
...
// private sealed class ScriptModule.RequireContext :186
// {
...
// public RequireContext(Fuse.Scripting.Context c, Fuse.Scripting.ScriptModule m, Fuse.Scripting.ModuleResult dependant) :192
...
// public RequireContext New(Fuse.Scripting.Context c, Fuse.Scripting.ScriptModule m, Fuse.Scripting.ModuleResult dependant) :192
...
// public object Require(object[] args) :199
...
// public object Require(string id) :211
...
// public RequireContext(Fuse.Scripting.Context c, Fuse.Scripting.ScriptModule m, Fuse.Scripting.ModuleResult dependant) [instance] :192
...
// public object Require(object[] args) [instance] :199
uObject* ScriptModule__RequireContext::Require(uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[48/*"require(): ...*/], uBox<int>(::TYPES[23/*int*/], uPtr(args)->Length())), ::STRINGS[49/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[20/*string*/]);
...
// public object Require(string id) [instance] :211
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        uPtr(module)->AddDependency(uDelegate::New(::TYPES[53/*Uno.Action*/], (void*)::g::Fuse::Scripting::ModuleResult__Invalidate_fn, uPtr(_dependant)));

        if (module->Error() == NULL)
        {
            if (::g::Uno::String::op_Equality(ScriptModule__RequireContext::_lastErrorPath_, path))
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[52/*"JavaScript ...*/], path), ::STRINGS[53/*" was fixed!"*/]), this, ::STRINGS[31/*"/usr/local/...*/], 232, ::STRINGS[54/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[52/*"JavaScript ...*/], path), ::STRINGS[55/*" line "*/]), uBox<int>(::TYPES[23/*int*/], uPtr(e)->LineNumber())), ::STRINGS[56/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[31/*"/usr/local/...*/], 242, ::STRINGS[54/*"Require"*/]);
...
// public RequireContext New(Fuse.Scripting.Context c, Fuse.Scripting.ScriptModule m, Fuse.Scripting.ModuleResult dependant) [static] :192
...
// public delegate TJSResult ResultConverter<T, TJSResult>(Fuse.Scripting.Context context, T result) :716
...
// public delegate T ResultFactory<T>(object[] args) :714
...
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[62/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[62] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ScriptClass_typeof());
    type->SetFields(0,
    ...
    type->Reflection.SetFunctions(4,
        ...
        new uFunction("get_Methods", NULL, (void*)ScriptClass__get_Methods_fn, 0, false, ::g::Fuse::Scripting::ScriptMethod_typeof()->Array(), 0),
        new uFunction("Register", NULL, (void*)ScriptClass__Register_fn, 0, true, uVoid_typeof(), 2, ::g::Uno::Type_typeof(), ::g::Fuse::Scripting::ScriptMethod_typeof()->Array()),
...
{
    uStackFrame __("Fuse.Scripting.ScriptClass", ".ctor(Uno.Type,Fuse.Scripting.ScriptMethod[])");
    _unoType = unoType;
    _methods = methods;
}
...
{
    uStackFrame __("Fuse.Scripting.ScriptClass", "get_Methods()");
    return _methods;
}
...
{
    uStackFrame __("Fuse.Scripting.ScriptClass", "Register(Uno.Type,Fuse.Scripting.ScriptMethod[])");
    ScriptClass_typeof()->Init();
...
// public sealed class ScriptEventArgs :34
// {
// static ScriptEventArgs() :34
...
// public generated ScriptEventArgs() [instance] :34
...
// public void Serialize(Fuse.Scripting.IEventSerializer s) [instance] :39
void ScriptEventArgs::Serialize(uObject* s)
{
}

// public generated ScriptEventArgs New() [static] :34
...
// public static Fuse.Scripting.ScriptEventArgs get_Empty() [static] :37
...
// public sealed class ScriptException :674
// {
...
// public ScriptException(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) :683
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    if (__this->LineNumber() >= 0)
    {
        ...
        stringBuilder->AppendLine(::g::Uno::Int::ToString(__this->LineNumber(), ::TYPES[23/*int*/]));
    }
...
// public generated string get_Name() :676
void ScriptException__get_Name_fn(ScriptException* __this, uString** __retval)
{
    *__retval = __this->Name();
}

// private generated void set_Name(string value) :676
void ScriptException__set_Name_fn(ScriptException* __this, uString* value)
{
    __this->Name(value);
}

// public ScriptException New(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) :683
...
// public generated string get_SourceLine() :680
void ScriptException__get_SourceLine_fn(ScriptException* __this, uString** __retval)
{
    *__retval = __this->SourceLine();
}

// private generated void set_SourceLine(string value) :680
void ScriptException__set_SourceLine_fn(ScriptException* __this, uString* value)
{
    __this->SourceLine(value);
}

// public ScriptException(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) [instance] :683
...
// public generated string get_ErrorMessage() [instance] :677
...
// private generated void set_ErrorMessage(string value) [instance] :677
...
// public generated string get_FileName() [instance] :678
...
// private generated void set_FileName(string value) [instance] :678
...
// public generated string get_JSStackTrace() [instance] :681
...
// private generated void set_JSStackTrace(string value) [instance] :681
...
// public generated int get_LineNumber() [instance] :679
...
// private generated void set_LineNumber(int value) [instance] :679
...
// public generated string get_Name() [instance] :676
...
// private generated void set_Name(string value) [instance] :676
...
// public generated string get_SourceLine() [instance] :680
...
// private generated void set_SourceLine(string value) [instance] :680
...
// public ScriptException New(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) [static] :683
...
static void ScriptMethod1_build(uType* type)
{
    ...
    ::STRINGS[64] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.29.22/Scripting/$.uno");
    ::STRINGS[65] = uString::Const("Call");
    ::TYPES[23] = ::g::Uno::Int_typeof();
    ::TYPES[8] = ::g::Uno::Delegate_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[53] = ::g::Uno::Action_typeof();
    ::TYPES[63] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
// public ScriptMethod(string name, Uno.Func<T, object[], object> method, Fuse.Scripting.ExecutionThread thread) :113
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[53/*Uno.Action*/], (void*)ScriptMethod1__CallClosure__Run_fn, ScriptMethod1__CallClosure::New1(__types[0], __this->_voidMethod, obj, args)));
        return *__retval = NULL, void();
    }
...
// public ScriptMethod New(string name, Uno.Func<T, object[], object> method, Fuse.Scripting.ExecutionThread thread) :113
...
// public ScriptMethod(string name, Uno.Func<T, object[], object> method, Fuse.Scripting.ExecutionThread thread) [instance] :113
...
// public ScriptMethod New(string name, Uno.Func<T, object[], object> method, Fuse.Scripting.ExecutionThread thread) [static] :113
...
static void ScriptModule_build(uType* type)
{
    ...
    ::STRINGS[44] = uString::Const("exports");
    ::STRINGS[70] = uString::Const("(function(module, exports, require");
    ::STRINGS[71] = uString::Const(", ");
    ::STRINGS[72] = uString::Const(") { ");
    ::STRINGS[73] = uString::Const("\n"
        " })");
    ::STRINGS[74] = uString::Const("Could not evaluate module '");
    ::STRINGS[75] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[76] = uString::Const("_moduleFunc");
    ::STRINGS[77] = uString::Const(".js");
    ::TYPES[64] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[38] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[65] = ::g::Uno::Collections::ICollection_typeof()->MakeType(uObject_typeof());
    ::TYPES[1] = uObject_typeof();
    ::TYPES[10] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[66] = ::g::Uno::Collections::IList_typeof()->MakeType(uObject_typeof());
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[6] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[31] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[32] = ::g::Uno::Collections::IEnumerator_typeof();
    ...
    type->SetFields(0,
        ...
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::Fuse::Scripting::ScriptModule, _names), 0,
        ::g::Uno::Func2_typeof()->MakeType(uObject_typeof(), ::g::Uno::UX::NameTable_typeof(), uObject_typeof()), offsetof(::g::Fuse::Scripting::ScriptModule, _unwrapper), 0,
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction(".ctor", NULL, (void*)ScriptModule__New1_fn, 0, true, ScriptModule_typeof(), 2, ::g::Uno::UX::NameTable_typeof(), ::g::Uno::Func2_typeof()->MakeType(uObject_typeof(), ::g::Uno::UX::NameTable_typeof(), uObject_typeof())));
}
...
// private static string ComputePath(string sourcePath, string moduleId) :303
...
// public override sealed void Evaluate(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result) :112
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uObject* ret5;
    ::g::Fuse::Scripting::Object* module = uPtr(result)->Object;
    uArray* newlines = uArray::New(::TYPES[38/*char[]*/], __this->LineNumberOffset());

    for (int i = 0; i < __this->LineNumberOffset(); ++i)
        uPtr(newlines)->Item<uChar>(i) = 10;

    uArray* args = uArray::New(::TYPES[9/*object[]*/], 3 + ((__this->_names != NULL) ? ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(__this->_names)->Objects()), ::TYPES[65/*Uno.Collections.ICollection<object>*/])) : 0));
    args->Strong<uObject*>(0) = module;
    args->Strong<uObject*>(1) = uPtr(module)->Item(::STRINGS[44/*"exports"*/]);
    args->Strong<uObject*>(2) = uDelegate::New(::TYPES[10/*Fuse.Scripting.Callback*/], (void*)ScriptModule__RequireContext__Require_fn, ScriptModule__RequireContext::New1(c, __this, result));
    ::g::Uno::UX::NameTable* rootTable = NULL;
    uString* wrappedCode = ::STRINGS[70/*"(function(m...*/];
    ::g::Uno::UX::NameTable* nt = __this->_names;
    int a = 3;
    int o = (nt != NULL) ? ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(nt)->Objects()), ::TYPES[65/*Uno.Collections.ICollection<object>*/])) - 1 : 0;
    ...
    while (nt != NULL)
    {
        ...
        {
            wrappedCode = ::g::Uno::String::op_Addition2(wrappedCode, ::g::Uno::String::op_Addition2(::STRINGS[71/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(e)));
            uPtr(args)->Strong<uObject*>(a++) = uPtr(__this->_unwrapper)->Invoke(2, (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(__this->_names)->Objects()), ::TYPES[66/*Uno.Collections.IList<object>*/]), uCRef<int>(o--), &ret5), ret5), NULL);
        }

        nt = uPtr(nt)->ParentTable;
    }

    wrappedCode = ::g::Uno::String::op_Addition2(wrappedCode, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[72/*") { "*/], uString::CharArray(newlines)), __this->Code()), ::STRINGS[73/*"\n })"*/]));
    ::g::Fuse::Scripting::Function* moduleFunc = uCast< ::g::Fuse::Scripting::Function*>(uPtr(c)->Evaluate(__this->FileName(), wrappedCode), ::TYPES[7/*Fuse.Scripting.Function*/]);

    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[74/*"Could not e...*/], __this->FileName()), ::STRINGS[75/*"': JavaScri...*/])));

    if (rootTable != NULL)
    {
        ::g::Fuse::Scripting::Object* ind3 = uAs< ::g::Fuse::Scripting::Object*>(uPtr(__this->_unwrapper)->Invoke(2, (uObject*)uPtr(rootTable)->This(), rootTable), ::TYPES[6/*Fuse.Scripting.Object*/]);
        ::g::Fuse::Scripting::Object* self = (ind3 != NULL) ? ind3 : (::g::Fuse::Scripting::Object*)uPtr(c)->NewObject();
        uPtr(self)->Item(::STRINGS[76/*"_moduleFunc"*/], moduleFunc);
        self->CallMethod(::STRINGS[76/*"_moduleFunc"*/], args);
    }
    else
        uPtr(moduleFunc)->Call(args);
}

// public Uno.UX.FileSource get_File() :31
void ScriptModule__get_File_fn(ScriptModule* __this, ::g::Uno::UX::FileSource** __retval)
{
    *__retval = __this->File();
}

// public void set_File(Uno.UX.FileSource value) :32
void ScriptModule__set_File_fn(ScriptModule* __this, ::g::Uno::UX::FileSource* value)
{
    __this->File(value);
}

// public string get_FileName() :71
void ScriptModule__get_FileName_fn(ScriptModule* __this, uString** __retval)
{
    *__retval = __this->FileName();
}

// public void set_FileName(string value) :76
void ScriptModule__set_FileName_fn(ScriptModule* __this, uString* value)
{
    __this->FileName(value);
}

// public override sealed Uno.UX.FileSource GetFile() :38
...
// public ScriptModule New([Uno.UX.NameTable names], [Uno.Func<object, Uno.UX.NameTable, object> unwrapper]) :22
void ScriptModule__New1_fn(::g::Uno::UX::NameTable* names, uDelegate* unwrapper, ScriptModule** __retval)
{
    *__retval = ScriptModule::New1(names, unwrapper);
}

// private Fuse.Scripting.Module TryResolve(string path, bool isFile) :259
...
// public ScriptModule([Uno.UX.NameTable names], [Uno.Func<object, Uno.UX.NameTable, object> unwrapper]) [instance] :22
void ScriptModule::ctor_1(::g::Uno::UX::NameTable* names, uDelegate* unwrapper)
{
    uStackFrame __("Fuse.Scripting.ScriptModule", ".ctor([Uno.UX.NameTable],[Uno.Func<object, Uno.UX.NameTable, object>])");
    ctor_();
    _names = names;
    _unwrapper = unwrapper;
}

// private bool Acceptor(object obj) [instance] :344
bool ScriptModule::Acceptor(uObject* obj)
{
    uStackFrame __("Fuse.Scripting.ScriptModule", "Acceptor(object)");
    return uIs(obj, ::TYPES[64/*Fuse.Scripting.IModuleProvider*/]);
}

// public Uno.IO.Bundle get_Bundle() [instance] :43
...
// public void set_Bundle(Uno.IO.Bundle value) [instance] :48
...
// public string get_Code() [instance] :57
...
// public void set_Code(string value) [instance] :62
...
// private string ComputePath(string moduleId, bool& isFile) [instance] :280
...
// public Uno.UX.FileSource get_File() [instance] :31
...
// public void set_File(Uno.UX.FileSource value) [instance] :32
...
// public string get_FileName() [instance] :71
...
// public void set_FileName(string value) [instance] :76
...
// private string GetSourcePath() [instance] :297
uString* ScriptModule::GetSourcePath()
{
    ...
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[38/*char[]*/], 1, '/'));
    else
        return ::STRINGS[8/*""*/];
}

// public int get_LineNumberOffset() [instance] :85
...
// public void set_LineNumberOffset(int value) [instance] :90
...
// private Uno.IO.BundleFile LookForFile(string path) [instance] :319
::g::Uno::IO::BundleFile* ScriptModule::LookForFile(uString* path)
{
    uStackFrame __("Fuse.Scripting.ScriptModule", "LookForFile(string)");
    ::g::Uno::IO::BundleFile* ret6;
    ::g::Uno::IO::BundleFile* ret7;

    if (Bundle() != NULL)

        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Bundle())->Files()), ::TYPES[31/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[32/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[33/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret6), ret6);

            if (ScriptModule::IsPathEqual(uPtr(f)->SourcePath(), path))
                return f;
        }

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[31/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[32/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* f1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[33/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret7), ret7);
...
// private Fuse.Scripting.Module TryResolve(string path, bool isFile) [instance] :259
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[67/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            ...
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[64/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
// private static string ComputePath(string sourcePath, string moduleId) [static] :303
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[38/*char[]*/], 1, '/'));
...
// private static bool IsPathEqual(string src, string path) [static] :337
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[77/*".js"*/])))
        return true;

    return false;
}

// public ScriptModule New([Uno.UX.NameTable names], [Uno.Func<object, Uno.UX.NameTable, object> unwrapper]) [static] :22
ScriptModule* ScriptModule::New1(::g::Uno::UX::NameTable* names, uDelegate* unwrapper)
{
    ScriptModule* obj4 = (ScriptModule*)uNew(ScriptModule_typeof());
    obj4->ctor_1(names, unwrapper);
    return obj4;
}
// }
...
// public delegate TJSValue ValueConverter<T, TJSValue>(Fuse.Scripting.Context context, T originalValue) :985
