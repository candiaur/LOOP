...
// {
// static Template9() :1036
static void Cursos__Template9__cctor__fn(uType* __type)
{
    Cursos__Template9::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Source"*/]);
    Cursos__Template9::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Value"*/]);
}

static void Cursos__Template9_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Source");
    ::STRINGS[1] = uString::Const("Value");
    ::STRINGS[2] = uString::Const("icono");
    ::STRINGS[3] = uString::Const("nivel");
    ::STRINGS[4] = uString::Const("auto,auto");
    ...
    ::TYPES[2] = ::g::Fuse::Reactive::DataToResourceBinding_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof());
    ...
    type->SetFields(2,
        ::g::Cursos_typeof(), offsetof(::g::Cursos__Template9, __parent1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof()), offsetof(::g::Cursos__Template9, temp_Source_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::Cursos__Template9, temp1_Value_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::Cursos__Template9::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::Cursos__Template9::__selector1_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Cursos__Template9__New2_fn, 0, true, Cursos__Template9_typeof(), 1, ::g::Cursos_typeof()));
}
...
::g::Uno::UX::Template_type* Cursos__Template9_typeof()
{
    ...
    options.ObjectSize = sizeof(Cursos__Template9);
    options.TypeSize = sizeof(::g::Uno::UX::Template_type);
    type = (::g::Uno::UX::Template_type*)uClassType::New("Cursos.Template9", options);
    type->SetBase(::g::Uno::UX::Template_typeof());
    type->fp_build_ = Cursos__Template9_build;
    type->fp_cctor_ = Cursos__Template9__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Template*, uObject**))Cursos__Template9__New1_fn;
    return type;
}

// public Template9(Cursos parent) :1030
void Cursos__Template9__ctor_1_fn(Cursos__Template9* __this, ::g::Cursos* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :1039
void Cursos__Template9__New1_fn(Cursos__Template9* __this, uObject** __retval)
{
    uStackFrame __("Cursos.Template9", "New()");
    ::g::Fuse::Controls::StackPanel* self = ::g::Fuse::Controls::StackPanel::New4();
    ::g::Fuse::Controls::Image* temp = ::g::Fuse::Controls::Image::New3();
    __this->temp_Source_inst = ::g::LOOP_FuseControlsImage_Source_Property::New1(temp, Cursos__Template9::__selector0());
    ::g::Fuse::Controls::Text* temp1 = ::g::Fuse::Controls::Text::New3();
    __this->temp1_Value_inst = ::g::LOOP_FuseControlsText_Value_Property::New1(temp1, Cursos__Template9::__selector1());
    ::g::Fuse::Controls::Grid* temp2 = ::g::Fuse::Controls::Grid::New4();
    ::g::Fuse::Reactive::DataToResourceBinding* temp3 = (::g::Fuse::Reactive::DataToResourceBinding*)::g::Fuse::Reactive::DataToResourceBinding::New2(::TYPES[2/*Fuse.Reactive.DataToResourceBinding<Fuse.Resources.ImageSource>*/], __this->temp_Source_inst, ::STRINGS[2/*"icono"*/]);
    ::g::Fuse::Reactive::DataBinding* temp4 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[3/*Fuse.Reactive.DataBinding<string>*/], __this->temp1_Value_inst, ::STRINGS[3/*"nivel"*/]);
    ...
    temp2->Columns(::STRINGS[4/*"auto,auto"*/]);
...
// public Template9 New(Cursos parent) :1030
void Cursos__Template9__New2_fn(::g::Cursos* parent, Cursos__Template9** __retval)
{
    *__retval = Cursos__Template9::New2(parent);
}

::g::Uno::UX::Selector Cursos__Template9::__selector0_;
::g::Uno::UX::Selector Cursos__Template9::__selector1_;

// public Template9(Cursos parent) [instance] :1030
void Cursos__Template9::ctor_1(::g::Cursos* parent)
{
    uStackFrame __("Cursos.Template9", ".ctor(Cursos)");
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Template9 New(Cursos parent) [static] :1030
Cursos__Template9* Cursos__Template9::New2(::g::Cursos* parent)
{
    Cursos__Template9* obj1 = (Cursos__Template9*)uNew(Cursos__Template9_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
