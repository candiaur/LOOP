...
// public abstract extern class LeafView :959
// {
...
// protected LeafView(ObjC.Object handle) :962
void LeafView__ctor_1_fn(LeafView* __this, uObject* handle)
{
    __this->ctor_1(handle);
}

// private float2 Fuse.Controls.Native.ILeafView.Measure(Fuse.LayoutParams lp, float density) :964
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.LeafView", "Fuse.Controls.Native.ILeafView.Measure(Fuse.LayoutParams,float)");
    ::g::Fuse::LayoutParams lp_ = *lp;
    ::g::Uno::Float2 fillSize = lp_.Size();
    ...
    float resW;
    float resH;
    LeafView::SizeThatFits(__this->Handle(), maxSize.X, maxSize.Y, &resW, &resH);
    ::g::Uno::Float2 result = ::g::Uno::Float2__New2(resW, resH);
    return *__retval = ::g::Fuse::Controls::Native::iOS::iOSDevice::CompensateForOrientation(result), void();
}

// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) :983
...
// protected LeafView(ObjC.Object handle) [instance] :962
void LeafView::ctor_1(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.LeafView", ".ctor(ObjC.Object)");
    ctor_(handle);
}

// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) [static] :983
void LeafView::SizeThatFits(uObject* handle, float w, float h, float* resW, float* resH)
{
    uStackFrame __("Fuse.Controls.Native.iOS.LeafView", "SizeThatFits(ObjC.Object,float,float,float&,float&)");
    @autoreleasepool
    {
