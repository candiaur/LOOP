...
// public sealed extern class Slider :1383
// {
static void Slider_build(uType* type)
{
    ...
    type->SetFields(3,
        ::g::Fuse::Controls::Native::IRangeViewHost_typeof(), offsetof(::g::Fuse::Controls::Native::iOS::Slider, _host), 0,
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Controls::Native::iOS::Slider, _valueChangedEvent), 0);
...
// public Slider(Fuse.Controls.Native.IRangeViewHost host) :1395
void Slider__ctor_2_fn(Slider* __this, uObject* host)
{
    __this->ctor_2(host);
}

// private static ObjC.Object Create() :1410
void Slider__Create_fn(uObject** __retval)
{
    *__retval = Slider::Create();
}

// public override sealed void Dispose() :1401
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :1418
...
// public void set_Progress(double value) [instance] :1388
void Slider::Progress(double value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Slider", "set_Progress(double)");
    Value((float)value * 100.0f);
}

// private float get_Value() [instance] :1425
float Slider::Value()
{
    uStackFrame __("Fuse.Controls.Native.iOS.Slider", "get_Value()");
    return Slider::GetValue(Handle());
}

// private void set_Value(float value) [instance] :1426
void Slider::Value(float value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Slider", "set_Value(float)");
    Slider::SetValue(Handle(), value);
}

// private static ObjC.Object Create() [static] :1410
uObject* Slider::Create()
{
    uStackFrame __("Fuse.Controls.Native.iOS.Slider", "Create()");
    @autoreleasepool
    {
...
// private static float GetValue(ObjC.Object handle) [static] :1430
float Slider::GetValue(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Slider", "GetValue(ObjC.Object)");
    @autoreleasepool
    {
...
// public Slider New(Fuse.Controls.Native.IRangeViewHost host) [static] :1395
...
// private static void SetValue(ObjC.Object handle, float value) [static] :1437
void Slider::SetValue(uObject* handle, float value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Slider", "SetValue(ObjC.Object,float)");
    @autoreleasepool
    {
