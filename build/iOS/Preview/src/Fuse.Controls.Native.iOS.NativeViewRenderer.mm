...
// internal sealed extern class NativeViewRenderer :1005
// {
...
// public NativeViewRenderer(ObjC.Object viewHandle) :1012
void NativeViewRenderer__ctor__fn(NativeViewRenderer* __this, uObject* viewHandle)
{
    __this->ctor_(viewHandle);
}

// private void DeleteTexture() :1124
void NativeViewRenderer__DeleteTexture_fn(NativeViewRenderer* __this)
{
    __this->DeleteTexture();
}

// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) :1059
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) :1165
void NativeViewRenderer__FreePixelBuffer_fn(void** buffer)
{
    NativeViewRenderer::FreePixelBuffer(*buffer);
}

// private void Fuse.Controls.Native.INativeViewRenderer.Draw(float4x4 localToClipTransform, float2 position, float2 size, float density) :1018
...
// private void Fuse.Controls.Native.INativeViewRenderer.Invalidate() :1119
void NativeViewRenderer__FuseControlsNativeINativeViewRendererInvalidate_fn(NativeViewRenderer* __this)
{
    uStackFrame __("Fuse.Controls.Native.iOS.NativeViewRenderer", "Fuse.Controls.Native.INativeViewRenderer.Invalidate()");
    __this->_visualValid = false;
}

// private static Uno.IntPtr MallocPixelBuffer(int size) :1160
void NativeViewRenderer__MallocPixelBuffer_fn(int* size, void** __retval)
{
    *__retval = NativeViewRenderer::MallocPixelBuffer(*size);
}

// public NativeViewRenderer New(ObjC.Object viewHandle) :1012
...
// private void Uno.IDisposable.Dispose() :1138
void NativeViewRenderer__UnoIDisposableDispose_fn(NativeViewRenderer* __this)
{
    uStackFrame __("Fuse.Controls.Native.iOS.NativeViewRenderer", "Uno.IDisposable.Dispose()");
    __this->DeleteTexture();
    __this->_viewHandle = NULL;
}

// public NativeViewRenderer(ObjC.Object viewHandle) [instance] :1012
void NativeViewRenderer::ctor_(uObject* viewHandle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.NativeViewRenderer", ".ctor(ObjC.Object)");
    _oldSize = ::g::Uno::Int2__New2(-1, -1);
    _viewHandle = viewHandle;
}

// private void DeleteTexture() [instance] :1124
void NativeViewRenderer::DeleteTexture()
{
    uStackFrame __("Fuse.Controls.Native.iOS.NativeViewRenderer", "DeleteTexture()");
...
// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) [static] :1059
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.NativeViewRenderer", "Draw(ObjC.Object,int,Uno.IntPtr,int,int,float,bool)");
    @autoreleasepool
    {
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) [static] :1165
void NativeViewRenderer::FreePixelBuffer(void* buffer)
{
    uStackFrame __("Fuse.Controls.Native.iOS.NativeViewRenderer", "FreePixelBuffer(Uno.IntPtr)");
    free( buffer );
}

// private static Uno.IntPtr MallocPixelBuffer(int size) [static] :1160
void* NativeViewRenderer::MallocPixelBuffer(int size)
{
    uStackFrame __("Fuse.Controls.Native.iOS.NativeViewRenderer", "MallocPixelBuffer(int)");
    return malloc( size );
}

// public NativeViewRenderer New(ObjC.Object viewHandle) [static] :1012
