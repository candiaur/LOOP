...
// public sealed extern class NSExtensionContext :40377
// {
static void NSExtensionContext_build(uType* type)
{
    type->SetInterfaces(
...
::g::iOS::Foundation::NSObject_type* NSExtensionContext_typeof()
{
    ...
    options.ObjectSize = sizeof(NSExtensionContext);
    options.TypeSize = sizeof(::g::iOS::Foundation::NSObject_type);
    type = (::g::iOS::Foundation::NSObject_type*)uClassType::New("iOS.Foundation.NSExtensionContext", options);
    type->SetBase(::g::iOS::Foundation::NSObject_typeof());
    type->fp_build_ = NSExtensionContext_build;
