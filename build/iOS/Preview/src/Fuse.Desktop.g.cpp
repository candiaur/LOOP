...
// /usr/local/share/uno/Packages/Fuse.Desktop/0.29.22/$.uno
// --------------------------------------------------------

// internal sealed class DesktopRootViewport :69
// {
static void DesktopRootViewport_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::RootViewport_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::RootViewport_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::RootViewport_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::RootViewport_type, interface3),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(::g::Fuse::RootViewport_type, interface4),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(::g::Fuse::RootViewport_type, interface5),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(::g::Fuse::RootViewport_type, interface6),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(::g::Fuse::RootViewport_type, interface7),
        ::g::Fuse::IViewport_typeof(), offsetof(::g::Fuse::RootViewport_type, interface8));
    type->SetFields(66,
...
::g::Fuse::RootViewport_type* DesktopRootViewport_typeof()
{
    ...
    type->interface8.fp_get_PixelsPerPoint = (void(*)(uObject*, float*))::g::Fuse::RootViewport__get_PixelsPerPoint_fn;
    type->interface8.fp_get_Size = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::RootViewport__get_Size_fn;
    type->interface8.fp_get_PixelSize = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::RootViewport__get_PixelSize_fn;
    type->interface8.fp_get_ProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ProjectionTransform_fn;
    type->interface8.fp_get_ProjectionTransformInverse = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ProjectionTransformInverse_fn;
    type->interface8.fp_get_ViewProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ViewProjectionTransform_fn;
    type->interface8.fp_get_ViewProjectionTransformInverse = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ViewProjectionTransformInverse_fn;
    type->interface8.fp_get_ViewTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ViewTransform_fn;
    type->interface8.fp_get_ViewTransformInverse = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ViewTransformInverse_fn;
    type->interface8.fp_get_ViewOrigin = (void(*)(uObject*, ::g::Uno::Float3*))::g::Fuse::RootViewport__get_ViewOrigin_fn;
    type->interface8.fp_get_ViewRange = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::RootViewport__get_ViewRange_fn;
...
// public DesktopRootViewport(Uno.Platform.Window window) :73
void DesktopRootViewport__ctor_4_fn(DesktopRootViewport* __this, ::g::Uno::Platform::Window* window)
{
    __this->ctor_4(window);
}

// public DesktopRootViewport New(Uno.Platform.Window window) :73
...
// protected override sealed void OnInvalidateVisual() :133
...
// private void OnPointerLeft(object sender, Uno.Platform.PointerEventArgs args) :187
...
// private void OnPointerMoved(object sender, Uno.Platform.PointerEventArgs args) :163
...
// private void OnPointerPressed(object sender, Uno.Platform.PointerEventArgs args) :139
...
// private void OnPointerReleased(object sender, Uno.Platform.PointerEventArgs args) :151
...
// private void OnPointerWheelChanged(object sender, Uno.Platform.PointerEventArgs args) :175
...
// private Fuse.Input.PointerEventData TranslatePointerEvent(Uno.Platform.PointerEventArgs args) :88
...
// public DesktopRootViewport(Uno.Platform.Window window) [instance] :73
...
// private void OnPointerLeft(object sender, Uno.Platform.PointerEventArgs args) [instance] :187
...
// private void OnPointerMoved(object sender, Uno.Platform.PointerEventArgs args) [instance] :163
...
// private void OnPointerPressed(object sender, Uno.Platform.PointerEventArgs args) [instance] :139
...
// private void OnPointerReleased(object sender, Uno.Platform.PointerEventArgs args) [instance] :151
...
// private void OnPointerWheelChanged(object sender, Uno.Platform.PointerEventArgs args) [instance] :175
...
// private Fuse.Input.PointerEventData TranslatePointerEvent(Uno.Platform.PointerEventArgs args) [instance] :88
...
// public DesktopRootViewport New(Uno.Platform.Window window) [static] :73
