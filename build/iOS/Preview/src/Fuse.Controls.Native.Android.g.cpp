...
#include <Fuse.Controls.Native.Android.TouchAction.h>
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/0.29.22/Android/$.uno
// ------------------------------------------------------------------------
...
// internal static class Helpers :226
// {
...
// public static int EncodeColor(float4 c) [static] :228
...
// public sealed extern class Slider :1022
// {
...
// public Slider(Fuse.Controls.Native.IRangeViewHost host) :1027
void Slider__ctor__fn(Slider* __this, uObject* host)
{
    __this->ctor_(host);
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host) :1027
void Slider__New1_fn(uObject* host, Slider** __retval)
{
    *__retval = Slider::New1(host);
}

// public void set_Progress(double value) :1024
void Slider__set_Progress_fn(Slider* __this, double* value)
{
    __this->Progress(*value);
}

// public Slider(Fuse.Controls.Native.IRangeViewHost host) [instance] :1027
void Slider::ctor_(uObject* host)
{
}

// public void set_Progress(double value) [instance] :1024
void Slider::Progress(double value)
{
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host) [static] :1027
...
// public sealed extern class Switch :1155
// {
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :1161
void Switch__ctor__fn(Switch* __this, uObject* host)
{
    __this->ctor_(host);
}

// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) :1158
void Switch__set_Host_fn(Switch* __this, uObject* value)
{
    __this->Host(value);
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) :1161
void Switch__New1_fn(uObject* host, Switch** __retval)
{
    *__retval = Switch::New1(host);
}

// public void set_Value(bool value) :1157
void Switch__set_Value_fn(Switch* __this, bool* value)
{
    __this->Value(*value);
}

// public Switch(Fuse.Controls.Native.IToggleViewHost host) [instance] :1161
void Switch::ctor_(uObject* host)
{
}

// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) [instance] :1158
void Switch::Host(uObject* value)
{
}

// public void set_Value(bool value) [instance] :1157
void Switch::Value(bool value)
{
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :1161
...
// /usr/local/share/uno/Packages/Fuse.Controls.MapView/0.29.22/Android/$.uno
// -------------------------------------------------------------------------
...
uEnumType* TouchAction_typeof()
{
    ...
    type = uEnumType::New("Fuse.Controls.Native.Android.TouchAction", ::g::Uno::Int_typeof(), 3);
    type->SetLiterals(
        "DOWN", 0LL,
        "UP", 1LL,
        "MOVE", 2LL);
