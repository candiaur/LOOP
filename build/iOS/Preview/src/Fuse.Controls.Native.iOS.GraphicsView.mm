...
// public sealed extern class GraphicsView :366
// {
static void GraphicsView_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)GraphicsView__New1_fn, 0, true, GraphicsView_typeof(), 1, ::g::Fuse::Visual_typeof()));
}
...
GraphicsView_type* GraphicsView_typeof()
{
    ...
    type->interface2.fp_BeginDraw = (void(*)(uObject*, ::g::Uno::Int2*))GraphicsView__FuseControlsNativeIGraphicsViewBeginDraw_fn;
...
// public GraphicsView(Fuse.Visual visual) :371
void GraphicsView__ctor_1_fn(GraphicsView* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_1(visual);
}

// private static void BeginDraw(ObjC.Object handle, int x, int y) :407
void GraphicsView__BeginDraw_fn(uObject* handle, int* x, int* y)
{
    GraphicsView::BeginDraw(handle, *x, *y);
}

// private static ObjC.Object Create() :393
void GraphicsView__Create_fn(uObject** __retval)
{
    *__retval = GraphicsView::Create();
}

// private static void DeleteDrawable(ObjC.Object handle) :442
void GraphicsView__DeleteDrawable_fn(uObject* handle)
{
    GraphicsView::DeleteDrawable(handle);
}

// public override sealed void Dispose() :434
void GraphicsView__Dispose_fn(GraphicsView* __this)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "Dispose()");
    __this->_visual = NULL;
    GraphicsView::DeleteDrawable(__this->Handle());
    ::g::Fuse::Controls::Native::iOS::View__Dispose_fn(__this);
}

// private static void EndDraw(ObjC.Object handle) :428
void GraphicsView__EndDraw_fn(uObject* handle)
{
    GraphicsView::EndDraw(handle);
}

// private void Fuse.Controls.Native.IGraphicsView.BeginDraw(int2 size) :402
void GraphicsView__FuseControlsNativeIGraphicsViewBeginDraw_fn(GraphicsView* __this, ::g::Uno::Int2* size)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "Fuse.Controls.Native.IGraphicsView.BeginDraw(int2)");
    ::g::Uno::Int2 size_ = *size;
    GraphicsView::BeginDraw(__this->Handle(), size_.X, size_.Y);
}

// private void Fuse.Controls.Native.IGraphicsView.EndDraw() :404
void GraphicsView__FuseControlsNativeIGraphicsViewEndDraw_fn(GraphicsView* __this)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "Fuse.Controls.Native.IGraphicsView.EndDraw()");
    GraphicsView::EndDraw(__this->Handle());
}

// public GraphicsView New(Fuse.Visual visual) :371
void GraphicsView__New1_fn(::g::Fuse::Visual* visual, GraphicsView** __retval)
{
    *__retval = GraphicsView::New1(visual);
}

// private void OnTouch(ObjC.Object sender, ObjC.Object uiEvent) :377
void GraphicsView__OnTouch_fn(GraphicsView* __this, uObject* sender, uObject* uiEvent)
{
    __this->OnTouch(sender, uiEvent);
}

// private static void SetCallback(ObjC.Object handle, Uno.Action<ObjC.Object, ObjC.Object> callback) :386
void GraphicsView__SetCallback_fn(uObject* handle, uDelegate* callback)
{
    GraphicsView::SetCallback(handle, callback);
}

// public GraphicsView(Fuse.Visual visual) [instance] :371
void GraphicsView::ctor_1(::g::Fuse::Visual* visual)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", ".ctor(Fuse.Visual)");
...
// private void OnTouch(ObjC.Object sender, ObjC.Object uiEvent) [instance] :377
void GraphicsView::OnTouch(uObject* sender, uObject* uiEvent)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "OnTouch(ObjC.Object,ObjC.Object)");

    if (_visual != NULL)
        ::g::Fuse::Controls::Native::iOS::InputDispatch::HandleEvent1(Handle(), _visual, uiEvent);
}

// private static void BeginDraw(ObjC.Object handle, int x, int y) [static] :407
void GraphicsView::BeginDraw(uObject* handle, int x, int y)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "BeginDraw(ObjC.Object,int,int)");
    @autoreleasepool
    {
        [] (::id handle, int x, int y) -> void
        {
            if (x < 1 || y < 1)
            	return;
...
// private static ObjC.Object Create() [static] :393
uObject* GraphicsView::Create()
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "Create()");
    @autoreleasepool
    {
...
// private static void DeleteDrawable(ObjC.Object handle) [static] :442
void GraphicsView::DeleteDrawable(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "DeleteDrawable(ObjC.Object)");
    @autoreleasepool
    {
        [] (::id handle) -> void
        {
...
// private static void EndDraw(ObjC.Object handle) [static] :428
...
// public GraphicsView New(Fuse.Visual visual) [static] :371
...
// private static void SetCallback(ObjC.Object handle, Uno.Action<ObjC.Object, ObjC.Object> callback) [static] :386
void GraphicsView::SetCallback(uObject* handle, uDelegate* callback)
{
    uStackFrame __("Fuse.Controls.Native.iOS.GraphicsView", "SetCallback(ObjC.Object,Uno.Action<ObjC.Object, ObjC.Object>)");
    @autoreleasepool
    {
