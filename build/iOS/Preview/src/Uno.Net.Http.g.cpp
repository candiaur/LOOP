...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.29.20/UriParsers/$.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.29.20/$.uno
// --------------------------------------------------------
...
static void HostInfoParser__cctor__fn(uType* __type)
{
    ...
    HostInfoParser::_invalidChars_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[2/*".."*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[3/*","*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[4/*"\\"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[5/*"|"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[6/*"<"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[7/*">"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[8/*"'"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[9/*";"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[10/*":"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[11/*"["*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[12/*"]"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[13/*"{"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[14/*"}"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[15/*"("*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[16/*")"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[17/*"="*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[18/*"+"*/]), collection1);
}
...
// internal sealed class HttpDefaultDispatcher :845
// {
...
// public HttpDefaultDispatcher New() [static] :847
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Uno.Net.Http/0.29.20/$.uno");
...
{
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    ::TYPES[4] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[5] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    type->SetInterfaces(
...
void HttpMessageHandler::AbortPendingRequests()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Net::Http::HttpMessageHandlerRequest*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_pendingRequests), &ret4), ret4); enum2.MoveNext(::TYPES[5/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]); )
    {
        ::g::Uno::Net::Http::HttpMessageHandlerRequest* request = enum2.Current(::TYPES[5/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]);
...
void HttpMessageHandler::Dispose()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Net::Http::HttpMessageHandlerRequest*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_pendingRequests), &ret7), ret7); enum1.MoveNext(::TYPES[5/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]); )
    {
        ::g::Uno::Net::Http::HttpMessageHandlerRequest* request = enum1.Current(::TYPES[5/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]);
...
static void HttpMessageHandlerRequest_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("HttpMessageHandlerRequest");
    ::STRINGS[31] = uString::Const("");
    ::STRINGS[32] = uString::Const("GET");
    ::STRINGS[33] = uString::Const("HEAD");
    ::STRINGS[34] = uString::Const("Not allowed to set header \"");
    ::STRINGS[35] = uString::Const("\" on this target.");
    ::TYPES[6] = ::g::Uno::Net::Http::Implementation::IHttpRequest_typeof();
    ...
    ::TYPES[13] = HttpMessageHandlerRequest__DispatchClosure1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[14] = ::g::Uno::Action1_typeof()->MakeType(HttpMessageHandlerRequest_typeof());
    ::TYPES[15] = ::g::Uno::Action2_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof());
    ::TYPES[16] = ::g::Uno::Action4_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof());
    type->SetInterfaces(
...
// public byte[] GetResponseContentByteArray() :628
...
// public string GetResponseContentString() :614
...
// public string GetResponseHeader(string name) :591
...
// public string GetResponseHeaders() :602
...
// public int GetResponseStatus() :580
...
// public void SetResponseType(Uno.Net.Http.HttpResponseType responseType) :492
...
// public void SetTimeout(int timeoutInMilliseconds) :482
...
// public void Abort() [instance] :566
void HttpMessageHandlerRequest::Abort()
{
    ...
    ::g::Uno::Net::Http::Implementation::IHttpRequest::Abort(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    OnAborted();
}
...
void HttpMessageHandlerRequest::add_Aborted(uDelegate* value)
{
    ...
    Aborted1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Aborted1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_Aborted(uDelegate* value)
{
    ...
    Aborted1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Aborted1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::CheckDisposed()
{
    ...
    if (_httpRequest == NULL)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[30/*"HttpMessage...*/]));
}
...
void HttpMessageHandlerRequest::Dispose()
{
    ...
    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_httpRequest), ::TYPES[8/*Uno.IDisposable*/]));
    _httpRequest = NULL;
...
void HttpMessageHandlerRequest::add_Done(uDelegate* value)
{
    ...
    Done1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Done1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_Done(uDelegate* value)
{
    ...
    Done1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Done1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::add_Error(uDelegate* value)
{
    ...
    Error1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Error1, value), ::TYPES[15/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/]);
}
...
void HttpMessageHandlerRequest::remove_Error(uDelegate* value)
{
    ...
    Error1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Error1, value), ::TYPES[15/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/]);
}

// public byte[] GetResponseContentByteArray() [instance] :628
uArray* HttpMessageHandlerRequest::GetResponseContentByteArray()
{
    ...
    if ((State() < 4) || (State() > 5))
        return uArray::New(::TYPES[10/*byte[]*/], 0);

    uArray* ind2 = ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseContentByteArray(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    return (ind2 != NULL) ? ind2 : uArray::New(::TYPES[10/*byte[]*/], 0);
}

// public string GetResponseContentString() [instance] :614
uString* HttpMessageHandlerRequest::GetResponseContentString()
{
    ...
    uString* ind1 = ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseContentString(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    return (ind1 != NULL) ? ind1 : ::STRINGS[31/*""*/];
}

// public string GetResponseHeader(string name) [instance] :591
uString* HttpMessageHandlerRequest::GetResponseHeader(uString* name)
{
    ...
    return ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseHeader(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]), name);
}

// public string GetResponseHeaders() [instance] :602
uString* HttpMessageHandlerRequest::GetResponseHeaders()
{
    ...
    return ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseHeaders(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]));
}

// public int GetResponseStatus() [instance] :580
int HttpMessageHandlerRequest::GetResponseStatus()
{
    ...
    return ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseStatus(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]));
}
...
// private bool IsComplete() [instance] :408
...
// internal void OnAborted() [instance] :413
void HttpMessageHandlerRequest::OnAborted()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[4/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure__Run_fn, HttpMessageHandlerRequest__DispatchClosure::New1(6, handler, this)));
}

// internal void OnDone() [instance] :434
void HttpMessageHandlerRequest::OnDone()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[4/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure__Run_fn, HttpMessageHandlerRequest__DispatchClosure::New1(5, handler, this)));
}

// internal void OnError(string platformspesificErrorMessage) [instance] :420
void HttpMessageHandlerRequest::OnError(uString* platformspesificErrorMessage)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[4/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure1__Run_fn, (HttpMessageHandlerRequest__DispatchClosure1__New1_fn(::TYPES[13/*Uno.Net.Http.HttpMessageHandlerRequest.DispatchClosure<string>*/], uCRef<int>(7), handler, this, platformspesificErrorMessage, &ret4), ret4)));
}
...
// internal void OnTimeout() [instance] :427
void HttpMessageHandlerRequest::OnTimeout()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[4/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure__Run_fn, HttpMessageHandlerRequest__DispatchClosure::New1(8, handler, this)));
}
...
void HttpMessageHandlerRequest::add_Progress(uDelegate* value)
{
    ...
    Progress1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Progress1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/]);
}
...
void HttpMessageHandlerRequest::remove_Progress(uDelegate* value)
{
    ...
    Progress1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Progress1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/]);
}

// public void SendAsync() [instance] :553
void HttpMessageHandlerRequest::SendAsync()
{
    ...
    _state = 2;
    ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    OnStateChanged();
}

// public void SendAsync(string data) [instance] :535
void HttpMessageHandlerRequest::SendAsync2(uString* data)
{
    ...
    if (((::g::Uno::String::op_Equality(Method(), ::STRINGS[32/*"GET"*/]) || ::g::Uno::String::op_Equality(Method(), ::STRINGS[33/*"HEAD"*/])) || ::g::Uno::String::op_Equality(data, NULL)) || ::g::Uno::String::op_Equality(data, ::STRINGS[31/*""*/]))
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    else
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync2(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]), data);

    OnStateChanged();
}

// public void SetHeader(string name, string value) [instance] :469
void HttpMessageHandlerRequest::SetHeader(uString* name, uString* value)
{
    ...
    if (!HttpMessageHandlerRequest::IsHeaderValid(name, value))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[34/*"Not allowed...*/], name), ::STRINGS[35/*"\" on this ...*/])));

    ::g::Uno::Net::Http::Implementation::IHttpRequest::SetHeader(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]), name, value);
}

// public void SetResponseType(Uno.Net.Http.HttpResponseType responseType) [instance] :492
...
// public void SetTimeout(int timeoutInMilliseconds) [instance] :482
void HttpMessageHandlerRequest::SetTimeout(int timeoutInMilliseconds)
{
    ...
    ::g::Uno::Net::Http::Implementation::IHttpRequest::SetTimeout(uInterface(uPtr(_httpRequest), ::TYPES[6/*Uno.Net.Http.Implementation.IHttpRequest*/]), timeoutInMilliseconds);
}
...
void HttpMessageHandlerRequest::add_StateChanged(uDelegate* value)
{
    ...
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(StateChanged1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_StateChanged(uDelegate* value)
{
    ...
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(StateChanged1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::add_Timeout(uDelegate* value)
{
    ...
    Timeout1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Timeout1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_Timeout(uDelegate* value)
{
    ...
    Timeout1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Timeout1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}

// private static bool IsHeaderValid(string name, string value) [static] :643
...
// public enum HttpRequestState :710
...
// public static class HttpStatusReasonPhrase :748
// {
// static HttpStatusReasonPhrase() :748
static void HttpStatusReasonPhrase__cctor__fn(uType* __type)
{
    ...
    HttpStatusReasonPhrase::Informational_ = (uObject*)(collection5 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[18/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(100), ::STRINGS[36/*"Continue"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(101), ::STRINGS[37/*"Switching P...*/]), collection5);
    HttpStatusReasonPhrase::Success_ = (uObject*)(collection4 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[18/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(200), ::STRINGS[38/*"OK"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(201), ::STRINGS[39/*"Created"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(202), ::STRINGS[40/*"Accepted"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(203), ::STRINGS[41/*"Non-Authori...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(204), ::STRINGS[42/*"No Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(205), ::STRINGS[43/*"Reset Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(206), ::STRINGS[44/*"Partial Con...*/]), collection4);
    HttpStatusReasonPhrase::Redirection_ = (uObject*)(collection3 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[18/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(300), ::STRINGS[45/*"Multiple Ch...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(301), ::STRINGS[46/*"Moved Perma...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(302), ::STRINGS[47/*"Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(303), ::STRINGS[48/*"See Other"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(304), ::STRINGS[49/*"Not Modified"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(305), ::STRINGS[50/*"Use Proxy"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(307), ::STRINGS[51/*"Temporary R...*/]), collection3);
    HttpStatusReasonPhrase::ClientErrors_ = (uObject*)(collection2 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[18/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(400), ::STRINGS[52/*"Bad Request"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(401), ::STRINGS[53/*"Unauthorized"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(402), ::STRINGS[54/*"Payment Req...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(403), ::STRINGS[55/*"Forbidden"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(404), ::STRINGS[56/*"Not Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(405), ::STRINGS[57/*"Method Not ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(406), ::STRINGS[58/*"Not Accepta...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(407), ::STRINGS[59/*"Proxy Authe...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(408), ::STRINGS[60/*"Request Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(409), ::STRINGS[61/*"Conflict"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(410), ::STRINGS[62/*"Gone"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(411), ::STRINGS[63/*"Length Requ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(412), ::STRINGS[64/*"Preconditio...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(413), ::STRINGS[65/*"Request Ent...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(414), ::STRINGS[66/*"Request-URI...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(415), ::STRINGS[67/*"Unsupported...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(416), ::STRINGS[68/*"Requested r...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(417), ::STRINGS[69/*"Expectation...*/]), collection2);
    HttpStatusReasonPhrase::ServerErrors_ = (uObject*)(collection1 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[18/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(500), ::STRINGS[70/*"Internal Se...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(501), ::STRINGS[71/*"Not Impleme...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(502), ::STRINGS[72/*"Bad Gateway"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(503), ::STRINGS[73/*"Service Una...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(504), ::STRINGS[74/*"Gateway Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(505), ::STRINGS[75/*"HTTP Versio...*/]), collection1);
}

static void HttpStatusReasonPhrase_build(uType* type)
{
    ::STRINGS[36] = uString::Const("Continue");
    ::STRINGS[37] = uString::Const("Switching Protocols");
    ::STRINGS[38] = uString::Const("OK");
    ::STRINGS[39] = uString::Const("Created");
    ::STRINGS[40] = uString::Const("Accepted");
    ::STRINGS[41] = uString::Const("Non-Authoritative Information");
    ::STRINGS[42] = uString::Const("No Content");
    ::STRINGS[43] = uString::Const("Reset Content");
    ::STRINGS[44] = uString::Const("Partial Content");
    ::STRINGS[45] = uString::Const("Multiple Choices");
    ::STRINGS[46] = uString::Const("Moved Permanently");
    ::STRINGS[47] = uString::Const("Found");
    ::STRINGS[48] = uString::Const("See Other");
    ::STRINGS[49] = uString::Const("Not Modified");
    ::STRINGS[50] = uString::Const("Use Proxy");
    ::STRINGS[51] = uString::Const("Temporary Redirect");
    ::STRINGS[52] = uString::Const("Bad Request");
    ::STRINGS[53] = uString::Const("Unauthorized");
    ::STRINGS[54] = uString::Const("Payment Required");
    ::STRINGS[55] = uString::Const("Forbidden");
    ::STRINGS[56] = uString::Const("Not Found");
    ::STRINGS[57] = uString::Const("Method Not Allowed");
    ::STRINGS[58] = uString::Const("Not Acceptable");
    ::STRINGS[59] = uString::Const("Proxy Authentication Required");
    ::STRINGS[60] = uString::Const("Request Time-out");
    ::STRINGS[61] = uString::Const("Conflict");
    ::STRINGS[62] = uString::Const("Gone");
    ::STRINGS[63] = uString::Const("Length Required");
    ::STRINGS[64] = uString::Const("Precondition Failed");
    ::STRINGS[65] = uString::Const("Request Entity Too Large");
    ::STRINGS[66] = uString::Const("Request-URI Too Large");
    ::STRINGS[67] = uString::Const("Unsupported Media Type");
    ::STRINGS[68] = uString::Const("Requested range not satisfiable");
    ::STRINGS[69] = uString::Const("Expectation Failed");
    ::STRINGS[70] = uString::Const("Internal Server Error");
    ::STRINGS[71] = uString::Const("Not Implemented");
    ::STRINGS[72] = uString::Const("Bad Gateway");
    ::STRINGS[73] = uString::Const("Service Unavailable");
    ::STRINGS[74] = uString::Const("Gateway Time-out");
    ::STRINGS[75] = uString::Const("HTTP Version not supported");
    ::TYPES[17] = ::g::Uno::Collections::IDictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    ::TYPES[18] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
// public static string GetFromStatusCode(int statusCode) :815
...
// public static string GetFromStatusCode(int statusCode) [static] :815
uString* HttpStatusReasonPhrase::GetFromStatusCode(int statusCode)
{
    ...
    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Informational()), ::TYPES[17/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret6), ret6))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Success()), ::TYPES[17/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret7), ret7))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Redirection()), ::TYPES[17/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret8), ret8))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::ClientErrors()), ::TYPES[17/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret9), ret9))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::ServerErrors()), ::TYPES[17/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret10), ret10))
        return description;
...
// public sealed class InvalidResponseTypeException :689
// {
static void InvalidResponseTypeException_build(uType* type)
{
    ::STRINGS[76] = uString::Const("Response type is invalid.");
    type->SetFields(3);
    type->Reflection.SetFunctions(1,
...
// public InvalidResponseTypeException() :691
void InvalidResponseTypeException__ctor_3_fn(InvalidResponseTypeException* __this)
{
    __this->ctor_3();
}

// public InvalidResponseTypeException New() :691
...
// public InvalidResponseTypeException() [instance] :691
void InvalidResponseTypeException::ctor_3()
{
    ctor_1(::STRINGS[76/*"Response ty...*/]);
}

// public InvalidResponseTypeException New() [static] :691
...
// public sealed class InvalidStateException :695
// {
static void InvalidStateException_build(uType* type)
{
    ::STRINGS[77] = uString::Const("The object is in an invalid state.");
    type->SetFields(3);
    type->Reflection.SetFunctions(2,
...
// public InvalidStateException() [instance] :697
void InvalidStateException::ctor_3()
{
    ctor_1(::STRINGS[77/*"The object ...*/]);
}

// public InvalidStateException(string message) [instance] :700
void InvalidStateException::ctor_4(uString* message)
{
    ctor_1(message);
}

// public InvalidStateException New() [static] :697
...
// public InvalidStateException New(string message) [static] :700
...
{
    ::STRINGS[10] = uString::Const(":");
    ::STRINGS[78] = uString::Const("The scheme isn't specified in uriString.");
    ::STRINGS[79] = uString::Const("The scheme specified in uriString is not correctly formed.");
    ::STRINGS[80] = uString::Const("The length of the scheme specified in uriString exceeds 1023 characters.");
    ::STRINGS[21] = uString::Const("There is an invalid character sequence in uriString.");
    ::TYPES[7] = ::g::Uno::Int_typeof();
    type->Reflection.SetFunctions(2,
...
::g::Uno::Net::Http::SchemeParserResult SchemeParser::Parse(uString* uriString, int* idx)
{
    ...
    if (((*idx + 2) >= uriString->Length()) || (end == *idx))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[79/*"The scheme ...*/]));
...
// public sealed class UriFormatException :1085
// {
...
// public sealed class UriScheme :1108
// {
// static UriScheme() :1108
static void UriScheme__cctor__fn(uType* __type)
{
    ::g::Uno::Collections::List* collection2;
    ::g::Uno::Collections::List* collection1;
    UriScheme::KnownInternetSchemes_ = (collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[81/*"http"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[82/*"https"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[83/*"ftp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[84/*"gopher"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[85/*"nntp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[86/*"telnet"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[87/*"wais"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[88/*"file"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[89/*"prospero"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[90/*"ws"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[91/*"wss"*/]), collection2);
    UriScheme::KnownNonInternetSchemes_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[92/*"mailto"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[93/*"news"*/]), collection1);
}
...
static void UriScheme_build(uType* type)
{
    ...
    ::STRINGS[88] = uString::Const("file");
    ::STRINGS[89] = uString::Const("prospero");
    ::STRINGS[90] = uString::Const("ws");
    ::STRINGS[91] = uString::Const("wss");
    ::STRINGS[92] = uString::Const("mailto");
    ::STRINGS[93] = uString::Const("news");
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[19] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof());
    type->SetFields(0,
...
// public generated UriScheme() [instance] :1108
void UriScheme::ctor_()
{
}

// public static Uno.Net.Http.UriSchemeType GetSchemeType(string scheme) [static] :1141
...
// public static bool IsHttpScheme(string scheme) [static] :1155
...
// public generated UriScheme New() [static] :1108
...
// public static Uno.Collections.Dictionary<string, int> get_DefaultPorts() [static] :1118
::g::Uno::Collections::Dictionary* UriScheme::DefaultPorts()
{
    ...
    {
        UriScheme::_defaultPorts() = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[19/*Uno.Collections.Dictionary<string, int>*/]));
        ...
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[88/*"file"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[89/*"prospero"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[92/*"mailto"*/], uCRef<int>(25));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[93/*"news"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[90/*"ws"*/], uCRef<int>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[91/*"wss"*/], uCRef<int>(443));
    }
...
// public enum UriSchemeType :1101
...
static void UserInfoParser_build(uType* type)
{
    ...
    ::STRINGS[95] = uString::Const("The user name or password specified in uriString is not valid.");
    type->Reflection.SetFunctions(2,
...
uString* UserInfoParser::Parse(uString* uriString, int endIdx, int* idx)
{
    ...
    int end = ::g::Uno::String::IndexOf1(uPtr(uriString), ::STRINGS[94/*"@"*/], *idx);
    ...
    if (!UserInfoParser::IsValid(userInfo))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[95/*"The user na...*/]));
