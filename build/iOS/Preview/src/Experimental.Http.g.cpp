...
// /usr/local/share/uno/Packages/Experimental.Http/0.29.22/$.uno
// -------------------------------------------------------------
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Experimental.Http/0.29.22/$.uno");
...
void Loader::CloseRecord(uObject* record)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(uPtr(_header)->Headers()), ::STRINGS[6/*"etag"*/], &ret4), ret4))
        ::g::Experimental::Cache::ICacheWriter::AddMeta(uInterface(record, ::TYPES[2/*Experimental.Cache.ICacheWriter*/]), ::STRINGS[6/*"etag"*/], (::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(uPtr(_header)->Headers()), ::STRINGS[6/*"etag"*/], &ret5), ret5));
