// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.29.20/Backends/CPlusPlus/Uno/_main.cpp'.
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{uType* FocusHelpers__PerformResignFirstResponder_typeof();}}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{uType* FontCache_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{struct Control_type; ::g::Fuse::Controls::Control_type* MapView_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* Atras_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* Cursos_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* Indicador_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* udPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace Basic{::g::Fuse::Controls::Control_type* BackButton_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace Basic{::g::Fuse::Controls::Control_type* Button_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace Basic{::g::Fuse::Controls::Control_type* NavigationBar_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace Basic{::g::Fuse::Controls::Control_type* Resources_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct RangeControl_type;}} namespace Basic{::g::Fuse::Controls::RangeControl_type* Slider_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Basic{::g::Fuse::Controls::TextControl_type* Text_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct TextInput_type;}} namespace Basic{::g::Fuse::Controls::TextInput_type* TextInput_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct ToggleControl_type;}} ::g::Fuse::Controls::ToggleControl_type* Checkbox_typeof();}
namespace g{namespace Fuse{namespace Controls{struct ToggleControl_type;}} namespace Basic{::g::Fuse::Controls::ToggleControl_type* Switch_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{uType* MapCameraState_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uType* MapConfig_typeof();}}}
...
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Button_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Circle_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Control_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Image_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Rectangle_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Shape_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Slider_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* Switch_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* TextBlock_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; ::g::Fuse::iOS::Bindings::Controls::Element_type* TextInput_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct Element_type; Element_type* Element_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct MultilineTextInput_type; MultilineTextInput_type* MultilineTextInput_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{struct SingleLineTextInput_type; SingleLineTextInput_type* SingleLineTextInput_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{uClassType* ImageCache_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; ::g::Fuse::iOS::Bindings::NativeViews::NativeView_type* ContentControl_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; ::g::Fuse::iOS::Bindings::NativeViews::NativeView_type* GenericNativeView_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; ::g::Fuse::iOS::Bindings::NativeViews::NativeView_type* LeafNativeView_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; ::g::Fuse::iOS::Bindings::NativeViews::NativeView_type* NativeViewHost_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; ::g::Fuse::iOS::Bindings::NativeViews::NativeView_type* ParentControl_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; ::g::Fuse::iOS::Bindings::NativeViews::NativeView_type* ParentNativeView_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; ::g::Fuse::iOS::Bindings::NativeViews::NativeView_type* ScrollView_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{struct NativeView_type; NativeView_type* NativeView_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{namespace NativeViews{uType* NativeViewBlitter_typeof();}}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{struct ControlEvent_type; ControlEvent_type* ControlEvent_typeof();}}}}
...
namespace g{namespace Fuse{namespace iOS{namespace Bindings{struct UIControlCallback_type; UIControlCallback_type* UIControlCallback_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* FirstResponder_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* FontCache_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* InputDispatch_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* iOSBindingView_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* iOSDeviceInterop_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* iOSExtensions_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* iOSInterop_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* NSAttributedStringConstants_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* RootView_typeof();}}}}
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uClassType* Transform_typeof();}}}}
...
namespace g{namespace Fuse{namespace Navigation{struct VisualNavigation_type; ::g::Fuse::Navigation::VisualNavigation_type* HierarchicalNavigation_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{struct VisualNavigation_type; ::g::Fuse::Navigation::VisualNavigation_type* LinearNavigation_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace JavaScriptCore{uClassType* JSContext_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScriptCore{uClassType* JSValue_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Polyfills{namespace Window{::g::Fuse::Scripting::NativeModule_type* Includes_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} namespace Fuse{namespace BasicTheme{::g::Fuse::Triggers::Trigger_type* SwitchBehavior_typeof();}}}
...
namespace g{namespace Fuse{struct Node_type; namespace iOS{namespace Bindings{::g::Fuse::Node_type* StatusBarConfig_typeof();}}}}
...
namespace g{namespace iOS{namespace UIKit{struct UIView_type;}} namespace Fuse{namespace iOS{namespace Bindings{namespace Controls{::g::iOS::UIKit::UIView_type* ViewContainer_typeof();}}}}}
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_BasicBackButton_IsEnabled_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_BasicBackButton_Text_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_BasicButton_Opacity_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_BasicButton_Text_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_BasicTextInput_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseControlsCircle_Opacity_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseControlsRectangle_Height_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseControlsRectangle_Width_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseControlsText_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseControlsText_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseDrawingSolidColor_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseDrawingStroke_Width_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseEffectsDropShadow_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseBasicTheme_FuseTranslation_X_Property_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_Checkbox_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_Checkbox_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsCircle_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsCircle_LengthAngleDegrees_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsDockPanel_IsEnabled_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsDockPanel_Visibility_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsGrid_Visibility_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsImage_Source_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsImage_Url_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsPage_IsEnabled_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsPage_Visibility_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsPageControl_Active_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsStackPanel_Visibility_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsText_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsText_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsText_Visibility_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseControlsTextInput_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseDrawingSolidColor_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseReactiveEach_Items_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseTriggersActionsSetFuseElementsVisibility_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseTriggersActionsSetFuseVisual_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseTriggersWhileFalse_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_FuseTriggersWhileTrue_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* LOOP_Operation_Opacity_Property_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template10__Template11__Template12_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template10__Template11_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template10_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template11_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template5__Template6__Template7_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template5__Template6_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template5_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template6_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template7__Template8__Template9_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template7__Template8_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template7_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template8_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Cursos__Template9_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Indicador__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Indicador__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Indicador__Template2__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Indicador__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Indicador__Template3__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* Indicador__Template3_typeof();}
...
namespace g{uClassType* FuseiOSBindings_bundle_typeof();}
namespace g{uClassType* FuseReactive_bundle_typeof();}
namespace g{uClassType* LOOP_bundle_typeof();}
namespace g{uClassType* OutracksSimulatorClientUno_bundle_typeof();}
namespace g{uClassType* PolyfillsWindow_bundle_typeof();}
...
void uInitRtti()
{
    ...
    {
        (uType*(*)())&::g::Atras_typeof,
        (uType*(*)())&::g::Basic::BackButton_typeof,
        (uType*(*)())&::g::Basic::Button_typeof,
        (uType*(*)())&::g::Basic::NavigationBar_typeof,
        (uType*(*)())&::g::Basic::Resources_typeof,
        (uType*(*)())&::g::Basic::Slider_typeof,
        (uType*(*)())&::g::Basic::Switch_typeof,
        (uType*(*)())&::g::Basic::Text_typeof,
        (uType*(*)())&::g::Basic::TextInput_typeof,
        (uType*(*)())&::g::Checkbox_typeof,
        (uType*(*)())&::g::Cursos__Template_typeof,
        (uType*(*)())&::g::Cursos__Template1_typeof,
        (uType*(*)())&::g::Cursos__Template10__Template11__Template12_typeof,
        (uType*(*)())&::g::Cursos__Template10__Template11_typeof,
        (uType*(*)())&::g::Cursos__Template10_typeof,
        (uType*(*)())&::g::Cursos__Template11_typeof,
        (uType*(*)())&::g::Cursos__Template2_typeof,
        (uType*(*)())&::g::Cursos__Template3_typeof,
        (uType*(*)())&::g::Cursos__Template4_typeof,
        (uType*(*)())&::g::Cursos__Template5__Template6__Template7_typeof,
        (uType*(*)())&::g::Cursos__Template5__Template6_typeof,
        (uType*(*)())&::g::Cursos__Template5_typeof,
        (uType*(*)())&::g::Cursos__Template6_typeof,
        (uType*(*)())&::g::Cursos__Template7__Template8__Template9_typeof,
        (uType*(*)())&::g::Cursos__Template7__Template8_typeof,
        (uType*(*)())&::g::Cursos__Template7_typeof,
        (uType*(*)())&::g::Cursos__Template8_typeof,
        (uType*(*)())&::g::Cursos__Template9_typeof,
        (uType*(*)())&::g::Cursos_typeof,
        ...
        (uType*(*)())&::g::Fuse::BasicTheme::SwitchBehavior_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::MapCameraState_typeof,
        (uType*(*)())&::g::Fuse::Controls::MapConfig_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::iOS::FocusHelpers__PerformResignFirstResponder_typeof,
        ...
        (uType*(*)())&::g::Fuse::iOS::Bindings::ControlEvent_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Button_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Circle_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Control_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Element_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Image_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::ImageCache_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::MultilineTextInput_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Rectangle_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Shape_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::SingleLineTextInput_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Slider_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::Switch_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::TextBlock_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::TextInput_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Controls::ViewContainer_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::FirstResponder_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::FontCache_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::InputDispatch_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::iOSBindingView_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::iOSDeviceInterop_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::iOSExtensions_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::iOSInterop_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::ContentControl_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::GenericNativeView_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::LeafNativeView_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::NativeView_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::NativeViewBlitter_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::NativeViewHost_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::ParentControl_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::ParentNativeView_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NativeViews::ScrollView_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::NSAttributedStringConstants_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::RootView_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::StatusBarConfig_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::TextLayout_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::TextRenderer_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::Transform_typeof,
        (uType*(*)())&::g::Fuse::iOS::Bindings::UIControlCallback_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::JavaScriptCore::JSContext_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScriptCore::JSValue_typeof,
        ...
        (uType*(*)())&::g::FuseBasicTheme_BasicBackButton_IsEnabled_Property_typeof,
        (uType*(*)())&::g::FuseBasicTheme_BasicBackButton_Text_Property_typeof,
        (uType*(*)())&::g::FuseBasicTheme_BasicButton_Opacity_Property_typeof,
        (uType*(*)())&::g::FuseBasicTheme_BasicButton_Text_Property_typeof,
        (uType*(*)())&::g::FuseBasicTheme_BasicTextInput_TextColor_Property_typeof,
        ...
        (uType*(*)())&::g::FuseiOSBindings_bundle_typeof,
        ...
        (uType*(*)())&::g::Indicador__Template_typeof,
        (uType*(*)())&::g::Indicador__Template1_typeof,
        (uType*(*)())&::g::Indicador__Template2__Template3_typeof,
        (uType*(*)())&::g::Indicador__Template2_typeof,
        (uType*(*)())&::g::Indicador__Template3__Template4_typeof,
        (uType*(*)())&::g::Indicador__Template3_typeof,
        (uType*(*)())&::g::Indicador_typeof,
        ...
        (uType*(*)())&::g::LOOP_bundle_typeof,
        (uType*(*)())&::g::LOOP_Checkbox_TextColor_Property_typeof,
        (uType*(*)())&::g::LOOP_Checkbox_Value_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsCircle_Color_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsCircle_LengthAngleDegrees_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsDockPanel_IsEnabled_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsDockPanel_Visibility_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsGrid_Visibility_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsImage_Source_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsImage_Url_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsPage_IsEnabled_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsPage_Visibility_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsPageControl_Active_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsStackPanel_Visibility_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsText_TextColor_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsText_Value_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsText_Visibility_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseControlsTextInput_Value_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseDrawingSolidColor_Color_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseReactiveEach_Items_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseTriggersActionsSetFuseElementsVisibility_Value_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseTriggersActionsSetFuseVisual_Value_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseTriggersWhileFalse_Value_Property_typeof,
        (uType*(*)())&::g::LOOP_FuseTriggersWhileTrue_Value_Property_typeof,
        (uType*(*)())&::g::LOOP_Operation_Opacity_Property_typeof,
        ...
        (uType*(*)())&::g::OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Color_Property_typeof,
        ...
        (uType*(*)())&::g::Polyfills::Window::Includes_typeof,
        (uType*(*)())&::g::PolyfillsWindow_bundle_typeof,
        (uType*(*)())&::g::udPage_typeof,
