// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.29.20/Backends/CPlusPlus/Uno/ObjectModel.cpp'.
...
static uType* uNewType(uint32_t type, const char* name, const uTypeOptions& options, bool isDefinition = true)
{
    ...
    result->ObjCDefaultObjectSize = 0;
    result->ObjCNativeClass = NULL;
    result->ObjCProxyClass = NULL;
    return result;
}
