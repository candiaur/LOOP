...
// internal static extern class InputDispatch :463
// {
// static InputDispatch() :469
...
// private static void ActivateTouch(Fuse.Controls.Native.iOS.UITouch touch) :489
void InputDispatch__ActivateTouch_fn(::g::Fuse::Controls::Native::iOS::UITouch* touch)
{
    InputDispatch::ActivateTouch(touch);
}

// public static void AddListener(Fuse.Visual visual, ObjC.Object handle) :638
void InputDispatch__AddListener_fn(::g::Fuse::Visual* visual, uObject* handle)
{
    InputDispatch::AddListener(visual, handle);
}

// private static void AddListener(ObjC.Object eventHandler, ObjC.Object uicontrol) :684
...
// private static ObjC.Object CreateEventHandler(Uno.Action<ObjC.Object, ObjC.Object> callback) :674
...
// public static void HandleEvent(ObjC.Object viewHandle, Fuse.Visual origin, Fuse.Controls.Native.iOS.UIEvent uiEvent) :513
...
// public static void HandleEvent(ObjC.Object viewHandle, Fuse.Visual origin, ObjC.Object uiEvent) :507
...
// public static bool IsUIControl(ObjC.Object handle) :658
void InputDispatch__IsUIControl_fn(uObject* handle, bool* __retval)
{
    *__retval = InputDispatch::IsUIControl(handle);
}

// private static bool IsUIEvent(ObjC.Object handle) :666
void InputDispatch__IsUIEvent_fn(uObject* handle, bool* __retval)
{
    *__retval = InputDispatch::IsUIEvent(handle);
}

// private static void LostCallback() :566
void InputDispatch__LostCallback_fn()
{
    InputDispatch::LostCallback();
}

// private static Fuse.Input.PointerEventData MakePointerEventData(Fuse.Controls.Native.iOS.UITouch touch, ObjC.Object rootView, int pointIndex) :568
...
// private static void OnTouchEvent(ObjC.Object sender, ObjC.Object uiEvent) :476
void InputDispatch__OnTouchEvent_fn(uObject* sender, uObject* uiEvent)
{
    InputDispatch::OnTouchEvent(sender, uiEvent);
}

// private static void RaiseCancelled(Fuse.Visual visual, Fuse.Input.PointerEventData data) :623
...
// private static void RaiseMoved(Fuse.Visual visual, Fuse.Input.PointerEventData data) :598
...
// private static void RaisePressed(Fuse.Visual visual, Fuse.Input.PointerEventData data) :586
...
// private static void RaiseReleased(Fuse.Visual visual, Fuse.Input.PointerEventData data) :610
...
// public static void RemoveListener(Fuse.Visual visual, ObjC.Object handle) :647
void InputDispatch__RemoveListener_fn(::g::Fuse::Visual* visual, uObject* handle)
{
    InputDispatch::RemoveListener(visual, handle);
}

// private static void RemoveListener(ObjC.Object eventHandler, ObjC.Object uicontrol) :694
...
// public static generated ObjC.Object get_RootView() :505
void InputDispatch__get_RootView_fn(uObject** __retval)
{
    *__retval = InputDispatch::RootView();
}

// public static generated void set_RootView(ObjC.Object value) :505
...
// private static void ActivateTouch(Fuse.Controls.Native.iOS.UITouch touch) [static] :489
...
// public static void AddListener(Fuse.Visual visual, ObjC.Object handle) [static] :638
...
// private static void AddListener(ObjC.Object eventHandler, ObjC.Object uicontrol) [static] :684
...
// private static ObjC.Object CreateEventHandler(Uno.Action<ObjC.Object, ObjC.Object> callback) [static] :674
...
// private static void DeactivateAllTouches() [static] :500
...
// private static Fuse.Visual FindRoot(Fuse.Visual visual) [static] :581
...
// private static int GetPointerIndex(Fuse.Controls.Native.iOS.UITouch touch) [static] :495
...
// public static void HandleEvent(ObjC.Object viewHandle, Fuse.Visual origin, Fuse.Controls.Native.iOS.UIEvent uiEvent) [static] :513
...
// public static void HandleEvent(ObjC.Object viewHandle, Fuse.Visual origin, ObjC.Object uiEvent) [static] :507
...
// public static bool IsUIControl(ObjC.Object handle) [static] :658
...
// private static bool IsUIEvent(ObjC.Object handle) [static] :666
...
// private static void LostCallback() [static] :566
void InputDispatch::LostCallback()
{
    InputDispatch_typeof()->Init();
}

// private static Fuse.Input.PointerEventData MakePointerEventData(Fuse.Controls.Native.iOS.UITouch touch, ObjC.Object rootView, int pointIndex) [static] :568
...
// private static void OnTouchEvent(ObjC.Object sender, ObjC.Object uiEvent) [static] :476
...
// private static void RaiseCancelled(Fuse.Visual visual, Fuse.Input.PointerEventData data) [static] :623
void InputDispatch::RaiseCancelled(::g::Fuse::Visual* visual, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    if (::g::Fuse::Input::Pointer::HardCapture(uPtr(data)->PointIndex, visual, InputDispatch::_captureIdentity(), uDelegate::New(::TYPES[4/*Uno.Action*/], (void*)InputDispatch__LostCallback_fn)))
    {
        try
        {
...
// private static void RaiseMoved(Fuse.Visual visual, Fuse.Input.PointerEventData data) [static] :598
void InputDispatch::RaiseMoved(::g::Fuse::Visual* visual, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    try
    {
        ::g::Fuse::Input::PointerMovedArgs* args = ::g::Fuse::Input::Pointer::RaiseMoved(InputDispatch::FindRoot(visual), data);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
// private static void RaisePressed(Fuse.Visual visual, Fuse.Input.PointerEventData data) [static] :586
void InputDispatch::RaisePressed(::g::Fuse::Visual* visual, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    try
    {
        ::g::Fuse::Input::PointerPressedArgs* args = ::g::Fuse::Input::Pointer::RaisePressed(InputDispatch::FindRoot(visual), data);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
// private static void RaiseReleased(Fuse.Visual visual, Fuse.Input.PointerEventData data) [static] :610
void InputDispatch::RaiseReleased(::g::Fuse::Visual* visual, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    try
    {
        ::g::Fuse::Input::PointerReleasedArgs* args = ::g::Fuse::Input::Pointer::RaiseReleased(InputDispatch::FindRoot(visual), data);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
// public static void RemoveListener(Fuse.Visual visual, ObjC.Object handle) [static] :647
...
// private static void RemoveListener(ObjC.Object eventHandler, ObjC.Object uicontrol) [static] :694
...
// public static generated ObjC.Object get_RootView() [static] :505
...
// public static generated void set_RootView(ObjC.Object value) [static] :505
