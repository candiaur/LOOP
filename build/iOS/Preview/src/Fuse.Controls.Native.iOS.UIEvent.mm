...
// public sealed extern class UIEvent :812
// {
...
// public UIEvent(ObjC.Object handle) :817
void UIEvent__ctor__fn(UIEvent* __this, uObject* handle)
{
    __this->ctor_(handle);
}

// public Fuse.Controls.Native.iOS.UITouch[] GetTouchesForView(ObjC.Object viewHandle) :822
...
// private static long GetTouchesForViewCount(ObjC.Object handle, ObjC.Object viewHandle) :833
...
// private static ObjC.Object GetTouchForView(ObjC.Object handle, ObjC.Object viewHandle, int index) :842
...
// public UIEvent New(ObjC.Object handle) :817
void UIEvent__New1_fn(uObject* handle, UIEvent** __retval)
{
    *__retval = UIEvent::New1(handle);
}

// public UIEvent(ObjC.Object handle) [instance] :817
...
// public Fuse.Controls.Native.iOS.UITouch[] GetTouchesForView(ObjC.Object viewHandle) [instance] :822
uArray* UIEvent::GetTouchesForView(uObject* viewHandle)
{
    ...
    for (int i = 0; i < touchCount; i++)
        touches->Strong< ::g::Fuse::Controls::Native::iOS::UITouch*>(i) = ::g::Fuse::Controls::Native::iOS::UITouch::New1(UIEvent::GetTouchForView(_handle, viewHandle, i));

    return touches;
}

// private static long GetTouchesForViewCount(ObjC.Object handle, ObjC.Object viewHandle) [static] :833
...
// private static ObjC.Object GetTouchForView(ObjC.Object handle, ObjC.Object viewHandle, int index) [static] :842
...
// public UIEvent New(ObjC.Object handle) [static] :817
