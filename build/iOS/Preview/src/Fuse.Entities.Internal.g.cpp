...
// /usr/local/share/uno/Packages/Fuse.Entities/0.29.22/Internal/$.uno
// ------------------------------------------------------------------
...
::g::Fuse::Entities::Entity* SceneGraphBuilder::CreateNode(::g::Uno::Content::Models::ModelNode* node, bool isRoot)
{
    ...
    if (transform != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(entity->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), transform);
    else if (isRoot)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(entity->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), CreateTransform());

    if (isRoot)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(entity->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), CreateMeshRenderer(CreateMaterial()));
