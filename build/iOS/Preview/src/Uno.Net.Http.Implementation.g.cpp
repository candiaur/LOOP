...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.29.20/Implementation/$.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.29.20/Implementation/iOS/$.uno
// ---------------------------------------------------------------------------
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", ".ctor(Uno.Net.Http.HttpMessageHandlerRequest,string,string)");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "Abort()");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "Dispose()");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "GetResponseContentByteArray()");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "GetResponseContentString()");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "GetResponseHeader(string)");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "GetResponseHeaders()");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "GetResponseStatus()");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "SendAsync()");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "SendAsync(string)");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "SetHeader(string,string)");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpRequest", "SetTimeout(int)");
...
{
    uStackFrame __("Uno.Net.Http.Implementation.iOSHttpSharedCache", "SetupSharedCache([bool],[long])");
