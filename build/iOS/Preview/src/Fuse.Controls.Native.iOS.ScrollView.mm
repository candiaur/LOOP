...
// public sealed extern class ScrollView :1218
// {
static void ScrollView_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Fuse::Controls::Native::iOS::ViewParent_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(3,
        ::g::Fuse::Controls::Native::iOS::View_typeof(), offsetof(::g::Fuse::Controls::Native::iOS::ScrollView, _content), 0,
        ::g::ObjC::Object_typeof(), offsetof(::g::Fuse::Controls::Native::iOS::ScrollView, _delegateHandle), 0,
        ::g::Fuse::Controls::Native::IScrollViewHost_typeof(), offsetof(::g::Fuse::Controls::Native::iOS::ScrollView, _host), 0);
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("get_Content", NULL, (void*)ScrollView__get_Content_fn, 0, false, ::g::Fuse::Controls::Native::iOS::View_typeof(), 0),
        new uFunction("set_Content", NULL, (void*)ScrollView__set_Content_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Controls::Native::iOS::View_typeof()),
...
// public ScrollView(Fuse.Controls.Native.IScrollViewHost host) :1265
void ScrollView__ctor_2_fn(ScrollView* __this, uObject* host)
{
    __this->ctor_2(host);
}

// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle) :1310
void ScrollView__Add_fn(uObject* parentHandle, uObject* childHandle)
{
    ScrollView::Add(parentHandle, childHandle);
}

// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) :1287
...
// private void Fuse.Controls.Native.IViewGroup.Remove(Fuse.Controls.Native.IView child) :1225
...
// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) :1335
void ScrollView__GetContentOffset_fn(uObject* handle, float* x, float* y)
{
    ScrollView::GetContentOffset(handle, x, y);
}

// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) :1265
void ScrollView__New1_fn(uObject* host, ScrollView** __retval)
{
    *__retval = ScrollView::New1(host);
}

// public override sealed void NotifyChildNewSize(Fuse.Controls.Native.iOS.View child, float2 size) :1304
void ScrollView__NotifyChildNewSize_fn(ScrollView* __this, ::g::Fuse::Controls::Native::iOS::View* child, ::g::Uno::Float2* size)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "NotifyChildNewSize(Fuse.Controls.Native.iOS.View,float2)");
    ::g::Uno::Float2 size_ = *size;
    ScrollView::SetContentSize(__this->Handle(), size_.X, size_.Y);
}

// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) :1296
...
// private static void Remove(ObjC.Object childHandle) :1318
void ScrollView__Remove_fn(uObject* childHandle)
{
    ScrollView::Remove(childHandle);
}

// public void set_ScrollPosition(float2 value) :1262
void ScrollView__set_ScrollPosition_fn(ScrollView* __this, ::g::Uno::Float2* value)
{
    __this->ScrollPosition(*value);
}

// private static void SetContentOffset(ObjC.Object handle, float x, float y) :1325
void ScrollView__SetContentOffset_fn(uObject* handle, float* x, float* y)
{
    ScrollView::SetContentOffset(handle, *x, *y);
}

// private static void SetContentSize(ObjC.Object handle, float w, float h) :1344
void ScrollView__SetContentSize_fn(uObject* handle, float* w, float* h)
{
    ScrollView::SetContentSize(handle, *w, *h);
}

// public ScrollView(Fuse.Controls.Native.IScrollViewHost host) [instance] :1265
void ScrollView::ctor_2(uObject* host)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", ".ctor(Fuse.Controls.Native.IScrollViewHost)");
...
// public void set_AllowedScrollDirections(Fuse.Controls.ScrollDirections value) [instance] :1257
void ScrollView::AllowedScrollDirections(int value)
{
}

// public Fuse.Controls.Native.iOS.View get_Content() [instance] :1233
::g::Fuse::Controls::Native::iOS::View* ScrollView::Content()
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "get_Content()");
    return _content;
}

// public void set_Content(Fuse.Controls.Native.iOS.View value) [instance] :1234
...
// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) [instance] :1296
...
// public void set_ScrollPosition(float2 value) [instance] :1262
void ScrollView::ScrollPosition(::g::Uno::Float2 value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "set_ScrollPosition(float2)");
    ScrollView::SetContentOffset(Handle(), value.X, value.Y);
}

// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle) [static] :1310
void ScrollView::Add(uObject* parentHandle, uObject* childHandle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "Add(ObjC.Object,ObjC.Object)");
    @autoreleasepool
    {
...
// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) [static] :1287
uObject* ScrollView::AddCallback(uObject* handle, uDelegate* callback)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "AddCallback(ObjC.Object,Uno.Action<ObjC.Object>)");
    @autoreleasepool
    {
...
// private static ObjC.Object Create() [static] :1278
uObject* ScrollView::Create()
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "Create()");
    @autoreleasepool
    {
...
// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) [static] :1335
void ScrollView::GetContentOffset(uObject* handle, float* x, float* y)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "GetContentOffset(ObjC.Object,float&,float&)");
    @autoreleasepool
    {
...
// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) [static] :1265
...
// private static void Remove(ObjC.Object childHandle) [static] :1318
void ScrollView::Remove(uObject* childHandle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "Remove(ObjC.Object)");
    @autoreleasepool
    {
        [] (::id childHandle) -> void
        {
...
// private static void SetContentOffset(ObjC.Object handle, float x, float y) [static] :1325
void ScrollView::SetContentOffset(uObject* handle, float x, float y)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "SetContentOffset(ObjC.Object,float,float)");
    @autoreleasepool
    {
        [] (::id handle, float x, float y) -> void
        {
...
// private static void SetContentSize(ObjC.Object handle, float w, float h) [static] :1344
void ScrollView::SetContentSize(uObject* handle, float w, float h)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ScrollView", "SetContentSize(ObjC.Object,float,float)");
    @autoreleasepool
    {
