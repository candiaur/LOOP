...
// {
// static Template3() :328
static void Indicador__Template3__cctor__fn(uType* __type)
{
    Indicador__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Value"*/]);
    Indicador__Template3::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Items"*/]);
}

static void Indicador__Template3_build(uType* type)
{
    ...
    type->SetFields(2,
        ::g::Indicador_typeof(), offsetof(::g::Indicador__Template3, __parent1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::Indicador__Template3, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(uObject_typeof()), offsetof(::g::Indicador__Template3, temp1_Items_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::Indicador__Template3::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::Indicador__Template3::__selector1_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Indicador__Template3__New2_fn, 0, true, Indicador__Template3_typeof(), 1, ::g::Indicador_typeof()));
}
...
::g::Uno::UX::Template_type* Indicador__Template3_typeof()
{
    ...
    options.ObjectSize = sizeof(Indicador__Template3);
    options.TypeSize = sizeof(::g::Uno::UX::Template_type);
    type = (::g::Uno::UX::Template_type*)uClassType::New("Indicador.Template3", options);
    type->SetBase(::g::Uno::UX::Template_typeof());
    type->fp_build_ = Indicador__Template3_build;
    type->fp_cctor_ = Indicador__Template3__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Template*, uObject**))Indicador__Template3__New1_fn;
    return type;
}

// public Template3(Indicador parent) :274
void Indicador__Template3__ctor_1_fn(Indicador__Template3* __this, ::g::Indicador* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :331
void Indicador__Template3__New1_fn(Indicador__Template3* __this, uObject** __retval)
{
    uStackFrame __("Indicador.Template3", "New()");
    ::g::Fuse::Controls::DockPanel* self = ::g::Fuse::Controls::DockPanel::New4();
    ::g::Fuse::Controls::Text* temp = ::g::Fuse::Controls::Text::New3();
    __this->temp_Value_inst = ::g::LOOP_FuseControlsText_Value_Property::New1(temp, Indicador__Template3::__selector0());
    ::g::Fuse::Reactive::Each* temp1 = ::g::Fuse::Reactive::Each::New2();
    __this->temp1_Items_inst = ::g::LOOP_FuseReactiveEach_Items_Property::New1(temp1, Indicador__Template3::__selector1());
    ...
    Indicador__Template3__Template4* temp6 = Indicador__Template3__Template4::New2(__this);
...
// public Template3 New(Indicador parent) :274
void Indicador__Template3__New2_fn(::g::Indicador* parent, Indicador__Template3** __retval)
{
    *__retval = Indicador__Template3::New2(parent);
}

::g::Uno::UX::Selector Indicador__Template3::__selector0_;
::g::Uno::UX::Selector Indicador__Template3::__selector1_;

// public Template3(Indicador parent) [instance] :274
void Indicador__Template3::ctor_1(::g::Indicador* parent)
{
    uStackFrame __("Indicador.Template3", ".ctor(Indicador)");
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Template3 New(Indicador parent) [static] :274
Indicador__Template3* Indicador__Template3::New2(::g::Indicador* parent)
{
    Indicador__Template3* obj1 = (Indicador__Template3*)uNew(Indicador__Template3_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
