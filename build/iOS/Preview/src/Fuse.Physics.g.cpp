...
// /usr/local/share/uno/Packages/Fuse.Physics/0.29.22/$.uno
// --------------------------------------------------------
...
// protected override sealed void OnRooted() :185
...
// protected override sealed void OnRooted() :310
...
// protected override sealed void OnUnrooted() :319
...
void ForceFieldEventArgs__FuseScriptingIScriptEventSerialize_fn(ForceFieldEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::TYPES[11/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[0/*"targetData"*/], uPtr(uPtr(__this->ForceField())->Parent())->DataContext());
}
...
// public Fuse.Visual get_Visual() :369
...
// public Fuse.Visual get_Visual() [instance] :369
...
static void ForceFieldEventTrigger_build(uType* type)
{
    ...
    ::TYPES[3] = uObject_typeof();
    ::TYPES[13] = ::g::Fuse::Physics::ForceFieldEventHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface2),
...
void ForceFieldEventTrigger::add_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[13/*Fuse.Physics.ForceFieldEventHandler*/]);
}
...
void ForceFieldEventTrigger::remove_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[13/*Fuse.Physics.ForceFieldEventHandler*/]);
}
...
{
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[14] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetInterfaces(
...
void ForceFieldTrigger::SetForce1(::g::Fuse::Physics::ForceField* field, ::g::Fuse::Physics::Body* body, float force)
{
    ...
    {
        ::g::Fuse::Node* b = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(uPtr(body)->Visual)->Children()), ::TYPES[14/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret1), ret1);
...
{
    ::TYPES[15] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[17] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[18] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Physics::Body_typeof());
    ::TYPES[19] = ::g::Fuse::Physics::ForceField_typeof();
    type->SetInterfaces(
...
void PointAttractor__OnUpdate_fn(PointAttractor* __this, double* deltaTime, ::g::Fuse::Physics::World* world)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Physics::Body*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(__this->World())->Bodies()), &ret6), ret6); enum2.MoveNext(::TYPES[18/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]); )
    {
        ::g::Fuse::Physics::Body* b = enum2.Current(::TYPES[18/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]);
...
bool PointAttractor::AnyStrongerForce(::g::Fuse::Physics::Body* b, float force, ::g::Fuse::Physics::World* w)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(w)->Rules()), ::TYPES[15/*Uno.Collections.IEnumerable<Fuse.Physics.IRule>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[16/*Uno.Collections.IEnumerator*/])); )
    {
        uObject* r = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[17/*Uno.Collections.IEnumerator<Fuse.Physics.IRule>*/]), &ret5), ret5);
...
// protected override sealed void OnRooted() :589
...
// protected override sealed void OnUnrooted() :598
...
// public Fuse.Visual get_Target() :559
void Spring__get_Target_fn(Spring* __this, ::g::Fuse::Visual** __retval)
{
    *__retval = __this->Target();
}

// public void set_Target(Fuse.Visual value) :560
...
// public Fuse.Visual get_Target() [instance] :559
...
// public void set_Target(Fuse.Visual value) [instance] :560
...
// internal static void Begin(Fuse.Visual n) :278
void WhileDragging__Begin_fn(::g::Fuse::Visual* n)
{
    WhileDragging::Begin(n);
}

// internal static void End(Fuse.Visual n) :287
...
// internal static void Begin(Fuse.Visual n) [static] :278
void WhileDragging::Begin(::g::Fuse::Visual* n)
{
    ...
    {
        WhileDragging* wd = uAs<WhileDragging*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(n)->Children()), ::TYPES[14/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), WhileDragging_typeof());
...
// internal static void End(Fuse.Visual n) [static] :287
void WhileDragging::End(::g::Fuse::Visual* n)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(n)->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        WhileDragging* wd = uAs<WhileDragging*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(n)->Children()), ::TYPES[14/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), WhileDragging_typeof());
...
{
    ::TYPES[20] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Physics::Body_typeof());
    ::TYPES[21] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[22] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[7] = ::g::Fuse::Physics::IRule_typeof();
    ::TYPES[18] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Physics::Body_typeof());
    ::TYPES[3] = uObject_typeof();
    ::TYPES[23] = ::g::Fuse::Physics::Body_typeof();
    ::TYPES[15] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    type->SetFields(0,
...
// internal static Fuse.Physics.World FindWorld(Fuse.Visual n) :683
void World__FindWorld_fn(::g::Fuse::Visual* n, World** __retval)
{
    *__retval = World::FindWorld(n);
}

// public static bool GetIsPhysicsWorld(Fuse.Visual n) :678
...
// internal Fuse.Physics.Body PinBody(Fuse.Visual node) :704
...
void World::ctor_()
{
    ...
    _bodies = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[20/*Uno.Collections.List<Fuse.Physics.Body>*/]));
    _bodyHandle = ::g::Fuse::Properties::CreateHandle();
    _rules = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[21/*Uno.Collections.List<Fuse.Physics.IRule>*/]));
    _firstFrame = true;
}
...
void World::OnUpdate()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_rules), &ret4), ret4); enum1.MoveNext(::TYPES[22/*Uno.Collections.List<Fuse.Physics.IRule>.Enumerator*/]); )
    {
        uObject* r = enum1.Current(::TYPES[22/*Uno.Collections.List<Fuse.Physics.IRule>.Enumerator*/]);
        ::g::Fuse::Physics::IRule::Update(uInterface(uPtr(r), ::TYPES[7/*Fuse.Physics.IRule*/]), deltaTime, this);
    }

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Physics::Body*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_bodies), &ret5), ret5); enum2.MoveNext(::TYPES[18/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]); )
    {
        ::g::Fuse::Physics::Body* b = enum2.Current(::TYPES[18/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]);
...
// internal Fuse.Physics.Body PinBody(Fuse.Visual node) [instance] :704
...
// internal Fuse.Physics.Body TryGetBody(Fuse.Visual node) [instance] :699
::g::Fuse::Physics::Body* World::TryGetBody(::g::Fuse::Visual* node)
{
    uStackFrame __("Fuse.Physics.World", "TryGetBody(Fuse.Visual)");
    return uAs< ::g::Fuse::Physics::Body*>(uPtr(uPtr(node)->Properties())->Get(_bodyHandle), ::TYPES[23/*Fuse.Physics.Body*/]);
}
...
// internal static Fuse.Physics.World FindWorld(Fuse.Visual n) [static] :683
...
// public static bool GetIsPhysicsWorld(Fuse.Visual n) [static] :678
...
// public static void SetIsPhysicsWorld(Fuse.Visual n, bool isPhysicsWorld) [static] :658
...
// public static void SetIsPhysicsWorldStyle(Fuse.Visual n, bool isPhysicsWorld) [static] :672
