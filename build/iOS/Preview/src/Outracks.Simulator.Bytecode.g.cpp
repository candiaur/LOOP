...
void Optional1__Equals2_fn(uTRef __this, uType* __type, void* other, bool* __retval)
{
    ...
    bool ind1;
    other_ = other;
    return *__retval = ::g::Uno::Bool::Equals((ind1 = __type->Field(__this, 0/*_hasValue*/).Value<bool>(), ind1), ::TYPES[3/*bool*/], uBox(::TYPES[3/*bool*/], other_[0/*_hasValue*/].Value<bool>())) && ::g::Uno::Object::Equals(uBoxPtr(__type->T(0), __type->Field(__this, 1/*_value*/), U_ALLOCA(__type->T(0)->ObjectSize)), uBoxPtr(__type->T(0), other_[1/*_value*/])), void();
}
...
void Optional1__GetHashCode_fn(uTRef __this, uType* __type, int* __retval)
{
    ...
    bool ind2;
    return *__retval = (::g::Uno::Bool::GetHashCode((ind2 = __type->Field(__this, 0/*_hasValue*/).Value<bool>(), ind2), ::TYPES[3/*bool*/]) * 397) ^ ::g::Uno::Object::GetHashCode(uBoxPtr(__type->T(0), __type->Field(__this, 1/*_value*/), U_ALLOCA(__type->T(0)->ObjectSize))), void();
}
