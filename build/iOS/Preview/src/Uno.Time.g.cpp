...
// /usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Time/$.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Time/Utilities/$.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Time/Timezones/$.uno
// -----------------------------------------------------------------------------
...
void Duration__GetHashCode_fn(Duration* __this, uType* __type, int* __retval)
{
    ...
    return *__retval = ::g::Uno::Long::GetHashCode(__this->Ticks(), ::TYPES[3/*long*/]), void();
}
...
{
    ::STRINGS[1] = uString::Const("UTC");
    ::TYPES[4] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Offset_typeof());
    ::TYPES[2] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    type->SetFields(4,
...
void FixedDateTimeZone__GetHashCode_fn(FixedDateTimeZone* __this, int* __retval)
{
    ...
    int ret4;
    int hash = ::g::Uno::Time::HashCodeHelper::Initialize();
    hash = (::g::Uno::Time::HashCodeHelper__Hash_fn(::TYPES[4/*Uno.Time.HashCodeHelper.Hash<Uno.Time.Offset>*/], uCRef<int>(hash), uCRef(__this->offset), &ret3), ret3);
...
void LocalTime__GetHashCode_fn(LocalTime* __this, uType* __type, int* __retval)
{
    ...
    return *__retval = ::g::Uno::Long::GetHashCode(ticks, ::TYPES[3/*long*/]), void();
}
...
void OffsetDateTime__GetHashCode_fn(OffsetDateTime* __this, int* __retval)
{
    ...
    hash = (::g::Uno::Time::HashCodeHelper__Hash_fn(::TYPES[4/*Uno.Time.HashCodeHelper.Hash<Uno.Time.Offset>*/], uCRef<int>(hash), uCRef(__this->_offset), &ret3), ret3);
    return *__retval = hash, void();
}
...
void Preconditions::CheckArgumentRange1(uString* paramName, int64_t value, int64_t minInclusive, int64_t maxInclusive)
{
    ...
    if ((value < minInclusive) || (value > maxInclusive))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New7(paramName, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*"Value shoul...*/], uBox<int64_t>(::TYPES[3/*long*/], minInclusive)), ::STRINGS[9/*"-"*/]), uBox<int64_t>(::TYPES[3/*long*/], maxInclusive)), ::STRINGS[10/*"]"*/])));
}
...
void ZonedDateTime__GetHashCode_fn(ZonedDateTime* __this, int* __retval)
{
    ...
    hash = (::g::Uno::Time::HashCodeHelper__Hash_fn(::TYPES[4/*Uno.Time.HashCodeHelper.Hash<Uno.Time.Offset>*/], uCRef<int>(hash), uCRef(__this->_offset), &ret8), ret8);
