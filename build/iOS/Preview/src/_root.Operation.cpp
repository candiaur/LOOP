// This file was generated based on '/Users/carla/Documents/Fuse Examples/LOOP/build/iOS/Preview/cache/Operation.g.uno'.
...
static void Operation_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Operation__New4_fn, 0, true, Operation_typeof(), 0));
}
...
{
    uStackFrame __("Operation", "InitializeUX()");
    TextColor(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    Alignment(11);
    Font(::g::MainView::museo500I_letter());
}
