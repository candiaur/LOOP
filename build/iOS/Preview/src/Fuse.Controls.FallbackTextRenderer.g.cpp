...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.29.22/TextControls/FallbackTextRenderer/$.uno
// ------------------------------------------------------------------------------------------------------
...
void ProperTextTransform__ResolveClipSpaceMatrix_fn(ProperTextTransform* __this, ::g::Uno::Float4x4* __retval)
{
    ...
    return *__retval = ::g::Uno::Matrix::Mul8(__this->Matrix(), ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(uPtr(__this->DrawContext)->Viewport()), ::TYPES[4/*Fuse.IViewport*/]))), void();
}
...
::g::Uno::Float2 TextRenderer::GetContentSize(::g::Fuse::LayoutParams lp)
{
    ...
    if (((Control == NULL) || ::g::Uno::String::op_Equality(uPtr(Control)->RenderValue(), NULL)) || (uPtr(uPtr(Control)->RenderValue())->Length() == 0))
        return ::g::Uno::Float2__New1(0.0f);
    ...
    InitWrap(wrapWidth, uPtr(Control)->RenderValue(), true);
...
void TextRenderer::UpdateArrange()
{
    ...
    uString* v = (ind13 != NULL) ? ind13 : ::STRINGS[1/*""*/];
