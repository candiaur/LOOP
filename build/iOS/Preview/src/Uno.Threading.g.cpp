...
// /usr/local/share/uno/Packages/Uno.Threading/0.29.20/$.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.29.20/Tasks/$.uno
// ---------------------------------------------------------------
...
static void IDispatcherExtensions_build(uType* type)
{
    ::TYPES[10] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[16] = ::g::Uno::Action_typeof();
    ::TYPES[18] = IDispatcherExtensions__Arg1Invoke_typeof();
    ::TYPES[19] = IDispatcherExtensions__Arg1InvokeFunc_typeof();
    ::TYPES[20] = IDispatcherExtensions__Arg2Invoke_typeof();
    type->Reflection.SetFunctions(3,
...
void IDispatcherExtensions__Invoke1_fn(uType* __type, uObject* dispatcher, uDelegate* action, void* arg)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[18/*Uno.Threading.IDispatcherExtensions.Arg1Invoke`1*/]->MakeType(__type->U(0)),
    };
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(dispatcher), ::TYPES[10/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[16/*Uno.Action*/], (void*)IDispatcherExtensions__Arg1Invoke__Run_fn, (IDispatcherExtensions__Arg1Invoke__New1_fn(__types[1], action, arg, &ret1), ret1)));
}
...
void IDispatcherExtensions__Invoke11_fn(uType* __type, uObject* dispatcher, uDelegate* func, void* arg)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[19/*Uno.Threading.IDispatcherExtensions.Arg1InvokeFunc`2*/]->MakeType(__type->U(0), __type->U(1)),
        __type->U(1),
    };
...
void IDispatcherExtensions__Invoke2_fn(uType* __type, uObject* dispatcher, uDelegate* action, void* arg1, void* arg2)
{
    uType* __types[] = {
        __type->U(0),
        __type->U(1),
        ::TYPES[20/*Uno.Threading.IDispatcherExtensions.Arg2Invoke`2*/]->MakeType(__type->U(0), __type->U(1)),
    };
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(dispatcher), ::TYPES[10/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[16/*Uno.Action*/], (void*)IDispatcherExtensions__Arg2Invoke__Run_fn, (IDispatcherExtensions__Arg2Invoke__New1_fn(__types[2], action, arg1, arg2, &ret3), ret3)));
}
// }
...
// /usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/Threading/$.uno
// ------------------------------------------------------------------------
...
static void Mutex_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("TryLock", NULL, NULL, offsetof(Mutex_type, fp_TryLock), false, ::g::Uno::Bool_typeof(), 0),
...
// /usr/local/share/uno/Packages/Uno.Threading/0.29.20/Implementation/Cpp/$.uno
// ----------------------------------------------------------------------------
...
static void POSIXMutex_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("Cannot trylock a disposed mutex");
    ::STRINGS[6] = uString::Const("Cannot unlock a disposed mutex");
    type->SetInterfaces(
...
::g::Uno::Threading::Mutex_type* POSIXMutex_typeof()
{
    ...
    type->fp_TryLock = (void(*)(::g::Uno::Threading::Mutex*, bool*))POSIXMutex__TryLock_fn;
...
// public override sealed bool TryLock() :97
void POSIXMutex__TryLock_fn(POSIXMutex* __this, bool* __retval)
{
    uStackFrame __("Uno.Threading.POSIXMutex", "TryLock()");

    if (::g::Uno::IntPtr::op_Equality(__this->_handle, ::g::Uno::IntPtr::Zero_))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[5/*"Cannot tryl...*/]));
...
void POSIXMutex__Unlock_fn(POSIXMutex* __this)
{
    ...
    if (::g::Uno::IntPtr::op_Equality(__this->_handle, ::g::Uno::IntPtr::Zero_))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[6/*"Cannot unlo...*/]));
...
{
    ::STRINGS[7] = uString::Const("Cannot join unstarted thread");
    ::STRINGS[8] = uString::Const("Cannot start throw more than once");
    ::TYPES[16] = ::g::Uno::Action_typeof();
    type->SetFields(1,
...
void POSIXThread__Join_fn(POSIXThread* __this)
{
    ...
    if (__this->_posixHandle == 0ULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[7/*"Cannot join...*/]));
...
void POSIXThread__Start_fn(POSIXThread* __this)
{
    ...
    if (__this->_posixHandle != 0ULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[8/*"Cannot star...*/]));
...
{
    ::TYPES[21] = ::g::Uno::Threading::Future1_typeof();
    ::TYPES[22] = ::g::Uno::Threading::TaskFuture_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[15] = ::g::Uno::Exception_typeof();
    ::TYPES[23] = ::g::Uno::Exception_typeof()->Array();
    ::TYPES[9] = ::g::Uno::Delegate_typeof();
    ::TYPES[24] = ::g::Uno::Threading::ITaskScheduler_typeof();
    type->SetInterfaces(
...
void Task::Execute()
{
...

    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            Status(1);
            Exception(::g::Uno::AggregateException::New7(uArray::Init< ::g::Uno::Exception*>(::TYPES[23/*Uno.Exception[]*/], 1, e)));
        }
    }
}
...
Task* Task::Run1(uDelegate* taskDelegate, uObject* scheduler)
{
    ...
    ::g::Uno::Threading::ITaskScheduler::ScheduleTask(uInterface(uPtr(scheduler), ::TYPES[24/*Uno.Threading.ITaskScheduler*/]), task);
    return task;
}
// }
...
{
    ::STRINGS[9] = uString::Const("wait");
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Uno.Threading/0.29.20/$.uno");
    ::TYPES[25] = ::g::Uno::Threading::TaskDelegate_typeof();
    ::TYPES[15] = ::g::Uno::Exception_typeof();
    ::TYPES[9] = ::g::Uno::Delegate_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::Threading::Future_type, interface0));
...
void TaskFuture__Wait_fn(TaskFuture* __this)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[9/*"wait"*/], 1, ::STRINGS[10/*"/usr/local/...*/], 446);
...
void TaskFuture::ctor_3(uDelegate* func)
{
    ...
    ctor_1();
    _func = func;
    _task = ::g::Uno::Threading::Task::Run(uDelegate::New(::TYPES[25/*Uno.Threading.TaskDelegate*/], (void*)TaskFuture__Invoke1_fn, this));
}
...
{
    ::TYPES[26] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(ThreadPool__WorkItem_typeof());
    ::TYPES[27] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Threading::Thread_typeof());
    ::TYPES[16] = ::g::Uno::Action_typeof();
    ::TYPES[28] = ThreadPool__WorkItem_typeof();
    type->SetInterfaces(
...
void ThreadPool::ctor_(int poolSize)
{
    ...
    _taskQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[26/*Uno.Threading.ConcurrentQueue<Uno.Threading.ThreadPool.WorkItem>*/]));
    _running = true;
    _disposeQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[27/*Uno.Threading.ConcurrentQueue<Uno.Threading.Thread>*/]));
    _poolSize = poolSize;
...
ThreadPoolTaskScheduler* ThreadPoolTaskScheduler::Default()
{
    ...
    if (ThreadPoolTaskScheduler::_default_ == NULL)
    {
        ...
        uPtr(uPtr(::g::Uno::Application::Current())->Window())->add_Closed(uDelegate::New(::TYPES[29/*Uno.EventHandler*/], (void*)ThreadPoolTaskScheduler__OnWindowClosed_fn));
    }
