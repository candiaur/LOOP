...
namespace g{struct LOOP_FuseControlsCircle_Color_Property;}
...
struct LOOP_FuseControlsCircle_Color_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Controls::Circle*> _obj;

    void ctor_2(::g::Fuse::Controls::Circle* obj, ::g::Uno::UX::Selector name);
    static LOOP_FuseControlsCircle_Color_Property* New1(::g::Fuse::Controls::Circle* obj, ::g::Uno::UX::Selector name);
};
// }
