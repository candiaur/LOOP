...
#include <objc/objc.h>
#include <uObjC.h>
namespace g{namespace Fuse{namespace iOS{namespace Bindings{struct UIControlCallback;}}}}
...
{
    void(*fp_callbackForEvent)(::g::Fuse::iOS::Bindings::UIControlCallback*, ::g::iOS::Foundation::NSObject*, ::g::iOS::Foundation::NSObject*);
};
