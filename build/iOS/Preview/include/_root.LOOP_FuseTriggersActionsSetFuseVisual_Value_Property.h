...
namespace g{struct LOOP_FuseTriggersActionsSetFuseVisual_Value_Property;}
...
struct LOOP_FuseTriggersActionsSetFuseVisual_Value_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Triggers::Actions::Set*> _obj;

    void ctor_2(::g::Fuse::Triggers::Actions::Set* obj, ::g::Uno::UX::Selector name);
    static LOOP_FuseTriggersActionsSetFuseVisual_Value_Property* New1(::g::Fuse::Triggers::Actions::Set* obj, ::g::Uno::UX::Selector name);
};
// }
