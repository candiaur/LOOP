...
struct CacheFramebuffer : uObject
{
    ...
    void ctor_(uObject* owner, int width, int height, int format, int flags);
    void Collect();
    void Dispose();
    void EnsurePinned();
    int Flags();
    ...
    static CacheFramebuffer* New1(uObject* owner, int width, int height, int format, int flags);
};
// }
