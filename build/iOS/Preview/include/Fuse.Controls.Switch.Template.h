...
void Switch__Template__ctor_1_fn(Switch__Template* __this, ::g::Fuse::Controls::Switch* parent);
void Switch__Template__New1_fn(Switch__Template* __this, uObject** __retval);
void Switch__Template__New2_fn(::g::Fuse::Controls::Switch* parent, Switch__Template** __retval);
...
struct Switch__Template : ::g::Uno::UX::Template
{
    ...
    static Switch__Template* New2(::g::Fuse::Controls::Switch* parent);
};
// }
