...
struct ErrorToast : ::g::Fuse::Controls::StackPanel
{
    ...
    void ctor_8();
    ::g::Uno::Float4 Color1();
    void Color1(::g::Uno::Float4 value);
    ...
    void SetColor1(::g::Uno::Float4 value, uObject* origin);
