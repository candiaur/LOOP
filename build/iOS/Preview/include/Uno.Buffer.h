// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.29.20/Source/Uno/$.uno'.
...
struct Buffer : uObject
{
    ...
    void ctor_1(uArray* data, int offset, int sizeInBytes, bool isReadOnly);
    void ctor_2(int sizeInBytes);
    ...
    static Buffer* New2(uArray* data, int offset, int sizeInBytes, bool isReadOnly);
    static Buffer* New3(int sizeInBytes);
};
// }
