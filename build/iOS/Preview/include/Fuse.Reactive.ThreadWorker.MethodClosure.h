...
struct ThreadWorker__MethodClosure : uObject
{
    ...
    void ctor_(::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker);
    uObject* Callback(uArray* args);
    static uArray* CopyArgs(::g::Fuse::Scripting::Array* args);
    static ThreadWorker__MethodClosure* New1(::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker);
};
// }
