...
void Button__Template__ctor_1_fn(Button__Template* __this, ::g::Fuse::Controls::Button* parent);
void Button__Template__New1_fn(Button__Template* __this, uObject** __retval);
void Button__Template__New2_fn(::g::Fuse::Controls::Button* parent, Button__Template** __retval);
...
struct Button__Template : ::g::Uno::UX::Template
{
    ...
    static Button__Template* New2(::g::Fuse::Controls::Button* parent);
};
// }
