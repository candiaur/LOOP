...
namespace g{struct LOOP_FuseControlsPage_Visibility_Property;}
...
struct LOOP_FuseControlsPage_Visibility_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Controls::Page*> _obj;

    void ctor_2(::g::Fuse::Controls::Page* obj, ::g::Uno::UX::Selector name);
    static LOOP_FuseControlsPage_Visibility_Property* New1(::g::Fuse::Controls::Page* obj, ::g::Uno::UX::Selector name);
};
// }
