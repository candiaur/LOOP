// This file was generated based on '/usr/local/share/uno/Packages/Fuse.UserEvents/0.29.22/$.uno'.
...
struct UserEvent : ::g::Fuse::Behavior
{
    ...
    static UserEvent* ScanTree(::g::Fuse::Visual* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual);
};
// }
