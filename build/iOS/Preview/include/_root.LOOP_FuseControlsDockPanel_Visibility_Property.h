...
namespace g{struct LOOP_FuseControlsDockPanel_Visibility_Property;}
...
struct LOOP_FuseControlsDockPanel_Visibility_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Controls::DockPanel*> _obj;

    void ctor_2(::g::Fuse::Controls::DockPanel* obj, ::g::Uno::UX::Selector name);
    static LOOP_FuseControlsDockPanel_Visibility_Property* New1(::g::Fuse::Controls::DockPanel* obj, ::g::Uno::UX::Selector name);
};
// }
