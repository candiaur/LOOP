...
struct WebView_type : ::g::Fuse::Controls::Native::iOS::LeafView_type
{
    ...
    ::g::iOS::WebKit::IWKNavigationDelegate interface4;
    ::g::Fuse::Triggers::IProgress interface5;
    ::g::Fuse::Navigation::IBaseNavigation interface6;
    ::g::Fuse::Controls::ISourceReceiver interface7;
};
...
struct WebView : ::g::Fuse::Controls::Native::iOS::LeafView
{
    ...
    void ctor_2(::g::Fuse::Controls::WebView* webViewHost, ::g::iOS::WebKit::WKWebView* wkWebView);
    uString* BaseUrl();
    ...
    static WebView* New1(::g::Fuse::Controls::WebView* webViewHost, ::g::iOS::WebKit::WKWebView* wkWebView);
};
// }
