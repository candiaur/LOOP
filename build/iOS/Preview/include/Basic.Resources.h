// This file was generated based on '/usr/local/share/uno/Packages/Fuse.BasicTheme/0.29.22/$.uno'.
...
struct Resources : ::g::Fuse::Controls::Panel
{
    ...
    void ctor_7();
    void InitializeUX();
    static uArray* GetColorScheme(int scheme);
    static Resources* New4();
    static void SetColorScheme(::g::Fuse::Controls::Control* control, int scheme);
};
// }
