...
{
    ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall _draw_5f2d2bfe;
    static uSStrong<Blitter*> _instance_;
    static uSStrong<Blitter*>& _instance() { return _instance_; }
    uStrong< ::g::Uno::Graphics::IndexBuffer*> Blit_VertexData_5f2d2bfe_2_5_2;
    uStrong< ::g::Uno::Graphics::VertexBuffer*> Blit_VertexData_5f2d2bfe_2_5_3;
