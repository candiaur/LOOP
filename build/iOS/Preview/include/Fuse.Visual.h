// This file was generated based on '/usr/local/share/uno/Packages/FuseCore/0.29.22/$.uno'.
...
struct Visual_type : ::g::Fuse::Node_type
{
    ...
    void(*fp_WindowToWorldRay)(::g::Fuse::Visual*, ::g::Uno::Float2*, ::g::Uno::Geometry::Ray*);
};
...
struct Visual : ::g::Fuse::Node
{
    ...
    void ctor_2();
    bool _isFlat();
    void _isFlat(bool value);
    bool _isFlatCached();
    void _isFlatCached(bool value);
    bool _isLocalFlat();
    ...
    static void bringIntoView(Visual* n, uArray* args);
    ...
    static ::g::Uno::Geometry::Ray WindowToWorldRay(Visual* __this, ::g::Uno::Float2 windowCoord);
...
inline ::g::Uno::Geometry::Ray Visual::WindowToWorldRay(::g::Uno::Float2 windowCoord) { ::g::Uno::Geometry::Ray __retval; return (((Visual_type*)__type)->fp_WindowToWorldRay)(this, &windowCoord, &__retval), __retval; }
...
inline ::g::Uno::Geometry::Ray Visual::WindowToWorldRay(Visual* __this, ::g::Uno::Float2 windowCoord) { ::g::Uno::Geometry::Ray __retval; return Visual__WindowToWorldRay_fn(__this, &windowCoord, &__retval), __retval; }
