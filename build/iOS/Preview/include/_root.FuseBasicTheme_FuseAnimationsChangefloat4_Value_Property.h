...
struct FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Animations::Change*> _obj;

    void ctor_2(::g::Fuse::Animations::Change* obj, ::g::Uno::UX::Selector name);
    static FuseBasicTheme_FuseAnimationsChangefloat4_Value_Property* New1(::g::Fuse::Animations::Change* obj, ::g::Uno::UX::Selector name);
};
// }
