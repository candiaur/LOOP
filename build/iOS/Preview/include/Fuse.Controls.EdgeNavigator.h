// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls.Navigation/0.29.22/$.uno'.
...
void EdgeNavigator__dismiss_fn(EdgeNavigator* e, uArray* args);
...
struct EdgeNavigator : ::g::Fuse::Controls::Panel
{
    ...
    static void dismiss(EdgeNavigator* e, uArray* args);
